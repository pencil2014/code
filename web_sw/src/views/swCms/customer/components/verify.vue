<template>
  ...
  >
    ...
    <div class="customer-box">
      ...
      <Customer :customer="customerData" :bdEmployeeName="bdEmployeeName" v-if="showCustomer" ref="customer" />
    </div>
...
export default {
  ...
  methods: {
    ...
    getCustomerDetail() {
      let { oid, bdEmployeeName } = this.option.data
      let data = {
        oid,
      }
      this.bdEmployeeName = bdEmployeeName
      this.loading = true
      customerDetail(data)
        .then((res) => {
