  ...
  created() {
    ...
    this.selfColumnsBase = [
      ...
      },
      {
        ...
        width: 150,
        formatter: ({cellValue, row}) => {
          let {currency, discountPriceGp20} = row
      ...
      },
      {
        ...
        width: 150,
        formatter: ({cellValue, row}) => {
          let {currency, discountPriceGp40} = row
      ...
      },
      {
        ...
        width: 150,
        formatter: ({cellValue, row}) => {
          let {currency, discountPriceHq40} = row
      ...
      },
      {
        ...
        width: 150,
        formatter: ({cellValue, row}) => {
          let {currency , discountPriceNor40} = row
          return `<span>${currency}:${cellValue}</span> / <span class="red">${currency}:${discountPriceNor40}</span>`
        }
      },
      {
        prop: 'sysLineName',
