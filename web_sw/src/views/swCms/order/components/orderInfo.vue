    ...
    >
       <div class="content-wrap">
        <div class="form-content">
          <div class="left" :class="{'long-left': arrowStatus === false}">
            ...
            <div class="top-form">
              ...
              <div class="item-box large-item">
                ...
                <el-form-item label="委托备注" prop="shipowner.intrustRemark">
                  <el-input
                    type="textarea"
                    v-model="form.shipowner.intrustRemark"
                    maxlength="200"
                    show-word-limit
              ...
              <div class="item-box large-item">
                ...
                <el-form-item label="付款方式" prop="transport.payMode">
                  <el-select
                    v-model="form.transport.payMode"
                    clearable
                    filterable
                    placeholder="请选择"
                    :disabled="type === 'info'"
                  >
                    <el-option
                      v-for="(item, index) in dictMap['payMode']"
                      :label="item.label"
                      :value="item.value"
                      :key="index"
                    ></el-option>
                ...
                <el-form-item label="出单方式" prop="transport.blMode">
                  <el-select v-model="form.transport.blMode" clearable filterable placeholder="请选择" :disabled="type === 'info'">
                    <el-option
                ...
                <el-form-item label="提单类型" prop="transport.blType">
                  <el-select v-model="form.transport.blType" clearable filterable placeholder="请选择" :disabled="type === 'info'">
                    <el-option
                ...
                <el-form-item label="放舱要求" prop="transport.issueMode">
                  <el-select v-model="form.transport.issueMode" clearable filterable placeholder="请选择" :disabled="type === 'info'">
                    <el-option
                      v-for="(item, index) in dictMap['issueMode']"
                      :label="item.label"
                      :value="item.value"
                      :key="index"
                    ></el-option>
                  ...
                  <div class="outer-box" v-show="showContainer">
                    <div class="container-box" v-for="(item, index) in form.containers" :key="index">
                      <div class="small-box">
                        ...
                        >
                          <el-select v-model="item.containerType" clearable filterable placeholder="请选择" :disabled="type === 'info'">
                            <el-option
                              v-for="(item, index) in dictMap['swMngContainerType'].filter(item => item.value !=='45hq')"
                              :label="item.label"
                              :value="item.value"
                              :key="index"
                            ></el-option>
                        ...
                        <el-form-item
                          ...
                          :rules="{ required: true, message: ' ', trigger: 'change' }"
                        >
                          <el-input v-model="item.containerNum" clearable placeholder="请填写" oninput ="value=value.replace(/[^0-9]/g,'')" :disabled="type === 'info'"></el-input>
                        </el-form-item>
                        <el-form-item
                          label="单柜重量"
                          label-width="80px"
                          ...
                          :rules="{ required: true, message: ' ', trigger: 'change' }"
                        >
                          <el-input v-model="item.weight" placeholder="请填写" clearable oninput ="value=value.replace(/[^0-9.]/g,'')" :disabled="type === 'info'"
                            ><template slot="append">KGS</template></el-input
                          >
                        </el-form-item>
                        <el-form-item label="单柜体积" prop="volume" label-width="80px">
                          <el-input v-model="item.volume" placeholder="请填写" clearable oninput ="value=value.replace(/[^0-9.]/g,'')" :disabled="type === 'info'"
                        ...
                        <el-form-item
                          label="包装"
                          label-width="80px"
                          :prop="`containers.${index}.packageInfo`"
                        >
                          <el-select v-model="item.packageInfo" clearable filterable placeholder="请选择" :disabled="type === 'info'">
                            <el-option
                              v-for="(item, index) in dictMap['packageType']"
                              :label="item.label"
                              :value="item.value"
                              :key="index"
                            ></el-option>
                        ...
                        <el-form-item
                          ...
                          :rules="{ required: true, message: ' ', trigger: 'change' }"
                        >
                          <el-select v-model="item.isHeavy" clearable filterable placeholder="请选择" :disabled="type === 'info'">
                            <el-option
                      ...
                      <div class="btn-box" v-show="type !== 'info'">
                  ...
                  <div class="outer-box" v-show="showCargos">
                    <div class="container-box" v-for="(item, i) in form.cargos" :key="i" :class="{'border': i != form.cargos.length - 1}">
                      ...
                      <!-- <el-input v-model="item.hscode" placeholder="请填写"></el-input> -->
                        ...
                        <el-form-item
                          ...
                          :rules="{ required: true, message: ' ', trigger: 'change' }"
                        >
                          <el-input v-model="item.cname" clearable placeholder="请填写" :disabled="type === 'info'"></el-input>
                        </el-form-item>
                        <el-form-item
                          label="英文品名"
                          label-width="80px"
                          ...
                          :rules="{ required: true, message: ' ', trigger: 'change' }"
                        >
                          <el-input v-model="item.ename" clearable placeholder="请填写" :disabled="type === 'info'"></el-input>
                        </el-form-item>
                        <el-form-item
                          label="货物性质"
                          label-width="80px"
                          ...
                          :rules="{ required: true, message: ' ', trigger: 'change' }"
                        >
                          <el-select v-model="item.property" clearable filterable placeholder="请选择" :disabled="type === 'info'">
                            <el-option
                        ...
                        <template v-if="item.property === 'dangerous'">
                          <el-form-item label="危险品级别" prop="dangerousGrade" label-width="80px">
                            <el-select v-model="item.dangerousGrade" clearable placeholder="请选择危险等级" :disabled="type === 'info'">
                              <el-option
                          ...
                          <el-form-item label="国危编码" prop="dangerousCode" label-width="80px" :disabled="type === 'info'">
                        <!-- <el-input v-model="item.dangerousCode"></el-input> -->
                          ...
                          <el-form-item label="包装组别" label-width="80px" prop="packageGroup" :disabled="type === 'info'">
                    ...
                    <!-- <el-form-item label="货好时间" prop="cargoReadyTime">
                      ...
                      ></el-date-picker>
                        ...
                        <el-form-item label="装箱要求" prop="boxRemark" label-width="80px">
                          <el-input v-model="item.boxRemark" clearable placeholder="请填写" :disabled="type === 'info'"></el-input>
              ...
              <div class="item-box flex-box">
                ...
                <Transition name="fade" mode="out-in">
                  <div class="transport-box" v-show="showTransport">
                    ...
                    <div class="transport-item transport-people">
                      <el-form-item label="放舱联系人" prop="transport.releaseContactName">
                        <el-input
                          v-model="form.transport.releaseContactName"
                          :disabled="type === 'info'"
                        ></el-input>
                      </el-form-item>
                      <el-form-item label="联系人邮箱" prop="transport.releaseContactEmail">
                        <el-input
                          v-model="form.transport.releaseContactEmail"
                          :disabled="type === 'info'"
                        ></el-input>
                      </el-form-item>
                      <el-form-item label="联系人电话" prop="transport.releaseContactPhone">
                        <el-input
                          v-model="form.transport.releaseContactPhone"
                          :disabled="type === 'info'"
                        ></el-input>
                      </el-form-item>
                    </div>
          ...
          <div class="right" :class="{'no-people': arrowStatus === false}">
             <div class="arrow-wrap">
              <div class="hamburger" v-if="arrowStatus" @click="changeArrow(false)">
                <i  class="el-icon-arrow-right"></i>
              </div>
              <div class="hamburger" v-else @click="changeArrow(true)">
             ...
             <div class="people-wrap">
                ...
                <div class="people-content">
                  <el-form-item :label="item.jobCname" v-for="(item, k) in form.workAssign" :key="k" :prop="`workAssign.${k}.employeeId`" :rules="{ required: item.isRequire, message: ' ', trigger: 'change' }">
                    <el-select
                      v-model="item.employeeId"
                      placeholder="请选择"
                      remote
                      :remote-method="(val) => changePerson(val, item.jobCode, k)"
                      @visible-change="(val) => changePerson(val, item.jobCode, k)"
                      @change="(val) => getPersonData(val, item.jobCode, k)"
                      filterable
                      clearable
                      :disabled="item.disabled || type === 'info'"
                    >
                      <el-option
...
import { cargoHscodeList, cargoUnnoList, cargoTypeList, portList } from '@/api/base'
import { getParticipants, workAssignList } from '@/api/swcms/index'
import {joinEmployeeList } from '@/views/swCms/data'
export default {
  props: {
    dataSource: {
      type: Object,
    ...
    return {
      ...
      rules: {
        ...
        transport: {
          ...
          // payMode: { required: true, message: ' ', trigger: 'change' },
          // blMode: { required: true, message: ' ', trigger: 'change' },
          blType: { required: true, message: ' ', trigger: 'change' },
          issueMode: { required: true, message: ' ', trigger: 'change' },
        },
        shipowner: {
      ...
      personList: [],
      arrowStatus: true,
      joinEmployeeList: joinEmployeeList,
      isRemoteFirst: true
    }
  },
  created() {
    ...
    if (data.transport.issueMode === '') {
      data.transport.issueMode = 'prompt'
    }
    Object.assign(this.form, data)
    if (data.workAssign.length === 0) {
      this.getWorkAssign()
    } else {
      let requireData = ['bd', 'pricing', 'op', 'doc', 'rc', 'ac']
      let workAssign = this.joinEmployeeList.map(item => {
        let workAssignItem = data.workAssign.find(i => i.jobCode === item.jobCode)
        return {
          jobCname: item.jobCname,
          jobCode: item.jobCode,
          isRequire: requireData.includes(item.jobCode) ? true : false,
          disabled: item.jobCode === 'bd' ? true : false,
          employeeId: workAssignItem.employeeId,
          deptCode: workAssignItem.deptCode,
          list: workAssignItem.employeeId ? [{
            label: workAssignItem.employeeName,
            value: workAssignItem.employeeId || ''
          }] : []
        }
      })
      this.form.workAssign = workAssign
    }
    this.fee = data.fee || {}
    this.option1 = Object.assign({}, this.option, {
      ...
      columns: [
        ...
        },
        {
          ...
          type: 'text',
          formatter: ({ cellValue, row }) => {
            let { currency, num40Nor } = row
            return num40Nor ? `${currency} ${cellValue.toFixed(2)} * ${num40Nor}` : 0
          },
        },
        {
          prop: 'price',
  ...
  watch: {
    ...
    dataSource (val) {
      if (val.workAssign.length === 0) {
        this.getWorkAssign()
      } else {
        this.changeWorkAssignList(val.workAssign)
      }
      this.fee = val.fee || {}
  ...
  methods: {
    getWorkAssign() {
      ...
      workAssignList(data)
        .then((res) => {
          let requireData = ['bd', 'pricing', 'op', 'doc', 'rc', 'ac']
          let workAssign = this.joinEmployeeList.map(item => {
             let workAssignItem = res.data.find(i => i.jobCode === item.jobCode)
            return {
              jobCname: item.jobCname,
              jobCode: item.jobCode,
              isRequire: requireData.includes(item.jobCode) ? true : false,
          ...
          console.log("form.workAssign", workAssign)
          this.form.workAssign = workAssign
        })
        .catch(() => {
        })
    ...
    getPersonData(val, code, index) {
      let obj = this.form.workAssign[index].list.find(item => item.value === val)
      this.form.workAssign[index].employeeName = obj.label
    },
    changePerson(keyword = '', code, index) {
      if (!keyword || keyword === true) {
        return
      }
      let codeItem = this.form.workAssign.find(item => item.jobCode === 'bd')
      let codeArr = ['asst', 'op', 'line_cs', 'op_truck', 'op_customs', 'op_wh', 'doc', 'tc', 'rc']
      let params = {
        name: keyword,
        roleCode: code
      }
      if (codeArr.includes(code)) {
        params.deptCode = codeItem.deptCode
      }
      getParticipants(params)
        .then((res) => {
          this.form.workAssign[index].list = res.data.map((item) => {
            return {
              label: item.cname,
              value: item.employeeId,
            }
          })
          console.log(111, this.form.workAssign[index].list)
        })
        .catch(() => {})
    },
    changePersonList() {
      // console.log("121212", this.dataSource.workAssign)
      // let requireData = ['bd', 'pricing', 'op', 'doc', 'rc', 'ac']
      // let workAssign = this.dataSource.workAssign.map(item => {
      //   return {
      //     ...item,
      //     isRequire: requireData.includes(item.jobCode) ? true : false,
      //     disabled: item.jobCode === 'bd' ? true : false,
      //     list: item.employeeId ? [{
    ...
    changeWorkAssignList(data) {
       let requireData = ['bd', 'pricing', 'op', 'doc', 'rc', 'ac']
          let workAssign = this.joinEmployeeList.map(item => {
             let workAssignItem = data.find(i => i.jobCode === item.jobCode)
            return {
              jobCname: item.jobCname,
              jobCode: item.jobCode,
              isRequire: requireData.includes(item.jobCode) ? true : false,
    ...
    feederSearch(val = '') {
      this.portSearch(val, 'port_of_feeder', 'porPortList', this.form.voyage.porPortCode)
    },
    polSearch(val = '') {
      this.portSearch(val, 'port_of_basic', 'polPortList', this.form.voyage.polPortCode)
    },
    podSearch(val = '') {
      this.portSearch(val, 'port_of_destination', 'podPortList', this.form.voyage.podPortCode)
    },
    unloadingPortSearch(val = '') {
      this.portSearch(val, 'port_of_discharge', 'unloadingPortList', this.form.voyage.unloadingPortCode)
    },
    // 远程搜索港口下拉数据 port_of_basic  port_of_destination
    portSearch(queryString, port, list, keyword) {
      let data = {
        portName: '',
        state: '',
        portAttribute: port,
      ...
      portList(data).then((res) => {
        this[list] = res.data.map(item => {
          return {
            label: `${item.ename}(${item.portCode}, ${item.cname}${item.portCname ? ',' + item.portCname : ''}${item.cityCname ? ',' + item.cityCname : ''}${item.countryName ? ',' + item.countryName : ''})`,
            value: item.portCode
          }
        })
