  ...
  columnsBase(handleClickRefreshList) {
    return [
      ...
      ...lastInitColumnsBase(handleClickRefreshList),
      {
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followLoaStatus', row.loa)
				}
			},
      {
				label: '放舱',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followReleaseStatus', row.release)
				}
			},
      {
				label: '拖柜',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followTruckStatus', row.truck)
				}
			},
      {
				label: '起运港仓储',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followPolWhStatus', row.pol_warehouse)
				}
			},
      {
				label: '堆场装箱',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followStuffingStatus', row.stuffing)
				}
			},
      {
				label: '散车',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followScatterStatus', row.pol_ltl)
				}
			},
      {
				label: 'VGM',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followVgmStatus', row.vgm)
				}
			},
      {
				label: '报关',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followCustomsStatus', row.pol_declaration)
				}
			},
      {
				label: '报检',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followInspectionStatus', row.pol_inspection)
				}
			},
      {
				label: '熏蒸',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followFumeStatus', row.fume)
				}
			},
      {
				label: '各类检查',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followOtherInspectionStatus', row.other_inspect)
				}
			},
      {
				label: '计划单',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followPlanTodoStatus', row.plan_todo)
				}
			},
      {
				label: 'MBL',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followBlStatus', row.mbl)
				}
			},
      {
				label: 'HBL',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followBlStatus', row.hbl)
				}
			},
      {
				label: '离港',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followCargoTraceStatus', row.departure)
				}
			},
      {
				label: 'SA',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followSaStatus', row.sa)
				}
			},
      {
				label: 'FREETIME',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followFreetimeStatus', row.freetimeStatus)
				}
			},
      {
				label: '单证',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followDocumentStatus', row.doc)
				}
			},
      {
				label: '保险',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followInsuranceStatus', row.insurance)
				}
			},
      {
				label: '费用',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followFeeStatus', row.fee)
				}
			},
      {
				label: '账单',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followBillStatus', row.bill)
				}
			},
      {
				label: '到港',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followCargoTraceStatus', row.arrival)
				}
			},
      {
				label: '目的港换单',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followPodExchangeDocStatus', row.pod_change_doc)
				}
			},
      {
				label: '目的港清关',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followCustomsClearanceStatus', row.pod_comm_clearance)
				}
			},
      {
				label: '目的港仓储',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followPolWhStatus', row.pod_warehouse)
				}
			},
      {
				label: '目的港派送',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followDeliveryStatus', row.delivery)
				}
			},
      {
				label: '目的港散车派送',
				...
				width: '100',
				formatter: (row, column) => {
          return getDictLabel('followDeliveryStatus', row.delivery_ltl)
				}
			},
    ].map(item => {
