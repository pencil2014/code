...
// 统一设置规则提醒
const ruleMsg = [{ required: true, message: ' ', trigger: 'blur' }] // 请填写内容
const ruleMsg1 = [{ required: true, message: ' ', trigger: 'change' }] // 请选择内容
const ruleMsg2 = [{ type: 'array', required: true, message: ' ', trigger: 'change' }] // 请选择内容
const cityProps = {
  value: 'cname',
  label: 'cname',
  children: 'children',
