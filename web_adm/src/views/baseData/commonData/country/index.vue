  ...
  <div class="menu">
      ...
      <div class="filter-containe search-layout">
        <div class="filter">
          <div class="search-containe">
            <div>
              <span class="filter-txt"> 国家代码: </span>
              <el-input
                clearable
                class="input-width"
                size="mini"
              ...
              ></el-input>
              <span class="filter-txt" style="margin-left:12px;"> 名称: </span>
              <el-input
                clearable
                class="input-width"
                size="mini"
                ...
                placeholder="中英文模糊查询"
              ></el-input>
              <span class="filter-txt" style="margin-left:12px;">是否启用:</span>
              <el-select
                filterable
                clearable
                size="mini"
    ...
    >
      <el-form
        ...
        label-suffix=":"
      >
        <el-form-item label="代码" label-width="100px" prop="countryCode">
          <el-input
            style="width: 80%"
            size="mini"
            :disabled="createItem.countryId != ''"
            v-model="createItem.countryCode"
          ></el-input>
          <!-- placeholder="请输入代码" -->
        </el-form-item>
       ...
       <el-form-item label="IATA分区" label-width="100px" prop="iata">
          <el-select
              style="width: 80%"
              filterable
              clearable
              size="mini"
              v-model="createItem.iata"
            >
            <!-- placeholder="请选择IATA分区" -->
              <el-option
                v-for="(o, key) in dictMap['iata']"
                :key="key"
                :label="$t(`dict.iata.${o.value}`)"
                :value="o.value"
              ></el-option>
            </el-select>
        </el-form-item>
...
<script>
import { countryList, countrySave } from "@/api/baseData";
...
export default {
  ...
  methods: {
    ...
    getList(isSearch) {
      ...
      countryList(this.tableQuery).then((res) => {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          countrySave(this.createItem).then((res) => {
