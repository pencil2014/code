<template>
	<div class="filter-flex">
		<div class="filter-search" :class="item.isReadOnly ? 'readOnly' : ''">
			...
			<div class="flex1">
				<div class="multi-select-tag" v-if="filterGroups[item.key]">
					<el-input
						...
						:placeholder="filterGroups[item.key].placeholder || 'Please input ' + filterGroups[item.key].label"
						...
						<span class="number-range-class">
							<el-input-number 
							  v-model="minNumber"
								...
								:precision="0"
								size="small"
								:placeholder="filterGroups[item.key]['min-placeholder'] || 'Minimum value'" 
							...
							<el-input-number 
							  v-model="maxNumber" 
								...
								:precision="0"
								size="small"
								:placeholder="filterGroups[item.key]['max-placeholder'] || 'Maximum value'" 
								@change="numberRangeChange"
								>
							</el-input-number>
						</span>
          ...
          <!-- 远程搜索 -->
          <el-select no-match-text="No matching data" no-data-text="No data" size="mini"  v-if="isShow&&filterGroups[item.key].type === 'remoteSelect'"
            v-model="item.value"
            filterable
            remote
            ref="remoteSelect"
            ...
            :placeholder="filterGroups[item.key].placeholder  || 'Please select ' + filterGroups[item.key].label"
          ...
          <el-select size="mini" no-match-text="No matching data" no-data-text="No data" v-if="filterGroups[item.key].type === 'select'"
            v-model="item.value"
            ref="select"
            :style="filterGroups[item.key].style || defaultStyle"
            :multiple="filterGroups[item.key].multiple"
          ...
          <!-- 日期和时间{date} --> 
               ...
               <el-date-picker size="mini"
									...
									:start-placeholder="filterGroups[item.key]['start-placeholder'] || 'Start time'"
									:end-placeholder="filterGroups[item.key]['end-placeholder'] || 'Ending time'"
									:placeholder="filterGroups[item.key].placeholder || 'Please select ' + filterGroups[item.key].label"
               ...
               <el-date-picker size="mini"
									...
									:placeholder="filterGroups[item.key]['start-placeholder'] || 'Start time'"
								...
								<el-date-picker size="mini"
									...
									:editable="filterGroups[item.key].editable"
									:clearable="filterGroups[item.key].clearable"
									:placeholder="filterGroups[item.key]['end-placeholder'] || 'Ending time'"
