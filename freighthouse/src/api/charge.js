...
// 询价列表导出
export function overSeasListExport(data) {
  return request({
    url: '/order/over/enquiry/overSeasList/export',
    method: 'post',
    data
  })
}
...
// 海外询价，报价备注
export function quoteRemark(data) {
  return request({
    url: '/order/over/enquiry/quote/remark',
    method: 'post',
    data
  })
}
// 海外询价，获取汇总信息
export function overSeasListSum(data) {
  return request({
    url: '/order/over/enquiry/overSeasList/sum',
    method: 'post',
    data
  })
}
...
export function feedbackCancel(data) {
  return request({
    url: '/order/over/enquiry/result/feedback/cancel',
    method: 'post',
    data
  })
}
// 海外询价，中标反馈接口
export function resultFeedback(data) {
  return request({
    url: '/order/over/enquiry/result/feedback',
    method: 'post',
    data
  })
}
// 海外询价，查询可选的工作单号列表
export function enquiryOrderList(data) {
  return request({
    url: '/order/over/enquiry/order/list',
    method: 'post',
    data
  })
}
// 订单页面的报价方案-所有的，包括已过期
export function viewQuotationSchemeAll(data) {
  return request({
    url: '/order/over/enquiry/quotation/bind/list',
    method: 'post',
    data
  })
}