...
// 所有状态的委托单位查询 包含废除的
export let customerListAllStatusNew = data => request({ url: '/crm/customer/customerInfo/all', method: 'post', data })
// 根据客商ID获取客商信息
...
const arr = [
  ...
  'freeze',//冻结供应商
  'unfreeze',//解冻供应商
  { api: 'activeRecord', baseUrl: 'crm/supplier/approve/record' }, //供应商活跃状态申请记录
  { api: 'activeVerify', baseUrl: 'crm/supplier/active/approve' }, //供应商活跃状态审核
  { api: 'verifyList', baseUrl: 'crm/supplier/verify/list' }, //供应商银行账户审核
