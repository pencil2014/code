...
// 特种柜月度汇总分页列表
export function listSpecialPage(data) {
  return request({
    url: '/fin/shLienMon/listSpecialPage',
    method: 'post',
    data
  })
}
export function getSpecialListAmtSummary(data) {
  return request({
    url: '/fin/shLienMon/getSpecialListAmtSummary',
    method: 'post',
    data
  })
}