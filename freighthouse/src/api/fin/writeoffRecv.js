...
// 外账会计凭证-收款核销列表
export function listAccountantExPage(data) {
  return request({
    url: '/fin/writeoffRecv/listAccountantExPage',
    method: 'post',
    data
  })
}
// 外账会计凭证-收款核销列表汇总
export function getAccountantExListAmtSummary(data) {
  return request({
    url: '/fin/writeoffRecv/getAccountantExListAmtSummary',
    method: 'post',
    data
  })
}
...
// 核销备注修改
export function checkRecvWriteoffOverduePayment(data) {
  return request({
    url: '/fin/custOverduePayment/checkRecvWriteoffOverduePayment',
    method: 'post',
    data
  })
}
// 可核销结算单列表金额汇总
export function getSettleOrderListAmtSummary(data) {
  return request({
    url: '/fin/writeoffRecv/getSettleOrderListAmtSummary',
    method: 'post',
    data
  })
}