...
export function getAuditLog(data) {
  return request({
    url: '/fin/settleOrderBaddebt/getAuditLog',
    method: 'post',
    data
  })
}
// 坏账申请修改审批人
export function modifyApprover(data) {
  return request({
    url: '/fin/settleOrderBaddebt/modifyApprover',
    method: 'post',
    data
  })
}
...
export function delApprover(data) {
  return request({
    url: '/fin/settleOrderBaddebt/delApprover',
    method: 'post',
    data
  })
}
// 坏账申请删除审批人
export function systemFeeList(data) {
  return request({
    url: '/fin/settleOrder/systemFeeList',
    method: 'post',
    data
  })
}
// 外账会计凭证-提成预销列表
export function baddebtPreOrderExListPage(data) {
  return request({
    url: '/fin/settleOrderBaddebt/baddebtPreOrderExListPage',
    method: 'post',
    data
  })
}
// 外账会计凭证-提成预销列表汇总
export function preOrderExListAmtSummary(data) {
  return request({
    url: '/fin/settleOrderBaddebt/preOrderExListAmtSummary',
    method: 'post',
    data
  })
}