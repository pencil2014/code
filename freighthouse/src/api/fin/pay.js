...
// 预付退款关联收款登记列表
export function listReceivableRegForPrePayRefund(data) {
  return request({
    url: '/fin/pay/order/listReceivableRegForPrePayRefund',
    method: 'post',
    data
  })
}
// 预付退款关联收款登记列表
export function listTransferFee(data) {
  return request({
    url: '/fin/receivableReg/listTransferFee',
    method: 'post',
    data
  })
}
...
// 外账核销列表
export function exAcctWriteoffPayPageList(data) {
  return request({
    url: '/fin/writeoffPay/exAcctWriteoffPayPageList',
    method: 'post',
    data
  })
}
// 外账核销列表汇总
export function exAcctWriteoffPayPageSummary(data) {
  return request({
    url: '/fin/writeoffPay/exAcctWriteoffPayPageSummary',
    method: 'post',
    data
  })
}
