...
// 银行流水列表汇总
export function bankListPageSummary(data) {
  return request({ url: '/fin/bankAccStatement/getListAmtSummary', method: 'post', data })
}
// 银行流水导入
...
// 标记流水是否参与对账
export function createReceivableReg(data) {
  return request({ url: '/fin/bankAccStatement/createReceivableReg', method: 'post', data })
}
