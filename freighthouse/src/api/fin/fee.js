...
// export function getOrderFeeStat(data) { // 废弃
//   return request({
...
export function listReceivableRegForWriteoff(data) {
  return request({
    url: '/fin/fee/listReceivableRegForWriteoff',
    method: 'post',
    data
  })
}
// 关联收款登记核销列表查询
export function toRefRegWriteoff(data) {
  return request({
    url: '/fin/fee/toRefRegWriteoff',
    method: 'post',
    data
  })
}
// 同步出口单费用
export function syncFeesFromExportOrder(data) {
  return request({
    url: '/fin/orderFee/syncFeesFromExportOrder',
    method: 'post',
    data
  })
}
// 订单费用-获取推送成本已录邮件信息
export function signEmailInfo(data) {
  return request({
    url: '/fin/orderFee/signEmailInfo',
    method: 'post',
    data
  })
}
// 订单费用-空运费用确认
export function confirmAirFee(data) {
  return request({
    url: '/fin/orderFee/confirmAirFee',
    method: 'post',
    data
  })
}
// 订单费用-空运费用确认详情
export function confirmAirFeeDetail(data) {
  return request({
    url: '/fin/orderFee/confirmAirFeeDetail',
    method: 'post',
    data
  })
}