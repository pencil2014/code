...
// 按jointNoOnline查订舱单详情
export function orderInfoBookOnline(data) {
	return request({
		url: '/order/shiporder/spacebook/order/info/bookonline',
		method: 'post',
		data
	})
}
...
// 查做柜接口 order/shiporder/spacebook/so/queryCn
export function doSoQueryCn(data) {
	return request({
		url: `/order/shiporder/spacebook/so/queryCn`,
		method: 'post',
		data
	})
}

//获取未回复列表接口 order/shiporder/spacebook/so/unReplyList
export function getSoUnReplyList(data) {
	return request({
		url: `/order/shiporder/spacebook/so/unReplyList`,
		method: 'post',
		data
	})
}

// 做柜回复 order/shiporder/spacebook/so/reply
export function soReplyTo(data) {
	return request({
		url: `/order/shiporder/spacebook/so/reply`,
		method: 'post',
		data
	})
}