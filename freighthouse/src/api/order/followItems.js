...
// 获取自定义过表头的人员信息 /base/webapi/listColumnConfig/employee/list
export function getColumnConfigEmployeeList(data) {
  return request({
    url: '/base/webapi/listColumnConfig/employee/list',
    method: 'post',
    data
  })
}

// 获取自定义过表头的字段及列宽 /base/webapi/listColumnConfig/employee/config
export function getColumnConfigEmployeeConfig(data) {
  return request({
    url: '/base/webapi/listColumnConfig/employee/config',
    method: 'post',
    data
  })
}

// 修改 ATA 和 ATD /order/shiporder/updateAtaAtd
export function updateAtaAtd(data) {
  return request({
    url: '/order/shiporder/updateAtaAtd',
    method: 'post',
    data
  })
}
