...
// 获取客户资质认证审核是否通过
export function orderMainCustCheck(data) {
	return request({
		url: `/order/main/cust/check`,
		method: 'post',
		data
	})
}
// CY LOCATION下拉数据
export function orderCyList(data) {
	return request({
		url: `/order/cy/list`,
		method: 'post',
		data
...
// 起运港拖柜复制
export function fclTruckIntrustCopy(data) {
	return request({
		url: `/order/shipping/fclTruckIntrust/copy`,
		method: 'post',
		data
	})
}
...
export function importApplyList(data) {
	return request({
		url: '/order/main/import/apply/list',
		method: 'post',
		data
	})
}
// 撤回推送海外分公司
export function importApplyCancel(data) {
	return request({
		url: '/order/main/import/apply/cancel',
		method: 'post',
		data
	})
}
...
// 放舱联系人信息查询
export function releaseContactInfo(data) {
	return request({
...
// 海运进口整箱 客户自订 同步服务项
export function importServiceSync(data) {
	return request({
		url: `/order/main/import/service/sync`,
		method: 'post',
		data
	})
}
// 海运进口整箱 客户自订 提单
export function orderMainImportSync(data) {
	return request({
		url: `/order/main/import/sync`,
		method: 'post',
		data
	})
}
...
// 返回首个M单的详情 /order/shipping/bl/detail/first
export function getBlDetailFirst(data) {
	return request({
		url: '/order/shipping/bl/detail/first',
		method: 'post',
		data
	})
}
// 获取收发通
export function mainCustMblContact(data) {
	return request({
		url: '/order/main/cust/mbl/contact',
		method: 'post',
		data
	})
}
...
// 仓储入仓附件列表
export function warehouseInWmsInFiles(data) {
	return request({
		url: '/order/warehouseIn/wmsInFiles',
		method: 'post',
		data
	})
}
// 仓储出仓附件列表
export function warehouseOutWmsOutFiles(data) {
	return request({
		url: '/order/warehouseOut/wmsOutFiles',
		method: 'post',
		data
	})
}
// 仓储订单附件列表
export function fileWmsList(data) {
	return request({
		url: '/order/shiporder/file/wmsList',
		method: 'post',
		data
	})
}
