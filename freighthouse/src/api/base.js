...
// 获取部门自定义表头 /base/webapi/listColumnConfig/dept/config
export function listColumnConfigDeptConfig(data) {
	return request({
		url: '/base/webapi/listColumnConfig/dept/config',
		method: 'post',
		data
	})
}
// 部门自定义表头新增 /base/webapi/listColumnConfig/dept/save
export function listColumnConfigDeptSave(data) {
	return request({
		url: '/base/webapi/listColumnConfig/dept/save',
		method: 'post',
		data
	})
}
...
// 港口下拉
export function basePortList(portName, portAttribute, state, portType) {
	state = state || ''
	return request({
		url: '/base/webapi/port/portList',
		method: 'post',
		data: { portName, portAttribute, state, portType }
	})
}
// 铁路站点下拉
...
//模糊搜索申请人
export function hscodeGetApplyList(data) {
	return request({
		url: '/base/webapi/hscode/getApplyList',
		method: 'post',
		data
	})
}
...
// 货品附件列表
export function hscodeFileList(data) {
	return request({
		url: '/base/webapi/hscode/fileList',
		method: 'post',
		data
	})
}
// 一级、二级分类下拉选项
export function hscodeTypeList(data) {
	return request({
		url: '/base/webapi/hscode/typeList',
		method: 'post',
		data
	})
}
// 货品名称新增
export function saveHscode(data) {
	return request({
		url: '/base/webapi/hscode/saveHscode',
		method: 'post',
		data
	})
}
// 货品名称列表
export function hscodePageList(data) {
	return request({
		url: '/base/webapi/hscode/hscodePageList',
		method: 'post',
		data
	})
}
// 货品审核列表
export function hscodeAuditPageList(data) {
	return request({
		url: '/base/webapi/hscode/hscodeAuditPageList',
		method: 'post',
		data
	})
}
// 货品名称禁用
export function hscodeChangeStatus(data) {
	return request({
		url: '/base/webapi/hscode/changeStatus',
		method: 'post',
		data
	})
}
// 货品名称审核
export function hscodeAudit(data) {
	return request({
		url: '/base/webapi/hscode/audit',
		method: 'post',
		data
	})
}
...
//分页调用的进口单申请列表
export function importApplyListPage(data) {
	return request({
		url: '/order/main/import/apply/list/page',
		method: 'post',
		data
	})
}
//出口转进口申请同意
export function importApplyAccept(data) {
	return request({
		url: '/order/main/import/apply/accept',
		method: 'post',
		data
	})
}
//出口转进口申请拒绝
export function importApplyRefuse(data) {
	return request({
		url: '/order/main/import/apply/refuse',
		method: 'post',
		data
	})
}
...
// 托书识别结果 /order/shiporder/file/getBookParseResult
export function getBookParseResult(data) {
	return request({
		url: '/order/shiporder/file/getBookParseResult',
		method: 'post',
		data
	})
}
...
// 获取海外商务对应的海外客服
export function pricingCustomer(data) {
	return request({
		url: '/order/work/oversea/pricing/customer',
		method: 'post',
		data
	})
}
...
export function sendVerificationCode(data) {
	return request({
		url: '/base/webapi/sysUser/sendVerificationCode',
		method: 'post',
		data
	})
}
...
// 新增品名分类
export function saveHscodeType(data) {
	return request({
		url: '/base/webapi/hscode/saveHscodeType',
		method: 'post',
		data
	})
}
// 编辑品名分类
export function editHscodeType(data) {
	return request({
		url: '/base/webapi/hscode/editHscodeType',
		method: 'post',
		data
	})
}
// 品名分类列表
export function hscodeTypePageList(data) {
	return request({
		url: '/base/webapi/hscode/hscodeTypePageList',
		method: 'post',
		data
	})
}
// 品名分类禁用
export function typeChangeStatus(data) {
	return request({
		url: 'base/webapi/hscode/typeChangeStatus',
		method: 'post',
		data
	})
}
