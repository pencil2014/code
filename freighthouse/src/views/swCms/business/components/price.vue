<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="45HQ" prop="priceHq45">
        <el-input v-model="form.priceHq45" :placeholder="getPlaceholder('priceHq45')"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        priceHq45: { required: true, message: ' ', trigger: 'change' },
  ...
  created() {
    if (this.option.type === 'edit') {
      ...
      Object.assign(this.form, {
        ...
        priceHq45: discountPriceHq45 - priceHq45,
      })
    }
    let { priceGp20 = 0, priceGp40 = 0, priceHq40 = 0, priceHq45 = 0 } = this.option.data
    this.basePrice = {
      priceGp20,
      priceGp40,
      priceHq40,
  ...
  methods: {
    ...
    submit() {
      this.$refs['form'].validate((valid) => {
        if (valid) {
          let reg = /^(\-|\+)?\d+(\.\d+)?$/
          let { priceGp20, priceGp40, priceHq40, priceHq45 } = this.form
          if (
            !reg.test(priceGp20) ||
            !reg.test(priceGp40) ||
            !reg.test(priceHq40) ||
          ...
          if (this.checkNum(priceGp20, 'priceGp20') || this.checkNum(priceGp40, 'priceGp40') || this.checkNum(priceHq40, 'priceHq40') || this.checkNum(priceHq45, 'priceHq45')) {
