...
// const tinymceCDN = '//cdn.jsdelivr.net/npm/tinymce-all-in-one@4.9.3/tinymce.min.js' // //cdnrs.longsailing.net/tinymce/tinymce.min.js
        ...
        images_upload_handler(blobInfo, success, failure, progress) {
          ...
          _this.$store
            ...
            .then((res) => {
              ...
              let { data } = res.data
              // let url = 'http://lstest.com/base/fileView/preview/b53793022c0d488dbe2a4bc82dcc4398/close_eye.png'
              // let url = 'http://localhost:9528/base/fileView/preview/5bc8472563834156bf61dd47b5db8ae9/sowoll'
              let url = `${location.origin}/base/fileView/preview/${data.fileNo}/sowoll`
              success(url)
            })
        },
      })
