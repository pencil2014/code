    ...
    <div class="content-box">
        ...
        <div class="form-wrap">
            <el-form ref="form" :model="form" :rules="rules" inline label-width="80px" class="edit-form">
              ...
              <div>
                <el-form-item label-width="80px" prop="content" :show-message="false">
                  <span slot="label">
                        <span class="span-box">
                            <span style="color: #ff1e2f; margin-right: 3px">*</span>
                            <span>内容</span>
                  ...
                  <tinymce class="mail-sign-rich-text" :toolbar="tinymceConfig.toolbar" :menubar="tinymceConfig.menubar" v-model="form.content" :height="180" :width="1250" ref="content" />
                </el-form-item>
              </div>
            </el-form>
        </div>
