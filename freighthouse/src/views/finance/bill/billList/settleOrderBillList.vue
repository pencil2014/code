    ...
    this.searchOption1 = {
      ...
      addFilter: {
        ...
        filterGroups: {
          ...
          settleOrderBillNo: { label: '系统账单编号', type: 'input', showType: '3' },
          ...
          billType: { label: '账单类型', type: 'select', showType: '6',
            selectOptions: [
              { label: '明细', value: 'detail'},
              { label: '汇总', value: 'sum' }
            ]
          },
          billFeeType: { label: '对账单费用类型', type: 'select', prop: 'billFeeType', showType: '6' }
        }
      }
    }
