  ...
  data() {
    ...
    return {
      ...
      selfColumnsBase: [
        ...
        { prop: 'businessType', label: '业务类型', type: 'select', width: 130 },
    ...
    this.searchOption = {
      ...
      addFilter: {
        ...
        filterGroups: {
          ...
          sourceBizNos: { label: '工作单号', type: 'input' },
          ...
          createdTime: { label: '创建时间', type: 'daterange', format: 'yyyy-MM-dd', ranges: ['beginDate', 'endDate'] },
          // TODO
          confirmBy: {
            label: '确认人',
            type: 'remoteSelect',
