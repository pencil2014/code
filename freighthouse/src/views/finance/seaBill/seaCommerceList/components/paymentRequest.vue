    ...
    <div class="finance-list-container">
      ...
      <div class="payment-request-form">
        ...
        >
          ...
          <el-form-item label="付款币种：" prop="settleCurrency">
            <el-select
          ...
          <el-form-item label="付款方式：" prop="payWay">
            <el-select v-model="paymentRequestForm.payWay" placeholder="请选择" @change="changePayway">
              <el-option v-for="(o, key) in payWayArr" :key="key" :label="o.label" :value="o.value"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="付款金额：" prop="payAmt" style="width:610px;">
            <div>
              <!-- style="width:200px" -->
              <el-input
...
export default {
  ...
  created() {
    ...
    let columns = [
      ...
      // { prop: 'orderNo', label: '工作单号', type: 'text', width: 150, st: 1 },
      ...
      { prop: 'currency', label: '币种', type: 'text', st: 2 },
      ...
      { prop: 'settleCurrency', label: '付款币种', type: 'text', st: 2 },
      { prop: 'settleRate', label: '汇率', type: 'text' },
      { prop: 'settleAmt', label: '付款金额', type: 'text' },
