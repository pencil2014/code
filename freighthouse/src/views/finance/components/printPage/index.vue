...
export default {
  ...
  created() {
    ...
    this.option1.columns = [
      ...
      { prop: 'gedgingApplyNo', label: '对冲编号', type: 'text', forceWidth: 118 },
      { prop: 'rivalCorpName', label: '结算单位', type: 'text', forceWidth: 122 },
      { prop: 'gedgingType', label: '对冲类型', type: 'select', forceWidth: 70 },
      { prop: 'gedgingSubType', label: '对冲子类型', type: 'select', forceWidth: 80 },
      { prop: 'gedgingCurrency', label: '币种', type: 'text', forceWidth: 40 },
      { prop: 'sumDescript', label: '对冲金额', type: 'text', forceWidth: 128 },
      { prop: 'createdName', label: '申请人', type: 'text', forceWidth: 70 },
      { prop: 'createdTime', label: '申请时间', type: 'text', forceWidth: 76 },
      { prop: 'writeoffName', label: '审核人', type: 'text', forceWidth: 70 },
      { prop: 'writeoffTime', label: '审核时间', type: 'text', forceWidth: 76 },
    ]
