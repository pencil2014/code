      ...
      <div class="el-col filter-left">
        ...
        >
          <template v-for="(child, key) in filterGroups">
            <el-option :key="key" :label="child.label" :value="key" :disabled="child.disabledInAdd"></el-option>
          </template>
        </el-select>
      </div>
      <div
        ...
        <div class="multi-select-tag" v-else-if="filterGroups[item.key]">
          ...
          >
            <el-input
              ref="range1"
              size="mini"
              v-lsNumber="{value:filterGroups[item.key].inputType||'number', obj:item.range, key:'min',positive:filterGroups[item.key].positive}"
              style="width:80px"
            ...
            <el-input
              ref="range2"
              size="mini"
              v-lsNumber="{value:filterGroups[item.key].inputType||'number', obj:item.range, key:'max', positive:filterGroups[item.key].positive}"
              style="width:80px"
