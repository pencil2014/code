<template>
  ...
  >
    <div class="finance-list-container">
      ...
      <div class="money-box">
        <div class="money-box-left">
          <el-button class="finance-btn" type="primary" @click="exportData" size="mini">导出</el-button>
          <el-button
  ...
  created() {
      ...
      colgroups: [
        {
          ...
          columns: [
            ...
            { prop: 'bankReceivePayDate', label: '收付日期', type: 'text', width: 100 },
            ...
            { prop: 'bankCurrency', label: '币种', type: 'text', width: 60 },
            { prop: 'bankAmt', label: '金额', type: 'text', width: 80 },
        ...
        },
        {
          ...
          className: 'system',
          columns: [
            { prop: 'sysReceivePayDate', label: '收付日期', type: 'text', width: 100 },
            ...
            { prop: 'sysCurrency', label: '币种', type: 'text', width: 60 },
            { prop: 'sysAmt', label: '金额', type: 'text', width: 80 },
    ...
    if (!this.isPay) {
      columns = [
        ...
        { prop: 'writeoffName', label: '核销人', type: 'text', width: 100 },
        { prop: 'writeoffTime', label: '核销时间', type: 'text', width: 130 },
