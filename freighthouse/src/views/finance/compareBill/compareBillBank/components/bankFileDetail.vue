    ...
    >
      <div class="money-box money-box-border-bottom">
        ...
        <div class="money-box-right">
          ...
          <el-button class="finance-btn" size="mini" @click="delRecord" type="danger">批量删除</el-button>
...
export default {
  ...
  created() {
    ...
    let columns = [
      ...
      { prop: 'receivePayType', label: '收付类型', type: 'select', width: 80, propInDict: 'receipayType' },
