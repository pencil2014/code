  ...
  <div class="finance-list-container">
    <div class="money-box">
      <div class="money-box-left">
        <el-button class="finance-btn"  @click="handleExport" size="mini"	>导出</el-button>
      </div>
  ...
  created(){
    this.searchOption1 = {
      ...
      addFilter: {
        ...
        filterGroups: {
          compareConsistent: { label: '对比结果', type: 'select', selectOptions:this.compareConsistent, placeholder: '请选择', showType: '1' },
          ...
          writeoffType: { label: '核销类型', type: 'select', prop:'dzgMonitorWriteoffType', placeholder: '请输入', showType: '2' },
          writeoffDate: { label: '核销时间', type: 'daterange', placeholder: '请选择', showType: '3' },
        }
      }
    }
    ...
    this.selfColumnsBase = this.columnsBaseLocal = [ // let columns = 
      ...
      { prop: 'writeoffType', label: '核销类型', sortable: false, type: 'select', propInDict:"dzgMonitorWriteoffType" },
      ...
      { prop: 'writeoffDate', label: '核销时间', type: 'text', width: 100 },
      ...
      { prop: 'differenceAmt', label: '差额', type: 'text' },
    ]
