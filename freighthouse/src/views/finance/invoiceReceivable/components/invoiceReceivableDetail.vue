    ...
    <div class="finance-list-container">
      <div class="money-box money-box-border-bottom">
        ...
        <div class="money-box-right">
          <el-button-group v-if="canCreateElecInvoice">
            <el-button
              class="finance-btn"
          ...
          <el-button-group v-if="invoiceTableList.length">
            <el-button class="finance-btn" @click="previewInvoiceAll" size="mini">预览发票</el-button>
          </el-button-group>
    ...
    <el-form :model="invoiceForm" ref="form" :inline="true" size="mini" label-width="100px">
      <div class="settlement-detail-form">
        ...
        <div>
          ...
          <DetailDiv
            label="开票状态："
            :content="dictMapObj['invoiceApplyStatus'][invoiceForm.invoiceApplyStatus]"
          />
...
import { info, getPaperInvoiceList, createElectronicInvoiceBatch } from '@/api/fin/invoiceReceivableApply'
import {
  info as detail,
...
export default {
      ...
      this.$confirmWarn(
        {
          body: `
        <p>请确认是否立马生成电子发票？</p>
        <p>发票张数：${this.invoiceTableList.length}，开票币种：${this.invoiceForm.invoiceCurrency}，开票金额：${this.invoiceForm.amt}</p>`,
          title: '电子票生成确认',
          dangerouslyUseHTMLString: true,
          customClass: 'ls__noicon',
        },
        () => {
          this.lsLoading = true
          createElectronicInvoiceBatch({ invoiceReceivableApplyIds: [this.rowData.invoiceReceivableApplyId] })
            .then((res) => {
  ...
  computed: {
    ...
    canCreateElecInvoice() {
      console.log(
        this.isApply,
        this.invoiceForm.invoiceApplyStatus,
        this.invoiceForm.invoiceType,
        this.invoiceForm.invoiceType.indexOf('electronic') > -1,
        this.invoiceForm.invoiceWay
      )
      return (
        this.isApply &&
        this.invoiceForm.invoiceApplyStatus === 'no_invoice' &&
        this.invoiceForm.invoiceType.indexOf('electronic') > -1 &&
        this.invoiceForm.invoiceWay === 'system'
      )
    },
  },
}
