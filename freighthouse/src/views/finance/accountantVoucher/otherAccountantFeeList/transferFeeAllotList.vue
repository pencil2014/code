...
export default {
  ...
  created() {
    this.searchOption1 = {
      ...
      addFilter: {
        ...
        filterGroups: {
          ...
          writeoffTime: { label: '核销时间', type: 'lsDatetimerange', showType: '6', format: 'yyyy-MM-dd HH:mm:ss' },
          receipayDate: { label: '收付日期', type: 'lsDaterange', format: 'yyyy-MM-dd' },
          settleCompCode: {
            label: '分公司',
            prop: 'settleCompCode',
            type: 'remoteSelect',
    ...
    this.selfColumnsBase = this.columnsBaseLocal = [ // let columns =
      ...
      { prop: 'finDate', label: '财务日期', type: 'text', width: 100 },
      { prop: 'writeoffDate', label: '核销日期', type: 'text', width: 100 },
