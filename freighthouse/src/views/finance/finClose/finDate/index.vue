  ...
  >
    ...
    <el-dialog title="修改" :visible.sync="dialogShow" width="400px" @close="dialogShow = false">
      ...
      >
        ...
        <el-form-item label="财务日期" prop="finDate">
          <el-date-picker
            style="width:250px"
            disabled
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" size="mini" @click="sureSet">确定</el-button>
        <el-button @click="dialogShowSet = false" size="mini">取消</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    this.searchOption = {
      ...
      addFilter: {
        ...
        filterGroups: {
          ...
          createdTime: { label: '创建时间', type: 'daterange', showType: '5' },
          updatedTime: { label: '更新时间', type: 'daterange', showType: '5' },
          finDate: { label: '财务日期', type: 'date', showType: '8', format: 'yyyy-MM-dd' },
        },
      },
    }
    ...
    let columns = [
      { prop: 'settleCompName', label: '分公司', width: 200 },
