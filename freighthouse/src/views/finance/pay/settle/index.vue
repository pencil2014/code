  ...
  created() {
    this.searchOption1 = {
      ...
      addFilter: {
        ...
        // 条件数组
        searchInputGroup: [
          { key: 'allNo', value: '', range: { min: '', max: '' } },
          { key: 'hasInvoice', value: '', range: { min: '', max: '' } },
          { key: 'recvCorpCode', value: '', range: { min: '', max: '' } },
          { key: 'currency', value: '', range: { min: '', max: '' } },
          { key: 'payAmt', value: '', range: { min: '', max: '' } },
          { key: 'applyDate', value: '', range: { min: '', max: '' } },
        ],
        filterGroups: {
          allNo: {
            label: '各类单号',
          ...
          applyNo: { label: '付款申请号', type: 'input' },
          invoiceNo: { label: '发票号', type: 'input' },
          invoiceRegNo: { label: '发票登记号', type: 'input' },
          ...
          recvBankName: { label: '收款银行', type: 'input' },
