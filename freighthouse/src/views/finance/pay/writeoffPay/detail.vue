      ...
      <div class="money-box money-box-border-bottom">
        ...
        <div class="money-box-right">
          ...
          <el-button-group v-if="voucherNos && checkAuth($route.name, 'btn-delVoucher')">
            <el-button @click="delVoucher" class="finance-btn" size="mini" type="danger">删除运营凭证</el-button>
          </el-button-group>
          ...
          <el-button-group v-if="!voucherNos && checkAuth($route.name, 'btn-batchPrintCreate')">
            <el-button @click="batchPrintCreate2(true)" class="finance-btn" size="mini" type="inner">预览运营凭证</el-button>
          </el-button-group>
          ...
          <el-button-group v-if="!voucherNos && checkAuth($route.name, 'btn-voucherNo')">
            <el-button @click="batchPrintCreate2(false)" class="finance-btn" size="mini" type="inner">生成运营凭证</el-button>
          </el-button-group>
          <el-button-group v-if="exVoucherNos && checkAuth($route.name, 'btn-delVoucher')">
            <el-button @click="delVoucher2" class="finance-btn" size="mini" type="danger">删除会计凭证</el-button>
          </el-button-group>
          <!-- <el-button-group v-if="!writeoffPay.voucherNo && checkAuth($route.name, 'btn-batchPrintCreate')"> -->
          <el-button-group v-if="!exVoucherNos && checkAuth($route.name, 'btn-batchPrintCreate')">
            <el-button @click="batchPrintCreate2(true, true)" class="finance-btn" size="mini" type="outer">预览会计凭证</el-button>
          </el-button-group>
          <!-- <el-button-group v-if="!writeoffPay.voucherNo && checkAuth($route.name, 'btn-voucherNo')"> -->
          <el-button-group v-if="!exVoucherNos && checkAuth($route.name, 'btn-voucherNo')">
            <el-button @click="batchPrintCreate2(false, true)" class="finance-btn" size="mini" type="outer">生成会计凭证</el-button>
          </el-button-group>
      ...
      <div class="payInfo-box" style="height: calc(100vh - 95px);">
        ...
        <div class="item-box">
          ...
          <div class="info-box">
            ...
            <DetailDiv label="复核状态：" :content="renderPropLabel('writeoffRecheckStatus', writeoffPay.recheckStatus)" :isIcon="writeoffPay.recheckStatus==='no_check'?true:false" />
            <DetailDiv label="复核人：" :content="writeoffPay.recheckName" />
            <DetailDiv label="复核日期：" :content="writeoffPay.recheckTime" />
