			...
			<div :class="{ 'finance-order-fee-main-cont': !feeEmbed }">
				...
				<div :class="{ 'finance-order-fee-main': !feeEmbed }">
					<div v-if="!hideNoBox" class="order-no-box">
						<div class="order-no-one" style="font-weight:bold;"><!-- <div class="order-icon-box"></div> -->工作号：{{ orderNo+(orderInfo.businessType?'('+(dictMapObj['businessType'][orderInfo.businessType]||orderInfo.businessType)+')':'') }}</div>
