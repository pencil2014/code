    ...
    <div class="finance-table-container">
      <div class="money-box">
        ...
        <div class="money-box-right">
          <el-button-group>
            <el-button v-if="checkAuth(pageCode, 'tab-managementFee', 'btn-createSettlement')" class="finance-btn" @click="createSettlement" size="mini">生成结算单</el-button>
          </el-button-group>
        </div>
      </div>
      <FinanceTable
    ...
    getData() {
      ...
      orderFeeList(data).then(res => {
        ...
        if (res.code === 0) {
          ...
          let columns = ['settleCompName', 'settleCorpName', 'feeName', 'feeAmt', 'currency', 'settleCycle', 'finDate', 'acfinDate', 'remark', 'writeoffNos', 'taxRate', 'feeEnName']
          let arr = []
