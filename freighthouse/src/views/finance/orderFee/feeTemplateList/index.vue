  ...
  >
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="saveSortNum" size="mini" type="primary">确定</el-button>
        <el-button @click="sortNumVisible = false" size="mini">取消</el-button>
      </span>
    </el-dialog>
  </div>
</template>
    ...
    this.searchOption1 = {
      ...
      addFilter: {
        ...
        filterGroups: this.isSelect ? {
          ...
          createdTime: { label: '创建时间', type: 'daterange', showType: '6' },
        } : {
          tempNo: { label: '模板编号', type: 'input', showType: '1' },
          tempName: { label: '模板名称', type: 'input', showType: '2' },
          businessType: { label: '业务类型', type: 'select', showType: '3', prop: 'businessType' },
