    ...
    <div class="settlement-detail-form settlement-detail-form-own">
      ...
      >
        ...
        <DetailDiv
          ...
          :isTooltip="true"
        />
        <el-form-item v-else label="分公司：" prop="settleCompName">
          <el-select v-model="settlementDetailForm.settleCompObj" placeholder="请选择">
        ...
        <h3 v-if="badDebtList.data.length">坏账申请</h3>
      ...
      <div class="money-box">
        ...
        <div class="money-box-right">
          ...
          <el-button-group
            v-if="(!isDetailPage || !finLockOrInvoiceOrCloseOrWriteOff) && canEdit && checkAuth($route.name, 'btn-addFee')"
          >
            <el-button class="finance-btn" type="danger" @click="delMulti" size="mini">删除费用</el-button>
          </el-button-group>
        </div>
      </div>
      <DetailFeeSearch
...
export default {
  ...
  methods: {
    ...
    delMulti() {
      ...
      if(!rows.length){
        return  this.$msgErrClose('请选择要删除的费用!')
      }
