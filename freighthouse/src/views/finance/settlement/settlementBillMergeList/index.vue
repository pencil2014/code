...
<div class="finance-page"
  ...
  <el-dialog
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="primary" @click="mergeSubmit" size="mini" :loading="loading">提交</el-button>
      <el-button @click="importDialogVisible = false" size="mini">取消</el-button>
    </span>
  </el-dialog>
</div>
</template>
  ...
  created() {
    ...
    this.searchOption1 = {
      ...
      addFilter: {
        ...
        filterGroups: {
          mergeNo: { label: '合并编号', type: 'input', placeholder: '请输入', showType: '1' },
          settleOrderNo: { label: '结算单号', type: 'input', placeholder: '请输入', showType: '2' },
          settleCorpCode: { label: '结算单位', prop: 'settleCorpCode', type: 'remoteSelect', showType: '3',
          ...
          createdTime: { label: '合并时间', type: 'daterange', placeholder: '请选择', showType: '5' },
        }
      }
    }
    ...
    let columns = [
      ...
      { prop: 'settleOrderNos', label: '结算单号', type: 'columnTip',
        width: 130,
        component: 'ColumnTip',
        componentProps: {
          show: false,
