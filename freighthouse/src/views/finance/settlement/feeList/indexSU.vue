      ...
      <div class="finance-list-container">
        <div class="money-box">
          <div class="money-box-left">
            ...
            <el-button-group>
              <el-button v-if="checkAuth($route.name, 'btn-export')" class="finance-btn" @click="handleCommand('settleUnit')" size="mini">导出</el-button>
              <!-- <div
...
export default {
  ...
  created() {
    ...
    let filterKeys = [
      ...
      'bdEmployeeId', 'opEmployeeId', 'bdDeptCode', 'pricingEmployeeId', 'shipCarrierCodes', 'invoiceNo',
      'invoiceStatuss', 'writeoffStatuss', 'podPortCode', 'polPortCode', 'currency', 'receipayType', 'custIntrustNo', 'whPoNo'
  ...
  methods: {
    ...
    handleCommand(command) {
      if (!this.option1.data.length) {
        return this.$message({ message: '请先搜索数据再导出', type: 'error', showClose: true })
      }
      let { prop, order } = this.sortParams
      if (prop === 'serviceCode') prop = 'serviceName'
      let data = {
