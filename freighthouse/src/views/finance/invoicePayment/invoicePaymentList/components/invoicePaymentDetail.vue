  ...
  <div class="finance-page"
    ...
    >
      ...
      <div class="settlement-detail-form invoice-detail-form-border-bottom">
          ...
          <el-form-item label="签收日期" prop="receiveTime">
            <el-date-picker v-model="invoicePaymentAddForm.receiveTime" disabled placeholder=""></el-date-picker>
          </el-form-item>
  ...
  methods: {
    init(){
      ...
      this.selfColumnsBase = [
        ...
        { prop: 'acfinDate', label: '会计日期', type: 'text', width: 100},
      ]
