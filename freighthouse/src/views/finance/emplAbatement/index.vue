		...
		this.searchOption2 = {
			...
			addFilter: {
				...
				filterGroups: {
					...
					writeoffNo: { label: '核销编号', type: 'input', showType: '1' },
          ...
          sourceType: { label: '来源', type: 'select', prop: 'emplAbatementSourceType', showType: '4' },
					...
					finDate: { label: '财务日期', type: 'daterange', showType: '6' },
					createdDate: { label: '创建时间', type: 'daterange', showType: '6' },
            ...
            queryPayOrderByWriteoffNo(data).then(res => {
              if (res.code === 0) {
                ...
                if (writeoffType === 'gedging_writeoff') {
                  ...
                  this.routerPush('BadOrderDetail', {source: 'detail', writeoffNopayNo: row.writeoffNo })
                } else {
