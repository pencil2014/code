<template>
	<div class="edit-container-exec">
		<div class="edit-row">
			<div class="row-tit">
				<span class="tit">冷箱订舱产品/产品详情</span>
		...
		<div class="edit-row">
			...
			<div class="orderCard">
				<section class="order-section">
					...
					<el-table v-if="createItem.intermodalService" :data="dischargeServices.list" style="width: 600px">
						<el-table-column v-for="(item,index) in dischargeServices.tableList" header-align="center" align="center" :property="item.prop" :label="item.label" :key="index + item.prop"></el-table-column>
						<!-- <el-table-column header-align="center" align="center" property="cntrType" label="40GP"></el-table-column>
            <el-table-column header-align="center" align="center" property="cntrType" label="40HQ"></el-table-column>-->
					</el-table>
				</section>
			</div>
			<div class="orderCard">
            ...
            <el-table-column width="200" header-align="center" align="center" property="estimateWeight" label="每箱预估重量">
              <template slot-scope="scope">
                <el-input v-model="scope.row.estimateWeight" placeholder="请输入" style="width: 120px" size="mini"><template slot="append">TON</template></el-input>
              </template>
            </el-table-column>
      ...
      <el-form :model="createItem" :rules="rules" ref="createItemForm" @keyup.enter.native="submitForm('createItemForm')" label-suffix=":" label-width="80px">
				<div class="orderCard">
					<section class="order-section">
						...
						<div>
							<el-row>
								<el-col :span="8">
									<el-form-item label="货物描述" prop="cargoInfo.desc"  label-width="100px">
										<el-input style="width: 80%" size="mini" v-model="createItem.cargoInfo.desc"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="8">
									<el-form-item label="包装类型" prop="cargoInfo.packageType"  label-width="100px">
										<!-- <el-input
											style="width: 80%"
											size="mini"
											v-model="createItem.cargoInfo.packageType"
										></el-input> -->
								...
								<el-col :span="8">
									<el-form-item label="货物数量" prop="cargoInfo.quantity"  label-width="100px">
										<el-input size="mini" min="1"  style="width: 80%"  v-model="createItem.cargoInfo.quantity" oninput="if(isNaN(value)){ value=value.slice(0,value.length-1)} if(value.indexOf('.')>0){value=value.slice(0,value.indexOf('.')+3)}"></el-input>
									</el-form-item>
								</el-col>
							</el-row>
							<el-row>
								<el-col :span="8">
									<el-form-item label="重量" prop="cargoInfo.weight"  label-width="100px">
								...
								<el-col :span="8">
									<el-form-item label="体积" prop="cargoInfo.volume"  label-width="100px">
								...
								<el-col :span="8">
									<el-form-item label="备注" prop="cargoInfo.remarks"  label-width="100px">
										<el-input size="mini" v-model="createItem.cargoInfo.remarks"  style="width: 80%" ></el-input>
									</el-form-item>
								</el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
									<el-form-item label="冻柜温度类型" prop="cargoInfo.reeferTemperatureType" label-width="100px">
                    <el-select size="mini" clearable v-model="createItem.cargoInfo.reeferTemperatureType" placeholder="请选择"  style="width: 80%" >
                      <el-option
                        v-for="item in dictMap['coscoReeferTemperatureType']"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                      </el-option>
                ...
                <el-col :span="8">
									<el-form-item label="冻柜温度值" prop="cargoInfo.reeferTemperatureValue"  label-width="100px">
										<el-input size="mini" v-model="createItem.cargoInfo.reeferTemperatureValue"  style="width: 80%" ></el-input>
									</el-form-item>
								</el-col>
                <el-col :span="8">
									<el-form-item label="冻柜通风类型" prop="cargoInfo.reeferVentilationType"  label-width="100px">
                    <el-select size="mini" clearable v-model="createItem.cargoInfo.reeferVentilationType" placeholder="请选择"  style="width: 80%" >
                      <el-option
                        v-for="item in dictMap['coscoReeferVentilationType']"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                      </el-option>
              ...
              <el-row>
                <el-col :span="8">
									<el-form-item label="冻柜通风值" prop="cargoInfo.reeferVentilationValue"  label-width="100px">
										<el-input size="mini" v-model="createItem.cargoInfo.reeferVentilationValue"  style="width: 80%" ></el-input>
									</el-form-item>
								</el-col>
                <el-col :span="8">
									<el-form-item label="冻柜湿度类型" prop="cargoInfo.reeferGenSetType"  label-width="100px">
										<el-select size="mini" clearable v-model="createItem.cargoInfo.reeferGenSetType" placeholder="请选择"  style="width: 80%" >
                      <el-option
                        v-for="item in dictMap['coscoReeferGensetType']"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                      </el-option>
                ...
                <el-col :span="8">
									<el-form-item label="冻柜湿度值" prop="cargoInfo.reeferHumidityValue"  label-width="100px">
										<el-input size="mini" v-model="createItem.cargoInfo.reeferHumidityValue" style="width: 80%" ></el-input>
									</el-form-item>
								</el-col>
				...
				<section class="order-section">
					...
					<div v-if="oceanFeeList.length > 0">
						...
						<el-table :data="oceanFeeList">
							...
							<el-table-column width="200" header-align="center" align="center" label="20RF">
								<template slot-scope="scope">
									{{ scope.row | price20RfFilter }}
								</template>
							</el-table-column>
							<el-table-column width="200" header-align="center" align="center" label="40RQ">
								<template slot-scope="scope">
									{{ scope.row | price40RqFilter }}
								</template>
							</el-table-column>
					...
					<div v-if="porExtraFeeList.length > 0">
						...
						<el-table :data="porExtraFeeList">
							...
							<el-table-column width="200" header-align="center" align="center" property="20RF" label="20RF">
								<template slot-scope="scope">
									{{ scope.row | price20RfFilter }}
								</template>
							</el-table-column>
							<el-table-column width="200" header-align="center" align="center" property="40RQ" label="40RQ">
								<template slot-scope="scope">
									{{ scope.row | price40RqFilter }}
								</template>
							</el-table-column>
...
import { bookInfoReefer, extraChargeFeeListReefer, bookingReefer, intermodalServiceReefer, getPackageType } from '@/api/exec/cosco'
...
export default {
		...
		return {
			...
			createItem: {
				...
				cargoInfo: {
					...
					volume: 1000.5,
					remarks: '94011000',
          reeferTemperatureType: null,
          reeferTemperatureValue: null,
          reeferVentilationType: null,
          reeferVentilationValue: null,
          reeferGenSetType: null,
          reeferHumidityValue: null
				},
				containerInfos: [],
				//备注
				remarks: '',
	...
	filters: {
		billPriceFilter(row) {
      let source = row.priceTicket
			if (!source) return
			if (row.paymentTerm === 'P') {
				return source.P && `${source.P.currency} ${source.P.price}`
			} else {
				return source.C && `${source.C.currency} ${source.C.price}`
			}
		},
		price20RfFilter(row) {
      let source = row.price20Rf
			if (!source) return
			if (row.paymentTerm === 'P') {
				return source.P && `${source.P.currency} ${source.P.price}`
			} else {
    ...
    scrollBottom() {
      ...
      this.showBtnBox = scrollBottom > 200
		...
		init() {
			...
			bookInfoReefer({ productId, sapid }).then(res => {
			...
			intermodalServiceReefer({ productId, sapid }).then(({ data }) => {
      ...
      if (!this.createItem.emergencyContactInfo.email) {
        this.$message.error('联系人邮箱不能为空')
          ...
          let {reeferTemperatureType,reeferVentilationType, reeferGenSetType, reeferHumidityValue, reeferTemperatureValue, reeferVentilationValue} = data.cargoInfo
          if (!reeferTemperatureType) {
            data.cargoInfo.reeferTemperatureType = null
          }
          if (!reeferVentilationType) {
            data.cargoInfo.reeferVentilationType = null
          }
          if (!reeferGenSetType) {
            data.cargoInfo.reeferGenSetType = null
          }
          if (!reeferHumidityValue) {
            data.cargoInfo.reeferHumidityValue = null
          }
          if (!reeferTemperatureValue) {
            data.cargoInfo.reeferTemperatureValue = null
          }
          if (!reeferVentilationValue) {
            data.cargoInfo.reeferVentilationValue = null
          }
		...
		getExtraFeeList() {
			//获取附加费明细数据
			extraChargeFeeListReefer({ productId: this.createItem.productId, sapid: this.$route.query.sapid }).then(res => {
