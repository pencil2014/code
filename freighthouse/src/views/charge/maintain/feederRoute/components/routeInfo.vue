<template>
  <el-row>
    <el-col :span="48">
      <el-form-item class="oneEighth multi-select-tag" label="驳船收货地" prop="feederPolCode" required :show-message="false">
        <el-select size="mini" filterable remote clearable
    ...
    <el-col :span="48">
      <el-form-item class="oneEighth"  label="收货区域" prop="receiptArea" :show-message="false">
        <el-input clearable size="mini" placeholder="请输入" v-model="createItem.receiptArea"></el-input>
      </el-form-item>
    </el-col>
    <el-col :span="48">
      <el-form-item class="oneEighth" label="目的地" prop="podCode" :show-message="false">
        <el-select size="mini"
    ...
    <el-col :span="48">
      <el-form-item class="oneEighth multi-select-tag" required label="船公司" prop="shipCarrierCode" :show-message="false">
        <el-select size="mini"
    ...
    <el-col :span="48">
      <el-form-item class="oneEighth multi-select-tag" label="系统航线" prop="sysLineCode" required :show-message="false">
        <el-select size="mini"
    ...
    <el-col :span="48">
      <el-form-item class="oneEighth" label="驳船预计开船时间" prop="feederSchedule" :show-message="false">
        <el-input clearable size="mini" placeholder="格式为:星期,星期 如1,5" v-model="createItem.feederSchedule"></el-input>
      </el-form-item>
    </el-col>
    <el-col :span="48">
    ...
    <el-col :span="48">
      <el-form-item class="oneEighth" label="驳船中转方式" prop="transferMode" :show-message="false">
        <el-select v-model="createItem.transferMode" size="mini" clearable placeholder="请选择" style="width: 100%">
    ...
    <el-col :span="48">
      <el-form-item class="oneEighth" label="维护人" prop="maintainerId" :show-message="false">
        <el-select size="mini"
    ...
    <el-col :span="24">
      <el-form-item class="oneEighth" label="备注说明" prop="remark" :show-message="false">
        <el-input clearable size="mini" placeholder="请输入" v-model="createItem.remark" maxlength="500"></el-input>
      </el-form-item>
    </el-col>
  </el-row>
</template>
