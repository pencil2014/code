...
export default {
  data() {
    return {
      ...
      blFileTypeOptions: [{ label: '电放件', value: this.blType === 'mbl' ? 'mbl_telex_original' : 'hbl_telex_original' }],
      createItem: Object.assign({}, defaultCreate, { fileType: this.blType === 'mbl' ? 'mbl_telex_original' : 'hbl_telex_original' }),
      rules: {
