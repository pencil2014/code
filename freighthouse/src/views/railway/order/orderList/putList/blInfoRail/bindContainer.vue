<template>
	<div class="">
		<div style="padding-left:10px;margin-top:10px;" class="mb10 between h28 mt10 table-com-layout">
			<div class="ft14">
			...
			<div class="el-button-group" v-if="!isBd">
				<!-- <el-button disabled size="mini" type="primary" class="ml10" @click="handleSelectContainer">选择集装箱</el-button> -->
			</div>
		</div>
		<el-table ref="table" fit highlight-current-row style="width: 100%" :data="bindContainerList">
			...
			<el-table-column prop="quantity" label="件数" align="center">
				<template slot-scope="scope">
					<el-input disabled @blur="validateQuantityNum(scope.row)" v-model="scope.row.quantity" size="mini" placeholder="请输入"></el-input>
				</template>
			</el-table-column>
			<el-table-column prop="weight" label="毛重" align="center">
				<template slot-scope="scope">
					<el-input disabled @blur="validateWeight(scope.row)" v-model="scope.row.weight" size="mini" placeholder="请输入">
			...
			<el-table-column prop="volume" label="体积" align="center">
				<template slot-scope="scope">
					<el-input disabled @blur="validateVolume(scope.row)" v-model="scope.row.volume" size="mini" placeholder="请输入">
			...
			<el-table-column prop="packageInfo" label="包装" align="center">
				<template slot-scope="scope">
					<el-select disabled v-model="scope.row.packageInfo" size="mini" filterable>
			...
			<el-table-column label="操作" width="150" align="center" fixed="right">
				<template slot-scope="scope">
					<div class="operate-group">
						<el-button @click="handleCancelBind(scope.$index)" type="text" size="mini" disabled>取消关联</el-button>
					</div>
				</template>
			</el-table-column>
		</el-table>
