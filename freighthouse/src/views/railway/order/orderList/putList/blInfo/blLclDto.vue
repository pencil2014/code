<template>
	<div class="row-flex ml10 put-detail-lcl ">
		<div class="flex-item">
		...
		<div class="flex-item">
			...
			<el-input size="mini" clearable placeholder="请输入" v-model.number="createItem.blLclDto.quantity" :disabled="disabledState" @blur="validQuantity"></el-input>
		</div>
		<div class="flex-item">
			<div class="item-label">
