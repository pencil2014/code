      ...
      if (this.sizeLimit) {
        ...
        this.$store
          ...
          .then((res) => {
            ...
            if (res === 'error') return
            // 针对 订舱 - 我司格式托书校验
            let bkAttentionCheckStatus = (res.data.data && res.data.data.bkAttentionCheckStatus) || ''
            if (bkAttentionCheckStatus === 'fail') {
              this.$message({
                type: 'warning',
              ...
              this.$store.dispatch('order/compareFile', { orderNo: this.$route.query.orderNo, fileNo: res.data.data.fileNo})
              .then(result => {
              ...
              return
            } else if (bkAttentionCheckStatus === 'pass') {
