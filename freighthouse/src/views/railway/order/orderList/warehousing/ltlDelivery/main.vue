						...
						<div class="service-container" id="container">
							...
							<div v-if="['ship_import_fcl', 'ship_import_lcl'].includes(orderInfo.businessType)" class="component-cont" style="padding-bottom:0;">
								<div class="inspection-menu-checkbox">
									...
									<el-checkbox @change="subTypeSave('pod_ltl_delivery_bonded')" v-model="pod_ltl_delivery_bonded" true-label="y" false-label="n">
										保税类型
									</el-checkbox>
									<el-checkbox @change="subTypeSave('pod_ltl_delivery_not_bonded')" v-model="pod_ltl_delivery_not_bonded" true-label="y" false-label="n">
										非保税类型
									</el-checkbox>
								</div>
...
import { serviceInfoSave, serviceInfoList, serviceInfoDelete, subTypeSave, getSubTypeList } from '@/api/order/list'
