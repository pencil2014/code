<template>
	<BaseDialog :config="dialogConfig" :callback="dialogCallback">
		<el-form ref="addApplierForm" :rules="rules" :model="createItem" label-position="right" label-width="110px" class="create-form">
			...
			<el-form-item label="集装箱" prop="fumeContainers" :show-message="false" v-if="detailInfo.main&&detailInfo.main.businessType === 'rail_export_fcl'">
...
export default {
	...
	computed: {
		...mapState({
			...
			blIdOptions: state => state.orderService.railBlIdOptions,
			containerList: state => state.orderService.railContainerList
		})
	},
	watch: {
		applierData: {
