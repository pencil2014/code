	...
	<div class="edit-container order-book fullWrap" id="fume">
		<div class="order-container">
			...
			<div class="tabs-container">
				<TopNav :serviceType="orderInfo.main && orderInfo.main.serviceType" :activityKey="routeName" :custid="orderInfo.main && orderInfo.main.custid" @routerPush="handleToRoute" />
