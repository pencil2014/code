<template>
	<div class="edit-row">
					...
					<el-table-column label="操作" width="120" align="center" fixed="right">
						<template slot-scope="scope">
							<div class="operate-group">
								...
								<el-button @click="handleDelete(scope.row)" type="text" size="mini" :disabled="isBd || createdItem.declareStatus === 'declared'">删除</el-button>
							</div>
						</template>
					</el-table-column>
				</el-table>
		...
		<el-dialog title="危险品申报附件上传" :visible.sync="uploadVisible" :lock-scroll="true" width="780px">
			<el-form ref="createUploadItem" :rules="rulesCreateItem" :model="createUploadItem" label-position="right" label-width="62px" class="dangerous-upload">
				<el-form-item label="箱号" prop="cn" style="width: 100%" :show-message="false">
