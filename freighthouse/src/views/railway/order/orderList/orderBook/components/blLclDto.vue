<template>
	<div style="padding-right:10px;" class="row-flex ml10">
		<div class="flex-item">
			<div class="item-label">
				<span class="lab">箱型</span>
			</div>
			<el-select :disabled="createItem.isDraftConfirm === 'y'" size="mini" v-model="createItem.blLclDto.containerType" filterable style="width: 100%" clearable placeholder="请选择">
		...
		<div class="flex-item">
			...
			<el-input :disabled="createItem.isDraftConfirm === 'y'" size="mini" clearable placeholder="请输入" v-model="createItem.blLclDto.cn"></el-input>
			<!-- <el-autocomplete
				style="width: 100%"
				size="mini"
				clearable
		...
		<div class="flex-item">
			...
			<el-input @blur="validateQuantityNum(createItem.blLclDto)" :disabled="createItem.isDraftConfirm === 'y'" size="mini" clearable placeholder="请输入" v-model="createItem.blLclDto.quantity"></el-input>
		</div>
		<div class="flex-item">
			<div class="item-label">
				<span class="lab">毛重</span>
			</div>
			<el-input @blur="validateWeight(createItem.blLclDto)" :disabled="createItem.isDraftConfirm === 'y'" size="mini" clearable placeholder="请输入" v-model="createItem.blLclDto.weight"></el-input>
		</div>
		<div class="flex-item">
			<div class="item-label">
				<span class="lab">体积</span>
			</div>
			<el-input @blur="validateVolume(createItem.blLclDto)" :disabled="createItem.isDraftConfirm === 'y'" size="mini" clearable placeholder="请输入" v-model="createItem.blLclDto.volume"></el-input>
		</div>
		<div style="padding-right:0;" class="flex-item">
			<div class="item-label">
				<span class="lab">包装</span>
			</div>
			<el-select size="mini" v-model="createItem.blLclDto.packageInfo" style="width: 100%" clearable placeholder="请选择" :disabled="createItem.isDraftConfirm === 'y'" filterable>
