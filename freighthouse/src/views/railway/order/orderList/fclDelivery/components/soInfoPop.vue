  ...
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <div class="soInfo-pop-container">
      <el-table fit highlight-current-row style="width: 100%" :data="soList" class="table-cont" @current-change="clickRow" :span-method="objectSpanMethod">
        ...
        <el-table-column prop="podPortName" label="目的地" align="center" width="200" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    */
    ...
    // 获取委派信息列表
		getServiceInfoList() {			
			serviceInfoList({ orderNo: this.$route.query.orderNo, serviceCode: 'pod_fcl_delivery' }).then(res => {
