      ...
      <el-row :gutter="10">
        ...
        <el-col :span="12">
          <el-form-item label="收件人电话" prop="receivePhone" :show-message="false">
            <el-input maxlength="128" show-word-limit type="text" :rows="1" placeholder="请输入收件人电话" v-model="createItem.receivePhone">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="收件方地址" prop="receiveAddress" :show-message="false">
        <el-input maxlength="512" type="textarea" :rows="1" placeholder="请输入收件方地址" v-model="createItem.receiveAddress">
        </el-input>
      </el-form-item>
			...
			if (this.sizeLimit) {
				...
				this.$store
					.dispatch('order/soUpload', {
						uri: '/order/shipping/bl/release/agree/batch',
						params: params
					})
					.then(res => {
