	...
	<div class="lcl-cargo-form">
		<div class="row-flex flex-cargo" v-for="(o, index) in createItem.cargoList" :key="index">
          ...
          <el-select size="mini" v-model="o.hscode" style="width: 100%"  placeholder="请选择海关编号" disabled>
			...
			<el-form-item class="cargo-item cname cname-ename" label="中文品名" :prop="`cargoList.${index}.cname`" :show-message="false" :rules="{ required: isRequired, message: '请输入中文品名', trigger: 'blur' }">
           ...
           <el-input size="mini" v-model="o.cname" clearable placeholder="请输入中文品名" disabled maxlength="1024"></el-input>
			...
			<el-form-item class="cargo-item cname cname-ename" label="英文品名" :prop="`cargoList.${index}.ename`" :show-message="false" :rules="{ required: isRequired, message: '请输入英文品名', trigger: 'blur' }">
