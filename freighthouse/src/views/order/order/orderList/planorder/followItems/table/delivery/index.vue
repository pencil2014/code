...
export default {
  ...
  data() {
    return {
      ...
      // table复选框多选的值
        ...
        noShowStripe: true,
				...
				configColumns: [],
				columns: [],
				allColumns: store.state.followItems.deliveryList.columnsBase(this.handleClickRefreshList),
				operationBtns: {
					minWidth: '100',
					fixed: 'right',
					show: true,
	...
	computed: {
		...mapState({
			...
			defaultColumns: state => state.followItems.deliveryList.defaultColumns,
			specialColumns: state => state.followItems.deliveryList.specialColumns,
			columnsBase: state => state.followItems.deliveryList.columnsBase(),
  ...
  methods: {
		init() {
			this.tableConfig.columns = store.state.followItems.deliveryList.columnsBase(this.handleClickRefreshList)
			this.tableConfig.allColumns = store.state.followItems.deliveryList.columnsBase(this.handleClickRefreshList)
		},
		handleOpPlan(row) {
