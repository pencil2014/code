...
export default {
  ...
  data() {
    return {
      ...
      // table复选框多选的值
        ...
        noShowStripe: true,
				...
				configColumns: [],
				columns: [],
				allColumns: store.state.followItems.stuffingList.columnsBase(this.handleClickRefreshList),
				operationBtns: {
					minWidth: '100',
					fixed: 'right',
					show: true,
	...
	computed: {
		...mapState({
			...
			defaultColumns: state => state.followItems.stuffingList.defaultColumns,
			specialColumns: state => state.followItems.stuffingList.specialColumns,
			columnsBase: state => state.followItems.stuffingList.columnsBase()
		})
	},
	created() {
		this.init()
  ...
  methods: {
		init() {
			this.tableConfig.columns = store.state.followItems.stuffingList.columnsBase(this.handleClickRefreshList)
			this.tableConfig.allColumns = store.state.followItems.stuffingList.columnsBase(this.handleClickRefreshList)
		},
		handleOpPlan(row) {
