<template>
	<div class="soInfo-container">
		<el-table fit style="width: 100%" max-height="200" :data="soList" class="table-cont" :span-method="objectSpanMethod">
			...
			<el-table-column label="操作" align="center" width="80" fixed="right" v-if="isOp">
				<template slot-scope="scope">
					<div class="operate-group">
						<el-button type="text" size="mini" :disabled="isDisabledEdit" @click="handleDelete(scope.row)">删除</el-button>
					</div>
				</template>
			</el-table-column>
		</el-table>
