<template>
	...
	<div id="warehouseInplan" class="edit-row" v-loading="lsLoading"
					...
					<el-table-column label="操作" align="center" fixed="right">
						<template slot-scope="scope">
							<div class="operate-group">
								<ButtonTip
									btnType="text" 
									:btnDisabled="!scope.row.outBatchNo" 
									btnText="详情" 
									:tipContent="noOutBatchNoTip(scope.row)" 
		...
		<template v-if="detailShow">
			<Detail :detailData="formData" :saveBarFixed="saveBarFixed" :isDisabledEdit="isDisabledEdit" :isJoint="isJoint" @close="close" @handleConfirm="handleSave"></Detail>
		</template>
	</div>
</template>
