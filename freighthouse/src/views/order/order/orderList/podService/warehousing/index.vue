						...
						<div class="service-container" id="container" @scroll="handleScroll">
							...
							<div v-if="isImport" class="component-cont" style="padding-bottom: 0">
								<div class="inspection-menu-checkbox">
									...
									<el-checkbox @change="subTypeSave('pod_warehouse_bonded')" v-model="pod_warehouse_bonded" true-label="y" false-label="n"> 保税类型 </el-checkbox>
									<el-checkbox @change="subTypeSave('pod_warehouse_not_bonded')" v-model="pod_warehouse_not_bonded" true-label="y" false-label="n"> 非保税类型 </el-checkbox>
							...
							<component v-if="(isImport && serviceCheckout.length > 0) || !isImport" :is="activityTab" :activityType="activityType" :orderInfo="orderInfo" :tabMenus="menus" :saveBarFixed="saveBarFixed" :isJoint="isJoint"></component>
...
export default {
	...
	computed: {
		...
		getCurrentServiceCode() {
			...
			// console.log('find', find, this.menus, this.activityKey);
