		...
		<div class="row-body">
			<el-form ref="form" :rules="rules" :model="formData" class="form-body" label-width="90px">
				<el-row>
					...
					<el-col :span="6">
						<el-form-item label="进仓仓库" prop="whId">
							<el-select v-model="formData.whId" size="mini" remote clearable :filterable="true" @visible-change="whVisibleChange" :remote-method="whFilterMehod" placeholder="请选择" @change="handleSelectWhid" style="width: 100%">
				...
				<div class="row-tit h32">
					...
					<div class="row-tit-operate">
						<ButtonTip btnType="primary" :btnDisabled="(isBd && !isImportJoint) || isDisabledEdit" btnText="添加集装箱" :tipContent="isDocTip || isJointTip || isFinishTip || statusTip" class="operateBtn-tip" @click="handleAddBox"> </ButtonTip>
							...
							<template slot-scope="scope">
								...
								<div class="operate-group" v-else>
									<ButtonTip
										...
										@click="handleAddCargo(scope.row, item)"
									>
									</ButtonTip>
									...
									<ButtonTip
										...
										class="operateBtn-tip"
										btnClassName="red"
										@click="handleDelete(scope.row, scope.$index, index)"
									>
									</ButtonTip>
