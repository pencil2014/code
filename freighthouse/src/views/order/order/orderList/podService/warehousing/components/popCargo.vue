<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form id="cargoDialog" ref="form" :model="formData" class="table-com-layout">
      <el-row>
        <el-col :span="8">
          <el-form-item label="进仓编号：" prop="inBatchNo">
            <el-input clearable v-model="formData.inBatchNo" size="mini"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="中文品名：" prop="cargoName">
            <el-input clearable v-model="formData.cargoName" size="mini" maxlength='128'></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-table fit highlight-current-row style="width: 100%" ref="contMultiTable" :data="cargoList" @selection-change="handleSelectionChange">
