			...
			<el-form id="cnameDialog" ref="form" :model="formData">
							...
							<el-col :span="12" style="display: flex">
								<template v-if="clickType == 'planOut'">
									<el-form-item label="仓库名称" prop="whId">
										<el-select clearable v-model="formData.whId" filterable @visible-change="wareHouseSearch" :filter-method="wareHouseSearch" size="mini">
											<el-option :disabled="item.disabled" v-for="(ele, index) in whOptions" :key="index" :label="ele.label" :value="ele.value"></el-option>
										</el-select>
									</el-form-item>
									<el-form-item label="客户名称" prop="custid">
										<el-select clearable v-model="formData.custid" filterable @visible-change="customerSearch" :filter-method="customerSearch" size="mini">
									...
									<el-form-item label="进仓编码" prop="batchNo">
										<el-input clearable v-model="formData.batchNo" size="mini"></el-input>
									</el-form-item>
								</template>
							</el-col>
							<el-col :span="clickType == 'planOut' ? 4 : 8">
								<el-form-item label="中文品名" prop="cname">
									<el-input clearable v-model="formData.cname" size="mini" maxlength="128"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="clickType == 'planOut' ? 4 : 8">
								<el-form-item label="海关编码" prop="hscode">
									<el-input clearable v-model="formData.hscode" size="mini"></el-input>
								</el-form-item>
							</el-col>
						</el-row>
					</el-col>
				...
				<div>
					...
					<div class="table-com-layout">
						<el-table :data="tableData" @current-change="clickRow" highlight-current-row align="center" style="width: 100%">
							<el-table-column align="center" label="" width="100px">
								<template slot-scope="scope">
									<el-radio v-model="selectCargo" :label="scope.row"><span></span></el-radio>
								</template>
							</el-table-column>
							...
							<template v-if="clickType == 'planOut'">
								...
								<el-table-column prop="lastWeight" align="center" label="剩余毛重"> </el-table-column>
								<el-table-column prop="lastVolume" align="center" label="剩余体积"> </el-table-column>
							</template>
...
import AddCnameDialog from './addCname'
