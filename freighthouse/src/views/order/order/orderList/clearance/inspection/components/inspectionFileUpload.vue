<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form ref="uploadFileForm" :model="createdItem" :rules="rules" label-position="right" label-width="70px" class="inspection-upload-form">    
...
export default {
  ...
  methods: {
    ...
    handleImport(done) {
      ...
      this.isFcl && this.fileData.append("containerId", this.param.containerId)
