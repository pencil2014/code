<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form ref="uploadFileForm" :model="createItem" :rules="rules" label-position="right" label-width="80px" class="polLtl-upload">    
...
<style lang="scss">
.polLtl-upload .el-form-item__label, .polLtl-upload .el-form-item__content{
  line-height: 20px;
}
</style>