  ...
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <div class="soInfo-pop-container">
      <el-table fit highlight-current-row style="width: 100%" :data="soList" class="table-cont" @current-change="clickRow" :span-method="objectSpanMethod">
        ...
        <el-table-column prop="containerType" label="箱型箱量" align="center" width="150" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="boxAddress" label="装货详细地址" align="center" width="150" show-overflow-tooltip></el-table-column>
        <el-table-column prop="remark" label="委派备注" align="center" width="200" show-overflow-tooltip></el-table-column>
      </el-table>
    </div>
  </BaseDialog>
</template>
...
export default {
  ...
  methods: {
    ...
    */
    ...
    // 获取委派信息列表
		getServiceInfoList() {			
			serviceInfoList({ orderNo: this.$route.query.orderNo, serviceCode: 'truck' }).then(res => {
