      ...
      <div v-show="!o.containerListShowState" style="padding: 8px 0 5px">
        <el-form class="row-flex flex-so" v-for="(item, sIndex) in o.containerList" :key="sIndex" :model="createItem.soContainerList[index]" ref="containerList">
          ...
          <div class="row-flex-cont">
            <div class="flex">
              <el-form-item class="item-cell" label="箱型" :prop="`containerList.${sIndex}.containerType`" :show-message="false" :rules="{ required: false, message: ' ', trigger: 'change' }">
              ...
              <el-form-item class="item-cell" label="箱量" :prop="`containerList.${sIndex}.containerNum`" :show-message="false" :rules="[{ required: false, validator: checkContainerNum, trigger: 'blur' }]">
              ...
              <el-form-item class="item-cell" label="单柜重量" :prop="`containerList.${sIndex}.weight`" :show-message="false" :rules="[{ required: false, validator: checkWeight, trigger: 'blur' }]">
              ...
              <el-form-item class="item-cell" label="是否重柜" :prop="`containerList.${sIndex}.isHeavy`" :show-message="false" :rules="{ required: false, message: '请选择是否重柜', trigger: 'change' }">
            ...
            <div class="flex" style="clear: both">
              <el-form-item class="item-cell" label="特种长宽高" v-if="item.containerType && (item.containerType.toUpperCase().indexOf('OT') !== -1 || item.containerType.toUpperCase().indexOf('FR') !== -1)">
                <el-col :span="8">
                  <el-form-item :prop="`containerList.${sIndex}.specialLength`" :show-message="false" :rules="[{ required: false, validator: checkWeight, trigger: 'blur' }]">
                ...
                <el-col :span="8">
                  <el-form-item :prop="`containerList.${sIndex}.specialWidth`" :show-message="false" :rules="[{ required: false, validator: checkWeight, trigger: 'blur' }]">
                ...
                <el-col :span="8">
                  <el-form-item :prop="`containerList.${sIndex}.specialHeight`" :show-message="false" :rules="[{ required: false, validator: checkWeight, trigger: 'blur' }]">
              ...
              <el-form-item class="item-cell" label="单位" :prop="`containerList.${sIndex}.temperatureType`" :show-message="false" :rules="{ required: isBd, message: '请选择单位', trigger: 'change' }" v-if="item.containerType && item.containerType.toUpperCase().indexOf('RF') !== -1">
              ...
              <el-form-item class="item-cell" label="设置温度" :prop="`containerList.${sIndex}.temperatureSet`" :show-message="false" :rules="[{ required: false, validator: checkTemprature, trigger: 'blur' }]" v-if="item.containerType && item.containerType.toUpperCase().indexOf('RF') !== -1">
              ...
              <el-form-item class="item-cell" label="最低温度" :prop="`containerList.${sIndex}.temperatureMin`" :show-message="false" :rules="[{ required: false, validator: checkTemprature, trigger: 'blur' }]" v-if="item.containerType && item.containerType.toUpperCase().indexOf('RF') !== -1">
              ...
              <el-form-item class="item-cell" label="最高温度" :prop="`containerList.${sIndex}.temperatureMax`" :show-message="false" :rules="[{ required: false, validator: checkTemprature, trigger: 'blur', item: item }]" v-if="item.containerType.toUpperCase().indexOf('RF') !== -1">
              ...
              <el-form-item class="item-cell" label="通风量" :prop="`containerList.${sIndex}.airMete`" :show-message="false" :rules="[{ required: false, message: '请输入', trigger: 'blur' }]" v-if="item.containerType && item.containerType.toUpperCase().indexOf('RF') !== -1">
              ...
              <el-form-item class="item-cell" label="湿度要求" :prop="`containerList.${sIndex}.humidity`" :show-message="false" :rules="{ required: false, message: '请输入湿度要求', trigger: 'blur' }" v-if="item.containerType.toUpperCase().indexOf('RF') !== -1">
...
export default {
  ...
  computed: {
    ...
    viewState() {
      ...
      if (!this.ordDetRole || this.isAc || this.$route.query.source === 'jointList') {
        return true
      }
      ...
      // if(this.orderInfoDataObj.exportOrderNo && (this.orderInfoDataObj.soContainerList && this.orderInfoDataObj.soContainerList.length)){
      //   return true
      // }
      return false
    },
