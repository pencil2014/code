<template>
	<div class="edit-container order-book fullWrap" id="internalTradeBarge">
				...
				<div class="detail-container detail-container-pol flex">
					...
					<div class="flex1 component-main-cont">
						<div class="service-container" id="container" @scroll="handleScroll">
							...
							<!-- <OneServiceFee :orderNoProp="oQuery.orderNo" :serviceCode="'internal_trade_barge'" /> -->
						</div>
...
export default {
	...
	data() {
		return {
			...
			activityKey: '',
			serviceCode: 'internal_trade_barge',
			detailData: {},
			type: '', // 新增或编辑标识
			saveBarFixed: false
		}
...
#internalTradeBarge .remark-con {
	display: flex;
}
#internalTradeBarge .remark-con .txt {
...
#internalTradeBarge .remark-con .underline {
	padding: 0;
}
#internalTradeBarge .remark-style{
	overflow: hidden; 
	white-space: nowrap;
	text-overflow: ellipsis;
	display: inline-block;
