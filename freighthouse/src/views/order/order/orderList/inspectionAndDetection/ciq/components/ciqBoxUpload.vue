<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form ref="uploadFileForm" :model="createdItem" :rules="rules" label-position="right" label-width="60px" class="create-form">    
...
export default {
	...
	methods: {
		...
		handleTempDownload() {
			let fileName = 'inspectionCiq_temp.xlsx'
      if (this.isBulkRo) {
        fileName = 'inspectionCiq_temp_bulk.xlsx'
      }
			this.$store
