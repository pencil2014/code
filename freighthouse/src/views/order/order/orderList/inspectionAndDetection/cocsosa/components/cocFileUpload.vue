...
export default {
  ...
  methods: {
    ...
    handleImport(done) {
      ...
      this.oQuery.jointNo && this.fileData.append("jointNo", this.$route.query.jointNo)
      ...
      this.fileData.append("checkSupplierName", this.param.checkSupplierName)
      ...
      // form.append("jointNo", this.$route.query.jointNo)
