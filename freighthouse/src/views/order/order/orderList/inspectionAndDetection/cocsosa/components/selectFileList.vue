		...
		<BaseDialog :config="dialogConfig" :callback="dialogCallback">
			<div class="coc-bewteen">
				<div class="">
					...
					<!-- <span class="ft12 mr10">M单号：{{param.blNo}}</span>
          <el-select size="mini" placeholder="请选择" v-model="typeCode" clearable>
			...
			<el-table fit highlight-current-row style="width: 100%" ref="fileListTable" :data="tableData" @current-change="handleCurrentChange">
