  ...
  <div class="">
    <div class="mb10 between h28 mt10 table-com-layout">
      ...
      <div class="el-button-group" v-if="!isBd">
        <el-button size="mini" type="primary" class="ml10" @click="handleSelectContainer">选择集装箱</el-button>
      </div>
    </div>
    <el-table ref="table" fit highlight-current-row style="width: 100%" :data="bindContainerList">
      ...
      <el-table-column prop="quantity" label="件数" align="center">
        <template slot-scope="scope">
          <el-input v-model.number="scope.row.quantity" size="mini" placeholder="请输入" @blur="validateNum('quantity', scope.row)"></el-input>
        </template>
      </el-table-column>
