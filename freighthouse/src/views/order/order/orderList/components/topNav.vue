<template>
	<div id="navCont">
		...
		<ul class="top-nav-tabs">
			...
			<li v-if="showRelate || asyncRelate || cdOrderShowRelate || hasRelateList || relateOrderList.length > 0" :class="{ 'is-active': 'ChildOrderList' === activityKey }" @click="tabsClick('ChildOrderList')">
				关联订单
			</li>
