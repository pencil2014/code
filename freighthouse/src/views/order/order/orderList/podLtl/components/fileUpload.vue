<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form ref="uploadFileForm" :model="createdItem" :rules="rules" label-position="right" label-width="70px" class="podLtl-upload">    
...
<style lang="scss">
.podLtl-upload .el-form-item__label, .podLtl-upload .el-form-item__content{
  line-height: 20px;
}
</style>