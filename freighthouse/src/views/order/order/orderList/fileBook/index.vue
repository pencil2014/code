<template>
	<div class="edit-container order-book fullWrap" id="fileBook">
					...
					<div class="flex1 component-main-cont">
						<div class="service-container">
							...
							<div class="fileList-cont table-com-layout">
								<div class="fileBook-row">
									<div class="ft14">托书列表</div>
									<el-button type="primary" size="mini" @click="handleAdd" :disabled="!isEditView">新增托书</el-button>
								</div>
								<el-table style="width: 100%" fit highlight-current-row :data="fileBookList">
									...
									<el-table-column prop="containerInfo" label="箱型箱量" align="center" v-if="isFcl"> </el-table-column>
									...
									<el-table-column label="操作" width="150" align="center" fixed="right">
										<template slot-scope="scope">
											<div class="operate-group">
												...
												<el-button @click="handleDelete(scope.row)" type="text" size="mini" :disabled="!isEditView">删除</el-button>
											</div>
										</template>
									</el-table-column>
								</el-table>
...
import { orderInfo, orderFileBookList, orderFileBookDelete } from '@/api/order/list'
...
export default {
	...
	computed: {
		isEditView() {
			return this.ordDetRole === 'bd' || this.ordDetRole === 'obd' || this.ordDetRole === 'op' || this.ordDetRole === 'doc' || this.ordDetRole === 'op_truck'
		}
	},
	components: {
		CancelAlert,
