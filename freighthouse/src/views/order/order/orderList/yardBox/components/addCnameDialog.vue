...
export default {
  data() {
    return {
      ...
      inputItem: [
        {label: "中文品名", key: "cname", prop: "cname", type: "input", inputType: "text", maxlength: '128' },
        {label: "英文品名", key: "ename", type: "input", inputType: "text", maxlength: '128' },
        // {label: "海关编码", key: "hscode", prop: "hscode", type: "input", inputType: "text" },
        {label: "HSCODE", key: "hscode", prop: "hscode", type: "select", options: [], filterable: true, clearable: true, remote: true, 
        ...
        {label: "货品类型", key: "type", prop: "type", type: "select",
          filterable:true,
          remote: true,
          options: [],
          remoteMethod: (queryString, item) => {
