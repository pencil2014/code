    ...
    <div class="row-flex flex-cargo" v-for="(o, index) in createItem.cargoList" :key="index">
      ...
      <!-- <div class="cargo-item hscode" v-if="isOp">
        ...
        <div class="item-content">
          <el-input size="mini" v-model="o.shortCname" clearable placeholder="请输入" :disabled="!isEditState">></el-input>
        </div>
      </div> -->
      ...
      <div class="cargo-item hscode" v-if="isOp">
        ...
        <div class="item-content">
          <el-input size="mini" v-model.number="o.quantity" clearable placeholder="请输入" :disabled="!isEditState" @blur="validateQuantity('quantity', o)"></el-input>
        </div>        
      </div>
      <div class="cargo-item hscode" v-if="isOp">
        <div class="item-label"><span class="lab">总毛重</span></div>
        <div class="item-content">
          <el-input size="mini" v-model="o.weight" clearable placeholder="请输入" :disabled="!isEditState" @blur="validateVolumeWeight('weight', o)">
      ...
      <div class="cargo-item hscode" v-if="isOp">
        ...
        <div class="item-content">
          <el-input size="mini" v-model="o.volume" clearable placeholder="请输入" :disabled="!isEditState" @blur="validateVolumeWeight('volume', o)">
      ...
      <!-- <div class="cargo-item hscode" v-if="isOp">
        ...
        <div class="item-content">
          <el-select size="mini" v-model="o.packageInfo" style="width: 100%" clearable placeholder="请选择" :disabled="!isEditState" filterable>
      ...
      <!-- <div class="cargo-item hscode" v-if="isOp">
        ...
        <div class="item-content">
            <el-input size="mini" v-model="o.length" clearable placeholder="请输入" :disabled="!isEditState">>
      ...
      <div class="cargo-item hscode" v-if="isOp">
        ...
        <div class="item-content">
          <el-input size="mini" v-model="o.width" clearable placeholder="请输入" :disabled="!isEditState">>
            <template slot="append">m</template>
          </el-input>
        </div>        
      </div>
      <div class="cargo-item hscode" v-if="isOp">
        ...
        <div class="item-content"> 
          <el-input size="mini" v-model="o.height" clearable placeholder="请输入" :disabled="!isEditState">>
            <template slot="append">m</template>
          </el-input>
        </div>        
      </div>
      <div class="cargo-item hscode" v-if="isOp" style="width: 47.4%">
        ...
        <div class="item-content">
          <el-input size="mini" v-model="o.mark" clearable placeholder="请输入" :disabled="!isEditState">></el-input>
        </div>        
      </div> -->
      <el-form-item class="cargo-item hscode" label="HS Code" :prop="`cargoList.${index}.hscode`" 
      :show-message="false" :rules="{required: false, message: '请选择海关编号', trigger: 'change'}">
       <el-tooltip v-if="!isEditState" class="item" effect="dark" :content="o.hscode" placement="top">
        ...
        <el-select v-else size="mini" v-model="o.hscode" style="width: 100%" remote filterable clearable placeholder="请选择海关编号" :disabled="!isEditState"
      ...
      :show-message="false" :rules="{required: false, message: '请输入中文品名', trigger: 'blur'}">
        <el-tooltip v-if="!isEditState" class="item" effect="dark" :content="o.cname" placement="top">
           <el-input size="mini" v-model="o.cname" clearable placeholder="请输入中文品名" disabled maxlength="1024"></el-input>
        </el-tooltip>
        <el-input  v-else size="mini" v-model="o.cname" clearable placeholder="请输入中文品名" :disabled="!isEditState" maxlength="1024"></el-input>
      </el-form-item>
      <el-form-item class="cargo-item hscode cname-ename" label="英文品名" :prop="`cargoList.${index}.ename`" 
      :show-message="false" :rules="{required: false, message: '请输入英文品名', trigger: 'blur'}">
        <el-tooltip v-if="!isEditState" class="item" effect="dark" :content="o.ename" placement="top">
           <el-input size="mini" v-model="o.ename" clearable placeholder="请输入英文品名" disabled maxlength="1024"></el-input>
        </el-tooltip>
        <el-input v-else size="mini" v-model="o.ename" clearable placeholder="请输入英文品名" :disabled="!isEditState" maxlength="1024"></el-input>
      </el-form-item>
      <div class="cargo-item hscode">
        <div class="item-label"><span class="lab">货品分类</span></div>
        <div class="item-content">
          <el-select size="mini" v-model="o.commodityTypeCode" style="width: 100%" filterable clearable placeholder="请选择货品分类" :disabled="!isEditState">
      ...
      <el-form-item class="cargo-item hscode" label="货物性质" :prop="`cargoList.${index}.property`" :show-message="false" 
        :rules="{required: false, message: '请选择货物性质', trigger: 'change'}">
        <el-select size="mini" v-model="o.property" style="width: 100%" clearable placeholder="请选择货物性质" :disabled="!isEditState">
      ...
      :show-message="false" :rules="{required: false, message: '请输入装箱要求', trigger: 'blur'}">
        <el-input size="mini" v-model="o.boxRemark" @focus="handleClear(o)" @blur="handleBlur(o)" placeholder="如无装箱要求，填无" :disabled="!isEditState">
        </el-input>
      </el-form-item>
      <el-form-item class="cargo-item hscode" label="危险等级" v-if="o.property === 'dangerous'" 
        :show-message="false" :prop="`cargoList.${index}.dangerousGrade`" :rules="{required: false, message: '请选择危险等级', trigger: 'change'}">
        <el-select size="mini" v-model="o.dangerousGrade" style="width: 100%" clearable placeholder="请选择危险等级" :disabled="!isEditState">
      ...
      <el-form-item class="cargo-item hscode" label="国际危码" :prop="`cargoList.${index}.dangerousCode`" 
        :show-message="false" v-if="o.property === 'dangerous'" :rules="{required: false, message: '请选择国际危码', trigger: 'change'}">
        <el-select size="mini" v-model="o.dangerousCode" style="width: 100%" clearable placeholder="请选择国际危码" :disabled="!isEditState"
      ...
      <div class="cargo-item hscode" v-if="o.property === 'dangerous'">
        ...
        <div class="item-content">
          <el-input size="mini" v-model="o.packageGroup" maxlength="64" clearable placeholder="请输入包装组别" :disabled="!isEditState"></el-input>
        </div>
      </div>
      ...
      <!-- <el-row class="flex-item-commodityDesc">
        <el-form-item class="form-cont" label="货物描述" :prop="`cargoList.${index}.commodityDesc`">
          <el-tooltip v-if="!isEditState && o.commodityDesc" class="item" effect="dark" placement="top">
            <div class="" slot="content" v-html="translateLineWrap(o.commodityDesc)"></div>
            <el-input type="textarea" :rows="4" size="mini" v-model="o.commodityDesc" clearable placeholder="请输入货物描述" disabled maxlength="512"></el-input>
          </el-tooltip>
          <el-input v-else type="textarea" :rows="4" size="mini" v-model="o.commodityDesc" clearable placeholder="请输入货物描述" :disabled="!isEditState" maxlength="512">
          </el-input>
        </el-form-item>
      </el-row> -->
    </div>
