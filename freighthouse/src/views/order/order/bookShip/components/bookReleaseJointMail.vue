<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback" >
    <el-form ref="mailOnlyForm" :rules="rules" :model="createItem" label-position="right" label-width="90px" class="bookReleaseMail-form">
			<!-- <div class="redTip">注意：收件人、抄送人邮箱如录入多个，请以逗号或者分号分隔</div> -->
			<el-form-item label="收件人" prop="mailTo" :show-message="false">
				<el-input  @blur="emailBlur('mailTo', createItem.mailTo)" type="text" placeholder="请输入收件人邮箱（多个以逗号或者分号分隔）" clearable v-model="createItem.mailTo">
				</el-input>
			</el-form-item>
			<div class="mailOnly-tip">请输入收件人邮箱（多个以逗号或者分号分隔）</div>
			<el-form-item label="抄送人" prop="mailCc" :show-message="false">
				<el-input  @blur="emailBlur('mailCc', createItem.mailCc)" type="text" placeholder="请输入抄送人邮箱（多个以逗号或者分号分隔）" clearable v-model="createItem.mailCc">
				</el-input>
			</el-form-item>
			<div class="mailOnly-tip">请输入收件人邮箱（多个以逗号或者分号分隔）</div>
