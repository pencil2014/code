<template>
	<BaseDialog :config="dialogConfig" :callback="dialogCallback">
		<el-form ref="uploadFileForm" :model="createdItem" :rules="rules" label-position="right" label-width="120px" id="upload-file-form" class="create-form">
			<el-form-item label="导入快递单">
				<el-upload
					ref="upload"
					drag
			...
			<el-form-item label="批量导入快递单模板">
				<el-button size="mini" type="default" @click="handleTempDownload">模板下载</el-button>
			</el-form-item>
		</el-form>
	</BaseDialog>
</template>
			...
			if (this.sizeLimit) {
				...
				this.$store
					.dispatch('user/import', {
						uri: '/order/shipping/express/importExcel',
						params: form
					})
					.then(res => {
...
<style lang="scss">
#upload-file-form .el-form-item__content {
	height: 100%;
}
</style>
