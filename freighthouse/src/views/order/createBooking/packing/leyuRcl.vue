...
import Transport from './leyuEsl/transport'
import Particulars from './leyuTsl/particulars'
import Totals from './components/totals'
import Charges from './leyuRcl/charges'
import Bl from './leyuRcl/bl'
  ...
  methods: {
    ...
    getDataSource (shipId) {
      ...
      siDetail(data).then(res => {
        ...
        telexReleaseOffice && Object.assign(this.blOption,{
          telexReleaseOffice:{
            locationCode: {
              cityUnCode: telexReleaseOffice.locationCode,
              cityName: telexReleaseOffice.locationName,
              countryName: telexReleaseOffice.country,
              countryCode: telexReleaseOffice.countryCode
            }
          }
        })
    ...
    submitOriginalFn(type) {
      ...
      const { chargeType, chargeTerm, paymentPlace, releaseOffice } =
        this.chargesOption
      const { blType, remarks, telexReleaseOffice } = this.blOption
      const {
      ...
      const data = {
        ...
        blType,
        telexReleaseOffice: {
          locationCode: telexReleaseOffice.locationCode?.cityUnCode,
          locationName: telexReleaseOffice.locationCode?.cityName,
          country: telexReleaseOffice.locationCode?.countryName,
          countryCode: telexReleaseOffice.locationCode?.countryCode,
        },
        remarks,
        chargeType,
        chargeTerm,
