<!--
 * @Author: Sivan
 * @Date: 2022-05-18 17:28:17
 * @LastEditTime: 2022-05-24 16:41:19
 * @LastEditors: Sivan
-->
<template>
          ...
          <div class="cnt-info">
            <el-form-item label="Shipper" prop="shipper.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('shipper', 'name', 35, 5)"
          ...
          <div class="cnt-info">
            <el-form-item label="Forwarder" prop="forwarder.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('forwarder', 'name', 35, 5)"
                :autosize="{ minRows: 0, maxRows: 5 }"
              ></el-input>
            </el-form-item>
          </div>
          ...
          <div class="cnt-info">
            <el-form-item label="Consignee" prop="consignee.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('consignee', 'name', 35, 5)"
                :autosize="{ minRows: 0, maxRows: 5 }"
              ></el-input>
            </el-form-item>
          </div>
          ...
          <div class="cnt-info">
            <el-form-item label="Notify Party" prop="notifyParty.name">
              ...
              <el-input
                ...
                :autosize="{ minRows: 0, maxRows: 5 }"
                @blur="handleTextarea('notifyParty', 'name', 35, 5)"
              ></el-input>
            </el-form-item>
          </div>
          <div class="btn-box2">
            ...
            <div class="cnt-info">
              <el-form-item label="Notify Party 2" prop="notifyParty2.name">
                ...
                <el-input
                  ...
                  :autosize="{ minRows: 0, maxRows: 5 }"
                  @blur="handleTextarea('notifyParty2', 'name', 35, 5)"
                ></el-input>
              </el-form-item>
            </div>
            <div class="btn-box2">
            ...
            <div class="cnt-info">
              <el-form-item label="Notify Party 3" prop="notifyParty3.name">
                ...
                <el-input
                  ...
                  :autosize="{ minRows: 0, maxRows: 5 }"
                  @blur="handleTextarea('notifyParty3', 'name', 35,5)"
                ></el-input>
              </el-form-item>
            </div>
            <div class="btn-box2">
            ...
            <div class="cnt-info">
              <el-form-item label="freightPayer" prop="freightPayer.name">
                ...
                <el-input
                  ...
                  :autosize="{ minRows: 0, maxRows: 5 }"
                  @blur="handleTextarea('freightPayer', 'name', 35, 5)"
                ></el-input>
              </el-form-item>
            </div>
            <div class="btn-box2">
          ...
          <div class="cnt-info">
            <el-form-item label="Notify Party" prop="shipTo.name">
              ...
              <el-input
                ...
                :autosize="{ minRows: 0, maxRows: 5 }"
                @blur="handleTextarea('shipTo', 'name', 35, 5)"
              ></el-input>
            </el-form-item>
          </div>
          <div class="btn-box2">
...
export default {
  ...
  methods: {
    ...
    // textarea格式化
    handleTextarea(type, key = 'name', num = 35, line = 5) {
      let res = []
      ...
      booker(data)
        .then((res) => {
          if (res.code === 0) {
            ...
            this.bookerData.name = this.bookerData.name + '\n' + this.bookerData.address
    ...
    copyBooker(type) {
      ...
      this['dis' + type] = true
      this.handleTextarea(type, 'name', 35, 5)
    },
    // Clear信息
    clearData(type) {
      const reset = {
    ...
    initData() {
      // 格式化数据
      this.form.shipper.name.length && this.handleTextarea('shipper')
