<!--
 * @Author: Sivan
 * @Date: 2022-06-13 16:47:07
 * @LastEditTime: 2022-06-16 11:18:01
 * @LastEditors: Sivan
-->
<template>
              ...
              <div class="item-cnt">
                <div class="item-info">
                  <div class="form-cnt">
                    ...
                    <el-row :gutter="20">
                      <el-col :span="6">
                        <el-form-item label="Package Count/Type (Outermost)" class="" :prop="`list.${index}.containers.${y}.packageType`"
                          :rules="{
                            required: true,
                            message: 'Required Field',
                            trigger: 'change',
