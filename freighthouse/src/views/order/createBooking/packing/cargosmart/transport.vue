  ...
  <div class="transports-cnt">
    ...
    >
      <div class="cnt-left">
        ...
        <el-form-item label="Print on B/L as" prop="placeOfReceipt.printName">
          <el-input
            placeholder="Enter B/L Location Name..."
            v-model="form.placeOfReceipt.printName"
            maxlength="22"
            :class="{ 'is-exceed': form.placeOfReceipt.printName.length > 22 }"
          ></el-input>
          <!-- <p class="error-tips" v-show="form.placeOfReceipt.printName.length > 22">
            This field can accept only 22 characters
          </p> -->
        </el-form-item>
        <el-form-item
          class="middle-item"
        ...
        <el-form-item label="Print on B/L as" prop="pol.printName">
          <el-input
            ...
            :class="{ 'is-exceed': form.pol.printName.length > 22 }"
            maxlength="22"
          ></el-input>
          <!-- <p class="error-tips" v-show="form.pol.printName.length > 22">
            This field can accept only 22 characters
          </p> -->
        </el-form-item>
        <el-form-item
        ...
        <el-form-item label="Print on B/L as" prop="pod.printName">
          <el-input
            ...
            maxlength="22"
            :class="{ 'is-exceed': form.pod.printName.length > 22 }"
          ></el-input>
          <!-- <p class="error-tips" v-show="form.pod.printName.length > 22">
            This field can accept only 22 characters
          </p> -->
        </el-form-item>
        <el-form-item
        ...
        <el-form-item label="Print on B/L as" prop="placeOfDelivery.printName">
          <el-input
            ...
            maxlength="22"
            :class="{ 'is-exceed': form.placeOfDelivery.printName.length > 22 }"
          ></el-input>
          <!-- <p class="error-tips" v-show="form.placeOfDelivery.printName.length > 22">
            This field can accept only 22 characters
          </p> -->
        </el-form-item>
      </div>
      <div class="cnt-right">
        ...
        <el-form-item
          class="spec-item"
          label="Lloyd's Number"
          prop="transportDetail.imoNumber"
        >
          <el-input
            placeholder="Enter Number..."
            type="text"
            v-model="form.transportDetail.imoNumber"
          ></el-input>
        </el-form-item>
        <el-form-item
          class="spec-item"
          label="Call Sign"
          prop="transportDetail.callNumber"
        >
          <el-input
            placeholder="Enter Number..."
            type="text"
            v-model="form.transportDetail.callNumber"
          ></el-input>
        </el-form-item>
      </div>
    </el-form>
    ...
    return {
      ...
      rules: {
        ...
        'placeOfDelivery.printName': {
          message: 'This field can accept only 22 characters',
          max: 22,
          trigger: 'change',
        },
