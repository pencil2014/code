    ...
    >
      <div class="address-box">
        <div class="item-box">
          <div class="cnt-info">
            <el-form-item label="Shipper" prop="shipper.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('shipper', 'name', 35, 1)"
                :autosize="{ minRows: 0, maxRows: 2 }"
                
              ></el-input>
              <p class="error-tips" v-show="shippernameError">
                This field can accept only 1 lines of 35 characters
              </p>
            </el-form-item>
            <el-form-item
              class="addr-item"
          ...
          <div class="btn-box2">
            <p class="error-tips" v-show="shipperaddressError">
              This field can accept only 4 lines of 35 characters
            </p>
          ...
          <div class="cnt-info">
            <el-form-item label="Forwarder" prop="forwarder.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('forwarder', 'name', 35, 1)"
                :autosize="{ minRows: 0, maxRows: 2 }"
          ...
          <div class="cnt-info">
            <el-form-item label="Consignee" prop="consignee.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('consignee', 'name', 35, 1)"
                :autosize="{ minRows: 0, maxRows: 2 }"
          ...
          <div class="cnt-info">
            <el-form-item label="Notify Party" prop="notifyParty.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('notifyParty', 'name', 35, 1)"
              ></el-input>
            ...
            >
              <el-input
                ...
                @blur="handleTextarea('notifyParty')"
                :autosize="{ minRows: 0, maxRows: 4 }"
        ...
        <template v-if="showMore">
            ...
            <div class="cnt-info">
              <el-form-item label="Notify Party 2" prop="notifyParty2.name">
                ...
                <el-input
                  ...
                  @blur="handleTextarea('notifyParty2', 'name', 35, 1)"
                ></el-input>
              ...
              >
                <el-input
                  ...
                  @blur="handleTextarea('notifyParty2')"
                  :autosize="{ minRows: 0, maxRows: 4 }"
            ...
            <div class="cnt-info">
              <el-form-item label="Notify Party 3" prop="notifyParty3.name">
                ...
                <el-input
                  ...
                  @blur="handleTextarea('notifyParty3', 'name', 35, 1)"
                ></el-input>
              ...
              >
                <el-input
                  ...
                  @blur="handleTextarea('notifyParty3')"
                  :autosize="{ minRows: 0, maxRows: 4 }"
          ...
          <div class="item-box">
            <div class="cnt-info">
              <el-form-item label="freightPayer" prop="freightPayer.name">
                <div class="label-box" slot="label">
                  <div class="title">freightPayer</div>
                  <div class="btn-box">
                    <el-button
                      @click="clearData('freightPayer')"
                      class="btn-text"
                      icon="el-icon-close"
                      size="mini"
                      type="text"
                ...
                <el-input
                  ...
                  type="textarea"
                  spellcheck="false"
                  v-model="form.freightPayer.name"
                  :autosize="{ minRows: 0, maxRows: 2 }"
                  
                  @blur="handleTextarea('freightPayer', 'name', 35, 1)"
                ></el-input>
                <p class="error-tips" v-show="freightPayernameError">
                  This field can accept only 1 lines of 35 characters
                </p>
              </el-form-item>
              <el-form-item
              ...
              >
                <el-input
                  ...
                  type="textarea"
                  spellcheck="false"
                  v-model="form.freightPayer.address"
                  @blur="handleTextarea('freightPayer')"
                  :autosize="{ minRows: 0, maxRows: 4 }"
                  
                  :class="{ 'is-exceed': freightPayeraddressError }"
                ></el-input>
              </el-form-item>
            </div>
            <div class="btn-box2">
              <p class="error-tips" v-show="freightPayeraddressError">
                This field can accept only 4 lines of 35 characters
              </p>
              <el-button
                @click="showDialog('freightPayer')"
                size="mini"
                type="text"
              >
                Add Party Details
        ...
        <div class="item-box">
          <div class="cnt-info">
            <el-form-item label="Notify Party" prop="shipTo.name">
              <div class="label-box" slot="label">
                <div class="title">Ship To</div>
                <div class="btn-box">
                  <el-button
                    @click="clearData('shipTo')"
                    class="btn-text"
                    icon="el-icon-close"
                    size="mini"
                    type="text"
              ...
              <el-input
                ...
                @blur="handleTextarea('shipTo', 'name', 35, 1)"
              ></el-input>
              <p class="error-tips" v-show="shipTonameError">
                This field can accept only 1 lines of 35 characters
              </p>
            </el-form-item>
            <el-form-item
            ...
            >
              <el-input
                ...
                type="textarea"
                spellcheck="false"
                v-model="form.shipTo.address"
                @blur="handleTextarea('shipTo')"
                :autosize="{ minRows: 0, maxRows: 4 }"
                
                :class="{ 'is-exceed': shipToaddressError }"
              ></el-input>
            </el-form-item>
          </div>
          <div class="btn-box2">
            <p class="error-tips" v-show="shipToaddressError">
              This field can accept only 4 lines of 35 characters
            </p>
            <el-button @click="showDialog('shipTo')" size="mini" type="text">
              Add Party Details
            </el-button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    // textarea格式化
    handleTextarea(type, key = 'address', num = 35, line = 4) {
      let res = []
    ...
    showDialog(type) {
      if (type) {
        ...
        const { address, name, contact, street, country, province, city } = data
    ...
    initData() {
      // 格式化数据
      this.form.shipper.address.length && this.handleTextarea('shipper')
      this.form.shipper.name.length &&
        this.handleTextarea('shipper', 'name', 35, 1)
      this.form.consignee.address.length && this.handleTextarea('consignee')
      this.form.consignee.name.length &&
        this.handleTextarea('consignee', 'name', 35, 1)
      this.form.notifyParty.address.length && this.handleTextarea('notifyParty')
      this.form.notifyParty.name.length &&
        this.handleTextarea('notifyParty', 'name', 35, 1)
      this.form.notifyParty2.address.length &&
        this.handleTextarea('notifyParty2')
      this.form.notifyParty2.name.length &&
        this.handleTextarea('notifyParty2', 'name', 35, 1)
      // this.form.notifyParty3.address.length &&
      //   this.handleTextarea("notifyParty3")
      // this.form.notifyParty3.name.length &&
      //   this.handleTextarea("notifyParty3", "name", 35, 1)
      this.isCheck = true
