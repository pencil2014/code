  ...
  <div class="general-cnt">
    ...
    >
          ...
          <div class="cnt-info">
            <el-form-item label="Shipper" prop="shipper.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('shipper', 'name', 35, 2)"
          ...
          <div class="cnt-info">
            <el-form-item label="Forwarder" prop="forwarder.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('forwarder', 'name', 35, 2)"
                :autosize="{ minRows: 0, maxRows: 2 }"
              ></el-input>
          ...
          <div class="cnt-info">
            <el-form-item label="Consignee" prop="consignee.name">
              ...
              <el-input
                ...
                @blur="handleTextarea('consignee', 'name', 35, 2)"
                :autosize="{ minRows: 0, maxRows: 2 }"
              ></el-input>
          ...
          <div class="cnt-info">
            <el-form-item label="Notify Party" prop="notifyParty.name">
              ...
              <el-input
                ...
                :autosize="{ minRows: 0, maxRows: 2 }"
                @blur="handleTextarea('notifyParty', 'name', 35, 2)"
              ></el-input>
            ...
            <div class="cnt-info">
              <el-form-item label="Notify Party 2" prop="notifyParty2.name">
                ...
                <el-input
                  ...
                  :autosize="{ minRows: 0, maxRows: 2 }"
                  @blur="handleTextarea('notifyParty2', 'name', 35, 2)"
                ></el-input>
            ...
            <div class="cnt-info">
              <el-form-item label="Notify Party 3" prop="notifyParty3.name">
                ...
                <el-input
                  ...
                  :autosize="{ minRows: 0, maxRows: 2 }"
                  @blur="handleTextarea('notifyParty3', 'name', 35, 2)"
                ></el-input>
            ...
            <div class="cnt-info">
              <el-form-item label="freightPayer" prop="freightPayer.name">
                ...
                <el-input
                  ...
                  :autosize="{ minRows: 0, maxRows: 2 }"
                  @blur="handleTextarea('freightPayer', 'name', 35, 2)"
                ></el-input>
          ...
          <div class="cnt-info">
            <el-form-item label="Notify Party" prop="shipTo.name">
              ...
              <el-input
                ...
                :autosize="{ minRows: 0, maxRows: 2 }"
                @blur="handleTextarea('shipTo', 'name', 35, 2)"
              ></el-input>
      ...
      <div class="carrier-box">
        ...
        <el-form-item
          class="spec-item"
          label="Main B/L Reference Number"
          prop="mainBlNo"
        >
          <el-input
            placeholder="Enter Number..."
            type="text"
            v-model="form.mainBlNo"
          ></el-input>
        </el-form-item>
      </div>
    </el-form>
