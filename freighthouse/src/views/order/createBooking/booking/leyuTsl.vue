...
import Interested from './leyuTsl/interested'
import Transport from './leyuTsl/transport'
import Payment from './leyuTsl/payment'
...
export default {
    ...
    return {
      ...
      interestedOption: {
        shipper: {
          ...
          name: 'LONGSAIL SUPPLY CHAIN CO.,LTD',
          code: 'SZP019QO',
        },
        forwarder: {
          address: '',
  ...
  methods: {
    ...
    getDataSource(shipId) {
      ...
      bkgDetail(data)
        .then((res) => {
          ...
          bookingOffice && Object.assign(this.paymentOption,{bookingOffice}) 
    ...
    submitOriginalFn(type) {
      ...
      const { chargeTerm, bookingOffice } = this.paymentOption
