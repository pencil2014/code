<!--
 * @Author: Sivan
 * @Date: 2022-05-26 10:40:43
 * @LastEditTime: 2022-05-30 16:03:13
 * @LastEditors: Sivan
-->
<template>
...
export default {
  ...
  methods: {
    initData () {
      ...
      if (shipmentId && this.form.payLocation.locationCode) {
        this.cityList = [this.form.payLocation.locationCode]
      }
    },
    // 港口下拉
    getCityList(str = '') {
