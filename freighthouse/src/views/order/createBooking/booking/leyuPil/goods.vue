      ...
      >
        <div class="item-info">
          <div class="form-cnt">
            ...
            <el-form-item label="Commodity(CN)" prop="cargoCname">
              <el-input
                v-model="item.cargoCname"
                type="textarea"
                placeholder="Enter Commodity..."
                autosize
              ></el-input>
            </el-form-item>
            <el-form-item label="Marks" prop="mark">
              <el-input
                v-model="item.mark"
                type="textarea"
...
<script>
import GoodsDialog from '../leyuTsl/goodsDialog'
      ...
      handler(val) {
        if (val.dictList.length) {
          ...
          const source = val.dictList.filter(
            (item) => item.groupCode === 'leyu_cargo_type'
          )[0]
          this.cargoTypeList = source.dictItems
            .filter((ele) => ele.itemCode === '0')
            .map((item) => {
