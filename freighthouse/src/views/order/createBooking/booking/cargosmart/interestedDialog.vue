<!--
 * @Author: Sivan
 * @Date: 2022-05-24 11:26:39
 * @LastEditTime: 2022-05-24 11:28:06
 * @LastEditors: Sivan
-->
<template>
  <el-dialog
      ...
      <div class="cnt-left">
        ...
        >
          <el-input
            ...
            @blur="handleTextarea('address',35,3)"
            spellcheck="false"
            :class="{ 'is-exceed': isError }"
          ></el-input>
          <p class="error-tips" v-show="isError">
            This field can accept only 3 lines of 35 characters
          </p>
        </el-form-item>
      </div>
      <div class="cnt-right">
