<template>
  <div class="remarks-cnt">
    <el-form
      ...
      size="mini"
    >
      <el-form-item label="Comments" prop="remark" class="flex-item">
        <el-input
          type="textarea"
      ...
      <el-form-item
        label="BKG Requestor Emails (used by carriers for BKG communication)"
        prop="notifyEmails"
      >
        <div class="cnt-box">
          <div class="email-box">
...
export default {
  ...
  methods: {
    ...
    // 数据验证
    validateForm() {
      let { remark, notifyEmails } = this.form
      let flag = notifyEmails.some((item) => !!item.value)
      return flag && !!remark
    },
  },
}
