<template>
  <div>
    <div class="intereste-cnt">
      ...
      <div class="intereste-item">
        <div class="title-box">
          <div class="title"><b style="color: #ff4949">*</b> Notify Party</div>
        </div>
        <div class="cnt-box">
          <el-input
            placeholder="Enter Name..."
...
<script>
import InterestedDialog from '../leyuTsl/interestedDialog'
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      let flag = null
      const { shipper, consignee, notifyParty } = this.form
      if (!shipper.name || !consignee.name || !notifyParty.name) {
        flag = false
      } else {
        flag = true
      }
