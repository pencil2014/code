      ...
      >
        <div class="item-info">
          <div class="form-cnt">
            ...
            <el-form-item
              label="Freezer instead of dry cabinet"
              prop="isUsedAsDry"
              v-show="item.showReefer"
            >
              <el-select v-model="item.isUsedAsDry" placeholder="Select One" class="large-select">
                <el-option
  ...
  methods: {
    ...
    validateForm() {
      ...
      for (let index = 0; index < len; index++) {
        ...
        const { containerType, containerNum } = source
        if (!containerType || !containerNum) {
          flag = false
        }
      }
      return flag
