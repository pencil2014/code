    ...
    <div class="intereste-cnt">
      ...
      <div class="intereste-item">
        <div class="title-box">
          ...
          <div class="btn-box">
            <el-button
              @click="clearData('shipFrom')"
              icon="el-icon-close"
              size="mini"
              type="text"
              v-show="form.shipFrom.name"
            >
              Clear
            </el-button>
            <el-button
              @click="copyBooker('shipFrom')"
              icon="el-icon-s-custom"
              size="mini"
              type="primary"
            >
        ...
        <div class="cnt-box">
          <el-input
            ...
            :autosize="{ minRows: 0, maxRows: 2 }"
            resize="none"
            @blur="handleTextarea('shipFrom', 'name')"
            :class="{ 'is-exceed': shipFromnameError }"
          ></el-input>
          <div class="btn-box2">
            <p class="error-tips" v-show="shipFromnameError">
              This field can accept only 2 lines of 35 characters
            </p>
            <el-button
              @click="showDialog('shipFrom')"
              size="mini"
              type="text"
              v-show="form.shipFrom.name"
            >
      ...
      <div class="intereste-item">
        <div class="title-box">
          ...
          <div class="btn-box">
            <el-button
              ...
              size="mini"
              type="text"
              v-show="form.shipTo.name"
            >
              Clear
            </el-button>
            <!-- <el-button
              @click="copyBooker('shipTo')"
              icon="el-icon-s-custom"
              size="mini"
              type="primary"
            >My Role</el-button>-->
        ...
        <div class="cnt-box">
          <el-input
            ...
            :autosize="{ minRows: 0, maxRows: 2 }"
            resize="none"
            @blur="handleTextarea('shipTo', 'name')"
            :class="{ 'is-exceed': shipTonameError }"
          ></el-input>
          <div class="btn-box2">
        ...
        <div class="intereste-item">
          ...
          <div class="cnt-box">
            <el-input
              ...
              :autosize="{ minRows: 0, maxRows: 2 }"
              resize="none"
              @blur="handleTextarea('notifyParty3', 'name')"
              :class="{ 'is-exceed': notifyParty3nameError }"
            ></el-input>
            <div class="btn-box2">
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      // let flag = null
      // const { shipper, forwarder } = this.form
      // const shipperValues = Object.values(shipper.contact)
      // shipperValues.push(shipper.address)
      // const forwarderValues = Object.values(forwarder.contact)
      // forwarderValues.push(forwarder.address)
      // const sta1 = shipperValues.some(item => item === '')
      // const sta2 = forwarderValues.some(item => item === '')
      // if (!sta1 || !sta2) {
      //   flag = true
      // } else {
      //   flag = false
