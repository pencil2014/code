        ...
        <tbody>
          ...
          <tr valign="top">
            ...
            <td>
              ...
              {{ previewData.transportOption.transportDetail.iecCode }},
              {{ previewData.transportOption.transportDetail.cargoValue }},
              {{ previewData.transportOption.transportDetail.cargoValueCurrency }},
              {{ previewData.transportOption.transportDetail.acidNo }},
              {{ previewData.transportOption.transportDetail.importerId }},
              {{ previewData.transportOption.transportDetail.exporterId }},
            </td>
          </tr>
          <tr valign="top">
            <td>
              ...
              <template v-else>
                <template v-if="index === 0">
                  <td :rowspan="item.span">
                    ...
                    <p>Seal: {{ item.sn }} (Carrier)</p>
                    <p>Type: {{ item.containerType }}</p>
                    <p>Print on B/L as: {{item.printPackageType}}</p>
                  </td>
                  <td :rowspan="item.span">OUTER</td>
                  <td :rowspan="item.span">{{ item.quantity }} {{ item.printPackageType }}</td>
          ...
          <tr>
            <td>
              <table cellpadding="4" cellspacing="0" border="1" width="100%">
                <tbody>
                  <tr>
                    <td style="font-weight: bold" colspan="1">Type of B/L</td>
                  </tr>
                  <tr valign="top">
                    <td width="20%">
                      {{
                        previewData.typeOfBlStr || ''
                      }}
                    </td>
                  </tr>
                </tbody>
...
export default {
  ...
  created() {
    ...
    let { typeOfBl } = this.previewData.blSplitOption
    this.previewData.typeOfBlStr = this.$parent.$refs.blSplitForm.typeOfBlList.find(item => item.value === typeOfBl)?.label || ''
