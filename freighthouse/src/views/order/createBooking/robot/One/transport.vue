    ...
    >
      ...
      <div class="cnt-right">
        ...
        <template v-if="form.pod.locationCode.countryCode === 'IN'">
           <el-form-item
              class="middle-item"
              label="IEC CODE of Indian Shipper/Consignee"
              prop="transportDetail.iecCode"
            >
              <el-input
                size="mini"
                v-model="form.transportDetail.iecCode"
           ...
           <el-form-item
              class="middle-item"
              label="Cargo Value"
              prop="transportDetail.cargoValue"
            >
              <el-input
                style="width:50%;"
                size="mini"
                v-model="form.transportDetail.cargoValue"
                placeholder="Enter Cargo Value ..."
              ></el-input>
              <el-select style="width:36%;margin-left:10px;" v-model="form.transportDetail.cargoValueCurrency" size="mini" placeholder="Enter Cargo Value Currency">
                <el-option
        ...
        <template v-if="form.pod.locationCode.countryCode === 'EG'">
           <el-form-item
              class="middle-item"
              label="ACID No."
              prop="transportDetail.acidNo"
            >
              <el-input
                size="mini"
                v-model="form.transportDetail.acidNo"
                placeholder="Enter ACID No. ..."
              ></el-input>
           </el-form-item>
           <el-form-item
              class="middle-item"
              label="Importer ID"
              prop="transportDetail.importerId"
            >
              <el-input
                size="mini"
                v-model="form.transportDetail.importerId"
           ...
           <el-form-item
              class="middle-item"
              label="Exporter ID"
              prop="transportDetail.exporterId"
            >
              <el-input
                size="mini"
                v-model="form.transportDetail.exporterId"
