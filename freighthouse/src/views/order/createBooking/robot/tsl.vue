...
<script>
import General from './Tsl/general'
import Transport from './Tsl/transport'
import Particulars from './Tsl/particulars'
import Totals from './Tsl/totals'
import Charges from './Tsl/charges'
import Bl from './Tsl/bl'
import Notification from './Tsl/notification'
import Preview from './Tsl/preview'
import { shipId, siOriginal, dictAll, siDetail } from '@/api/order/createBooking'
import { getFieldConfig, getSiInfo, saveSiInfoTsl, updateSiInfoTsl, startSiTask, cancelSiTask, checkAuthInfo } from '@/api/order/robotSi'
...
export default {
  ...
  methods: {
    ...
    submitOriginalFn(type) {
      ...
      let requestMethod = this.oid ? updateSiInfoTsl : saveSiInfoTsl
