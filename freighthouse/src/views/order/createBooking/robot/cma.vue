...
<script>
import General from './Cma/general'
import Transport from './Cma/transport'
import Particulars from './Cma/particulars'
import Totals from './Cma/totals'
import Charges from './Cma/charges'
import Bl from './Cma/bl'
import Notification from './Cma/notification'
import Preview from './Cma/preview'
import { shipId, siOriginal, dictAll, siDetail } from '@/api/order/createBooking'
import { getFieldConfig, getSiInfo, saveSiInfoCma, updateSiInfoCma, startSiTask, cancelSiTask, checkAuthInfo } from '@/api/order/robotSi'
...
export default {
  ...
  methods: {
    ...
    getSiInfoData(resData) {
      ...
      if(resData.oid) {
        ...
        let {
          ...
          paymentPlace,
          isAdValorem,
          isAddCertificatesRequired,
          isPartLoad,
          isRequestForCargoCover,
          isTransportOrderForCarrierHaulage,
          isOnDeck,
          isSplit,
          isMerged,
          isExpressReleased,
        ...
        this.blOption = Object.assign(this.blOption,{
          blType,
          blOriginalCount: blOriginalCount || undefined,
          blOriginalUnfreightCount: blOriginalUnfreightCount || undefined,
          blCopyCount: blCopyCount || undefined,
          blCopyUnfreightCount: blCopyUnfreightCount || undefined,
          issuePlace: issuePlace || {
            locationName: '',
          },
          isAdValorem: isAdValorem || 'n',
          isAddCertificatesRequired: isAddCertificatesRequired || 'n',
          isPartLoad: isPartLoad || 'n',
          isRequestForCargoCover: isRequestForCargoCover || 'n',
          isTransportOrderForCarrierHaulage: isTransportOrderForCarrierHaulage || 'n',
          isOnDeck: isOnDeck || 'n',
          isSplit: isSplit || 'n',
          isMerged: isMerged || 'n',
          isExpressReleased: isExpressReleased || 'n',
          selectedClauses,
          remarks
        })
    ...
    submitOriginal(type) {
      ...
      if (!sta3) {
        document.getElementsByClassName('particulars-cnt')[0].scrollIntoView()
        return this.$msgErrClose('Particulars And Cargos is Required')
      }
    ...
    submitOriginalFn(type) {
      ...
      let requestMethod = this.oid ? updateSiInfoCma : saveSiInfoCma
