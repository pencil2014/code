...
<script>
import General from './Cosco/general'
import Transport from './Cosco/transport'
import Particulars from './Cosco/particulars'
import Totals from './Cosco/totals'
import Charges from './Cosco/charges'
import Bl from './Cosco/bl'
import Notification from './Cosco/notification'
import Preview from './Cosco/preview'
import { shipId, siOriginal, dictAll, siDetail } from '@/api/order/createBooking'
import { getFieldConfig, getSiInfo, saveSiInfoCosco, updateSiInfoCosco, startSiTask, cancelSiTask, checkAuthInfo } from '@/api/order/robotSi'
...
export default {
  ...
  methods: {
    ...
    submitOriginalFn(type) {
      ...
      let requestMethod = this.oid ? updateSiInfoCosco : saveSiInfoCosco
