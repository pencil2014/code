...
<script>
import General from './Whl/general'
import Transport from './Whl/transport'
import Particulars from './Whl/particulars'
import Totals from './Whl/totals'
import Charges from './Whl/charges'
import Bl from './Whl/bl'
import Notification from './Whl/notification'
import Preview from './Whl/preview'
