    ...
    <el-table
      ...
      >
        <template slot="header">
          <span>
              <span class="red" v-if="validateParams.includes('cargoNature')">*</span> 
              <span class="label-title-class">cargoNature</span>
          </span>
        </template>
        <template slot-scope="scope">
          <div class="middle-item">
            <el-select
               size="mini"
                placeholder="Enter cargoNature..."
                v-model="scope.row.cargoNature"
            >
              <el-option v-for="(item, index) in cargoNatureList" :key="index" :label="item.label" :value="item.value"></el-option>
            </el-select>
          </div>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template slot="header">
          <span>
              <span class="red" v-if="validateParams.includes('quantity')">*</span> 
      ...
      <el-table-column
        ...
        <template slot="header">
          <span>
              <span class="red"  v-if="validateParams.includes('weight')">*</span> 
      ...
      <el-table-column
        ...
        <template slot="header">
          <span>
              <span class="red" v-if="validateParams.includes('volume')">*</span> 
      ...
      <el-table-column
        ...
        <template slot="header">
          <span>
            <span class="red" v-if="validateParams.includes('hsCode')">*</span> 
      ...
      >
        <template slot="header">
          <span>
              <span class="red" v-if="validateParams.includes('description')">*</span> 
      ...
      >
        <template slot="header">
          <span>
              <span class="red" v-if="validateParams.includes('marks')">*</span> 
       ...
       <el-table-column
        prop="cargoHarmonizedCode"
        label="cargoHarmonizedCode"
        width="200px"
      >
        <template slot="header">
          <span>
              <span class="red" v-if="validateParams.includes('cargoHarmonizedCode')">*</span> 
              <span class="label-title-class">cargoHarmonizedCode</span>
          </span>
        </template>
        <template slot-scope="scope">
          <div class="middle-item">
            <el-input
               size="mini"
                placeholder="Enter cargoHarmonizedCode..."
                v-model="scope.row.cargoHarmonizedCode"
            ></el-input>
          </div>
        </template>
      </el-table-column>
      ...
      >
        <template slot="header">
          <span>
              <span class="red" v-if="validateParams.includes('netWeight')">*</span> 
              <span class="label-title-class">netWeight</span>
          </span>
        </template>
        <template slot-scope="scope">
          <div class="middle-item">
  ...
  methods: {
    getDictData() {
      const source = this.dictAll.dictList.filter(
        (item) => item.groupCode === 'ai_oocl_cargo_nature'
      )[0]
      this.cargoNatureList = source.dictItems.map((item) => {
