  ...
  >
    ...
    >
      <div class="cnt-left">
        ...
        <el-form-item class="spec-item" label="iecCode" prop="additionInformation.iecCode">
          <el-input
            placeholder="Enter iecCode..."
            size="mini"
            v-model="form.additionInformation.iecCode"
          ></el-input>
        </el-form-item>
        <el-form-item class="spec-item" label="panNo" prop="additionInformation.panNo">
          <el-input
            placeholder="Enter panNo..."
            size="mini"
            v-model="form.additionInformation.panNo"
          ></el-input>
        </el-form-item>
        <el-form-item class="spec-item" label="gstNo" prop="gstNo">
          <el-input
        ...
        >
          ...
          ></el-input>
          <el-select style="width:36%;margin-left:10px;" v-model="form.currencyCode" size="mini" placeholder="Enter currencyCode">
            <el-option
      ...
      <div class="cnt-right">
        ...
        <el-form-item class="middle-item" label="ZIP CODE" prop="zipCode">
          <el-input
        ...
        <el-form-item class="middle-item" label="EORI CODE" prop="eoriNo">
          <el-input
            placeholder="Enter EORI CODE..."
            size="mini"
            v-model="form.eoriNo"
          ></el-input>
        </el-form-item>
        <el-form-item class="middle-item" label="officialEmail" prop="officialEmail">
          <el-input
            placeholder="Enter officialEmail..."
            size="mini"
