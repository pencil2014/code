  ...
  methods: {
    ...
    initData() {
     // 格式化数据
      ...
      this.form.forwarder.address && this.handleTextarea('forwarder', 'address', 'forwarder.address')
      this.form.forwarder.name &&
        this.handleTextarea('forwarder', 'name', 'forwarder.name')
