        ...
        <tbody>
          <tr valign="top">
            <td rowspan="2">
              ...
              {{ previewData.generalOption.shipper.eoriNo }} <br />PO Box :
              {{ previewData.generalOption.shipper.poBox }} <br />TAX ID :
              {{ previewData.generalOption.shipper.taxId }} <br />Abbreviation Code (Ex:USCI) :
              {{ previewData.generalOption.shipper.abbreviationCode }} <br />AEO number :
              {{ previewData.generalOption.shipper.aeoNo }} <br />Enterprise Code (number) :
              {{ previewData.generalOption.shipper.enterpriseNo }}
            </td>
            <td rowspan="2">
              ...
              {{ previewData.generalOption.forwarder.eoriNo }} <br />PO Box :
              {{ previewData.generalOption.forwarder.poBox }} <br />TAX ID :
              {{ previewData.generalOption.forwarder.taxId }} <br />Abbreviation Code (Ex:USCI) :
              {{ previewData.generalOption.forwarder.abbreviationCode }} <br />AEO number :
              {{ previewData.generalOption.forwarder.aeoNo }} <br />Enterprise Code (number) :
              {{ previewData.generalOption.forwarder.enterpriseNo }}
            </td>
            <td>
          ...
          <tr valign="top">
            <td>
              ...
              {{ previewData.generalOption.consignee.eoriNo }} <br />PO Box :
              {{ previewData.generalOption.consignee.poBox }} <br />TAX ID :
              {{ previewData.generalOption.consignee.taxId }} <br />Abbreviation Code (Ex:USCI) :
              {{ previewData.generalOption.consignee.abbreviationCode }} <br />AEO number :
              {{ previewData.generalOption.consignee.aeoNo }} <br />Enterprise Code (number) :
              {{ previewData.generalOption.consignee.enterpriseNo }}
            </td>
            <td>
              <b>NOTIFY PARTY</b>
              <br />
              ...
              {{ previewData.generalOption.notifyParty.eoriNo }} <br />PO Box :
              {{ previewData.generalOption.notifyParty.poBox }} <br />TAX ID :
              {{ previewData.generalOption.notifyParty.taxId }} <br />Abbreviation Code (Ex:USCI) :
              {{ previewData.generalOption.notifyParty.abbreviationCode }} <br />AEO number :
              {{ previewData.generalOption.notifyParty.aeoNo }} <br />Enterprise Code (number) :
              {{ previewData.generalOption.notifyParty.enterpriseNo }}
            </td>
            <td>
              ...
              <br />Fax :
              {{ previewData.generalOption.notifyParty2.contact.fax }} <br />ZIP CODE :
              {{ previewData.generalOption.notifyParty2.zipCode }} <br />EORI CODE :
              {{ previewData.generalOption.notifyParty2.eoriNo }} <br />PO Box :
              {{ previewData.generalOption.notifyParty2.poBox }} <br />TAX ID :
              {{ previewData.generalOption.notifyParty2.taxId }} <br />Abbreviation Code (Ex:USCI) :
              {{ previewData.generalOption.notifyParty2.abbreviationCode }} <br />AEO number :
              {{ previewData.generalOption.notifyParty2.aeoNo }} <br />Enterprise Code (number) :
              {{ previewData.generalOption.notifyParty2.enterpriseNo }}
            </td>
            <td>
      ...
      if (cargos && cargos.length > 1) {
        ...
        containers.forEach((ele) => {
          particularsOptionList.push({
            ...ele,
            cargos,
            span: (ele.cargos && ele.cargos.length) || 1
          })
        })
      }
    })
