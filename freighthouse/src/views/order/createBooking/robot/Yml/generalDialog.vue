  ...
  >
    ...
    >
      <div class="cnt-left">
        ...
        <el-form-item class="spec-item" label="PO Box" prop="poBox">
          <el-input
        ...
        <el-form-item class="spec-item" label="TAX ID" prop="taxId">
          <el-input
        ...
        <el-form-item class="spec-item" label="Abbreviation Code (Ex:USCI)" prop="abbreviationCode">
          <el-input
            placeholder="Enter Abbreviation Code (Ex:USCI)..."
            size="mini"
            v-model="form.abbreviationCode"
          ></el-input>
        </el-form-item>
        <el-form-item class="spec-item" label="AEO number" prop="aeoNo">
          <el-input
            placeholder="Enter AEO number..."
            size="mini"
            v-model="form.aeoNo"
          ></el-input>
        </el-form-item>
      ...
      <div class="cnt-right">
        ...
        <el-form-item class="middle-item" label="Enterprise Code (number)" prop="enterpriseNo">
          <el-input
            placeholder="Enter Enterprise Code (number)..."
            size="mini"
