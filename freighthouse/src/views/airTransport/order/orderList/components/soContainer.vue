        ...
        <el-form :model="soContainerData" ref="airSoContainer" label-width="70px" :show-message="false">
          <div class="row-flex flex-so" v-for="(el,index) in soContainerData.formData" :key="index">
            ...
            <div :class="{'form-box':!disabledState,'form-box100':disabledState}">
              <el-col :lg="{span: '4'}">
                <el-form-item class="min-width200" label="发货单位" :prop="'formData.'+index+'.cargoCustId'" :rules="soContainerData.rules.cargoCustId">
              ...
              <!-- <el-col :lg="{span: '4'}">
                <el-form-item class="min-width200" label="交仓地点">
                  <el-select size="mini" v-model="el.poDealAddress" filterable remote clearable :disabled="disabledState" style="width: 100%" placeholder="请输入" :remote-method="(val)=>{ receiptPlaceFilterMehod(val,index,el.poDealAddress)}" @focus="receiptPlaceFilterMehod('',index,el.polPortCode)">
                    <el-option v-for="item in el.cityArr||[]" :key="item.value" :label="item.label" :value="item.value"> </el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :lg="{span: '4'}">
                <el-form-item class="min-width200" label="交仓时间">
                  <elDatePickerLimit size="mini" v-model="el.poDealTime" :disabled="disabledState" type="date" style="width: 100%" clearable placeholder="请选择时间" value-format="yyyy-MM-dd" />
                </el-form-item>
              </el-col> -->
            </div>
          </div>
