<template>
  <div>
    <div class="orderDetail-air-transport ">
      <el-row :gutter="10" style="margin-bottom:10px" class="transport-from">
        <el-col :lg="{span: '1-2'}">
          <div class="transport-info-title">{{typeText}}航程</div>
        </el-col>
        <el-col :lg="{span: '3-8'}">
          <div class="transport-info-item">承运人</div>
        </el-col>
        <el-col :lg="{span: '3-8'}">
          <div class="transport-info-item">{{typeText}}起飞日</div>
        </el-col>
        <el-col :lg="{span: '3-8'}">
          <div class="transport-info-item">{{typeText}}到达日</div>
        </el-col>
        <el-col :lg="{span: '3-8'}">
          <div class="transport-info-item">{{typeText}}航班号</div>
        </el-col>
        <el-col :lg="{span: '3-8'}">
              ...
              <el-col :lg="{span: '3-8'}">
                <div class="transport-info-item">
                  <el-form-item class="" :prop="'formData.'+index+'.carrierSupplierId'" :rules="transportInfoData.rules.carrierSupplierId">
                    <el-select style="width:100%" :disabled="disabledState" size="mini" clearable v-model="el.carrierSupplierId" filterable remote reserve-keyword placeholder="请选择航空公司" :remote-method="(val)=>{ remoteMethod(val,index,el.carrierSupplierId)}" @focus="(val)=>{ remoteMethod('',index,el.carrierSupplierId)}">
              ...
              <el-col :lg="{span: '3-8'}">
                <div class="transport-info-item">
                  <el-form-item class="" :prop="'formData.'+index+'.polPortCode'" :rules="transportInfoData.rules.polPortCode">
                    <el-select size="mini" :disabled="disabledState" style="width:100%" clearable v-model="el.polPortCode" filterable remote reserve-keyword placeholder="请选择起运港" :remote-method="(val)=>{ polPortRemoteMethod(val,index,el.polPortCode)}" @focus="polPortRemoteMethod('',index,el.polPortCode)">
              ...
              <el-col :lg="{span: '3-8'}">
                <div class="transport-info-item">
                  <el-form-item class="" :prop="'formData.'+index+'.unloadingPortCode'" :rules="transportInfoData.rules.unloadingPortCode">
                    <el-select style="width:100%" :disabled="disabledState" size="mini" clearable v-model="el.unloadingPortCode" filterable remote reserve-keyword placeholder="请选择目的地" :remote-method="(val)=>{ unloadingPortMethod(val,index,el.unloadingPortCode)}" @focus="unloadingPortMethod('',index,el.unloadingPortCode)">
...
export default {
  ...
  created() {
    ...
    //   eflightNumber: [{ required: true, message: '请选择', trigger: 'change' }],
    //   polPortCode: [{ required: true, message: '请选择', trigger: 'change' }],
    //   unloadingPortCode: [
    //     { required: true, message: '请选择', trigger: 'change' }
    //   ]
    // }
