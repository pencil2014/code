  ...
  <div class="edit-row" v-loading="loading">
    <div class="edit-container so">
      ...
      <div class="row-form mt10 table-com-layout air-bl">
        <el-table ref="blTable" :row-class-name="tableRowClassName" style="width: 100%" :data="blList" :select-on-indeterminate="true" @select-all="handleSelectAll" @select="handleSelect" @selection-change="handleSelectionChange" :max-height="400">
  ...
  methods: {
    ...
    handleExport(value) {
      ...
      if (this.fileCommand == '1') {
        url = '/order/air/imports/bl/exportDraft'
        data = {
          blId: this.multipleSelection[0].blId,
