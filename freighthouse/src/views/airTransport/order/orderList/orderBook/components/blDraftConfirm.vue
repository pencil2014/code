<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form ref="createForm" :rules="rules" :model="createItem" label-position="right" label-width="120px" class="create-form">    
      <el-form-item label="单证中心" prop="employeeId">
        <el-select 
          size="mini" 
          clearable
          filterable
          v-model="createItem.employeeId"
          style="width: 100%"  
          placeholder="请选择"
      ...
      <el-form-item label="补料要求" prop="siRemark">
        <el-input type="textarea" size="mini" placeholder="请输入" v-model="createItem.siRemark"></el-input>
      </el-form-item>
    </el-form>
  </BaseDialog>
</template>
