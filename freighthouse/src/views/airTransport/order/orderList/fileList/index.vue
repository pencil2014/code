  ...
  <div class="edit-container order-book fullWrap" id="fileList">
    <div class="order-container">
      <div class="tabs-container">
        <!-- <TopNav :serviceType="airOrderInfo.serviceType" :activityKey="activityKey" @routerPush="handleToRoute" /> -->
        <div class="detail-container flex">
          <!-- <LeftNav :orderInfo="airOrderInfo" :activityKey="activityKey" @routerPush="handleToRoute" /> -->
          <div class="flex1 component-main-cont">
            <div class="service-container">
              <CustInfo :orderInfo="airOrderInfo" />

              <div class="fileList-cont" style="margin-top:0">
                ...
                <div class="mb10 between h28">
                  <div class="ft14 bold air-file-title">附件列表</div>
                  <div>
                ...
                <el-table style="width: 100%" fit highlight-current-row :data="fileList" @cell-mouse-enter="showTooltip" @cell-mouse-leave="hiddenTooltip" @selection-change="handleSelectionChange">
                  ...
                  <el-table-column v-if="fileStatus === 'effect'" label="操作" width="180" align="center" fixed="right">
                    <template v-if="fileStatus === 'effect'" slot-scope="scope">
                      <div class="operate-group">
                        ...
                        <el-button @click="handleDownload(scope.row)" type="text" size="mini" style="padding:0">下载</el-button>
                        <el-button @click="handleDelete(scope.row)" type="text" class="red" size="mini" v-if="isEditView && isSelfFile(scope.row) && bookingDelStatus(scope.row)" style="padding:0">删除</el-button>
                      </div>
                    </template>
                  </el-table-column>
                </el-table>
              ...
              <div v-if="uploadPopShow">
                <FileUpload @close="uploadPopClose" :compensaAgreementIsEditView="compensaAgreementIsEditView" :isAc="isAc" />
              </div>
...
export default {
  ...
  computed: {
    ...
    compensaAgreementIsEditView() {
      ...
      return this.isBd || this.roles.includes('op')
    },
    isBd() {
