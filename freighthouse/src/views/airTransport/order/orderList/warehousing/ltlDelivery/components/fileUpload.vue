	...
	<BaseDialog :config="dialogConfig" :callback="dialogCallback">
		<el-form ref="uploadFileForm" :model="createdItem" :rules="rules" label-position="right" label-width="70px" class="create-form">
			<el-form-item label="签收时间" prop="signTime">
				<elDatePickerLimit  noCanFuture size="mini" v-model="createdItem.signTime" type="datetime" style="width: 100%" clearable placeholder="请选择签收时间" value-format="yyyy-MM-dd HH:mm:ss" />
			</el-form-item>
