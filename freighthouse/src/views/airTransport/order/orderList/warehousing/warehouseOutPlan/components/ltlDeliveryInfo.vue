				...
				<el-row>
					...
					<el-col :span="6">
						<el-form-item label="装货地点" prop="loadPlace" :show-message="false">
							...
							<el-cascader style="width:100%" size="mini" :emitPath="true" v-model="formData.loadPlace" :options="loadPlaceData" :props="cityProps" clearable @change="handleLoadChange"></el-cascader>
						</el-form-item>
					</el-col>
					<el-col :span="6">
					...
					<el-col :span="6">
						<el-form-item label="卸货地点" prop="unloadPlace" :show-message="false">
							...
							<el-cascader style="width:100%" size="mini" :emitPath="true" v-model="formData.unloadPlace" :options="unloadPlaceData" :props="cityProps" clearable @change="handleUnloadChange"></el-cascader>
						</el-form-item>
					</el-col>
					<el-col :span="6">
