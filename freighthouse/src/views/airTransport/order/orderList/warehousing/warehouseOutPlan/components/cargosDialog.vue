<template>
	<BaseDialog :config="dialogConfig" :callback="dialogCallback">
		<div id="cargosDialog" class="table-com-layout">
			<el-table fit show-summary :summary-method="getSummaries" :data="cargosList" style="width: 100%">
				<el-table-column prop="cname" label="品名" width="180"> </el-table-column>
				<el-table-column prop="mark" label="唛头" width="180"> </el-table-column>
				...
				<el-table-column prop="packageType" label="包装">
