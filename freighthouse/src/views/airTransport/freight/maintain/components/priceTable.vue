  ...
  <div class="edit-row box-row surcharge-table">
    <div class="row-tit">
      ...
      <div class="row-tit-operate">
        ...
        <el-button type="primary" v-if="!disabledState" size="mini" ref="add" @click="handleAddLine">新增</el-button>
      </div>
    </div>
    <div class="row-form">
      <el-form label-width="auto" :model="tableData" ref="surchargeTable" :show-message="false">
        <el-table :data="tableData.list" :max-height="240">
          ...
          <el-table-column align="center" label="货物类型" width="150">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceCargoType'" :rules="tableData.rules.priceCargoType">
                <el-input :disabled="disabledState" placeholder="请输入" maxlength="128" size="mini" v-model="scope.row.priceCargoType">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="最低收费">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceMin'" :rules="tableData.rules.priceMin">
                <el-input :disabled="disabledState" placeholder="请输入" size="mini" v-model="scope.row.priceMin" @input="checkNumInput(scope.row.priceMin)">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="+45KG">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceKg45'" :rules="tableData.rules.priceKg45">
                <el-input :disabled="disabledState" placeholder="请输入" size="mini" v-model="scope.row.priceKg45" @input="checkNumInput(scope.row.priceKg45)">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="+100KG">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceKg100'" :rules="tableData.rules.priceKg100">
                <el-input :disabled="disabledState" placeholder="请输入" size="mini" v-model="scope.row.priceKg100" @input="checkNumInput(scope.row.priceKg100)">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="+300KG">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceKg300'" :rules="tableData.rules.priceKg300">
                <el-input :disabled="disabledState" placeholder="请输入" size="mini" v-model="scope.row.priceKg300" @input="checkNumInput(scope.row.priceKg300)">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="+500KG">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceKg500'" :rules="tableData.rules.priceKg500">
                <el-input :disabled="disabledState" placeholder="请输入" size="mini" v-model="scope.row.priceKg500" @input="checkNumInput(scope.row.priceKg500)">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="+1000KG">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceKg1000'" :rules="tableData.rules.priceKg1000">
                <el-input :disabled="disabledState" placeholder="请输入" size="mini" v-model="scope.row.priceKg1000" @input="checkNumInput(scope.row.priceKg1000)">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="+2000KG">
            <template slot-scope="scope">
              <el-form-item :prop="'list.'+scope.$index+'.priceKg2000'" :rules="tableData.rules.priceKg2000">
                <el-input :disabled="disabledState" placeholder="请输入" size="mini" v-model="scope.row.priceKg2000" @input="checkNumInput(scope.row.priceKg2000)">
                </el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="操作" fixed="right">
            <template slot-scope="scope">
              <el-button @click="handleDelete(scope)" type="text" :disabled="disabledState" class="red" size="mini">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-form>
