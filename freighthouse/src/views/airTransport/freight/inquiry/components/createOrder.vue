  ...
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form ref="createOrderForm" :rules="rules" :model="createdItem" label-position="right" label-width="80px" class="create-order-form">
      <el-form-item label="业务类型" prop="businessType">
        <el-select v-model="createdItem.businessType" size="mini" disabled clearable placeholder="请选择" style="width: 100%">
      ...
      <el-form-item label="服务类型" prop="serviceType">
        <el-select v-model="createdItem.serviceType" disabled size="mini" clearable placeholder="请选择" @focus="handleClickServiceType" style="width: 100%">
  ...
  methods: {
    getBusinessType() {
      ...
      baseBusinessList().then((res) => {
        ...
        this.handleSelectBusinessType('air_export')
      })
    },
