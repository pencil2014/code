...
const columns = {
    ...
    'confirmStatus', 'finDate', 'acfinDate', 'precloseStatus', 'precloseTime', 'closeStatus', 'closeTime', 'settleLock', 'lockReason', 'settleCycle',
    ...
    'writeoffNos', 'totalWriteoffAmt', 'notWriteoffAmt', 'blNos'],
	// 费用列表默认表头
    ...
    'signStatus', 'signDate', 'acfinDate', 'acfinCloseStatus', 'transferExVoucherNos', 'exVoucherNos', 'usdInterest', 'confirmLateFeeAmt', 'exportOrderNo', 'acfinBasicCurrency', 'acfinExRate', 'acfinBasicMoneyAmt', 'ecsEmployeeName', 'finBillType'
	],
  ...
  columnsBase: [
    ...
    { prop: 'sourceBizNo', label: '工作号', type: 'text', key: 'sourceBizNo', width: 125 },
    ...
    { prop: 'businessType', label: '业务类型', type: 'select', key: 'businessType', width: 128, propInDict: 'feeListBusinessType' },
		...
		{ prop: 'bdDeptName', label: '销售部门', type: 'text', key: 'bdDeptName', width: 125 },
    ...
    { prop: 'blNos', label: '提单号', type: 'text', key: 'blNos', width: 160 },
    ...
    { prop: 'signStatus', label: '签收状态', type: 'select', key: 'signStatus', width: 80 },
    { prop: 'signDate', label: '签收时间', type: 'text', key: 'signDate', width: 130 },
    { prop: 'acfinDate', label: '会计日期', type: 'text', key: 'acfinDate', width: 130 },
    { prop: 'acfinCloseStatus', label: '是否会计关账', type: 'select', key: 'acfinCloseStatus', propInDict: 'yesNo', width: 80 },
    { prop: 'transferExVoucherNos', label: '会计转字凭证号', type: 'text', key: 'transferExVoucherNos', width: 100 },
    { prop: 'exVoucherNos', label: '会计收付凭证号', type: 'text', key: 'exVoucherNos', width: 100 },
		{ prop: 'usdInterest', label: '预计滞纳金(USD)', type: 'text', key: 'usdInterest', width: 130 },
    { prop: 'confirmLateFeeAmt', label: '确认实际滞纳金(USD)', type: 'text', key: 'confirmLateFeeAmt', width: 150 },
    { prop: 'exportOrderNo', label: '关联出口单号', type: 'text', key: 'exportOrderNo', width: 130 },
    { prop: 'acfinBasicCurrency', label: '会计记账本位币', type: 'text', key: 'acfinBasicCurrency', width: 130 },
    { prop: 'acfinExRate', label: '会计记账汇率', type: 'text', key: 'acfinExRate', width: 130 },
    { prop: 'acfinBasicMoneyAmt', label: '会计折本位币金额', type: 'text', key: 'acfinBasicMoneyAmt', width: 130 },
    { prop: 'ecsEmployeeName', label: '海外客服', type: 'text', key: 'ecsEmployeeName', width: 100 },
    { prop: 'finBillType', label: '费用单类型', type: 'select', key: 'finBillType', propInDict: 'finBillBillType', width: 100 },
  ],
  columnsBase2: [
