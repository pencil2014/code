...
import ColumnDatePicker from '@/views/order/order/orderList/planorder/followItems/components/ColumnDatePicker.vue'
...
function lastInitColumnsBase(handleClickRefreshList) {
  return [
    ...
    },
    {
      ...
      disabled: false,
      sortable: 'custom',
      popoverComponent: ColumnDatePicker,
      method: (row, val) => {
        handleClickRefreshList(row, val)
      },
    },
...
const releaseList = {
  ...
  columnsBase(handleClickRefreshList, handleClickRefreshListAndColumn) {
    return [
      ...fristInitColumnsBase(handleClickRefreshList),
      { label: '是否申请不甩柜', key: 'isNodrop', prop: 'isNodrop', disabled: false, width: '150', formatter: (row, column) => {
...
const state = {
  ...
  sendPayBankReceiptList: {
    defaultColumns: sendPayBankReceiptList.defaultColumns,
		specialColumns: sendPayBankReceiptList.specialColumns,
		columnsBase: sendPayBankReceiptList.columnsBase
  },
  departureList: {
    defaultColumns: departureList.defaultColumns,
		specialColumns: departureList.specialColumns,
		columnsBase: departureList.columnsBase
  },
  arrivalList: {
    defaultColumns: arrivalList.defaultColumns,
		specialColumns: arrivalList.specialColumns,
		columnsBase: arrivalList.columnsBase
  },
  serviceCodeVal: '',
  subStatusTypeVal: '',
  activityKey: '',
...
const actions = {
  ...
  setActivityKey(context, params) {
		context.commit('setActivityKey', params)
	},
}
