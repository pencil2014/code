...
const orderList = {
	...
	columnsBase(handleOrderNoInfo) {
		return [
			...
			// 新增
			{ label: '运单号', key: 'blNo', prop: 'blNo', disabled: false, width: '120', sortable: 'custom' },
			...
			{ label: '起运国', key: 'polCountryCname', prop: 'polCountryCname', disabled: false, width: '120' },
			{ label: '目的国', key: 'podCountryCname', prop: 'podCountryCname', disabled: false, width: '120' },
...
const orderReportList = {
	...
	columnsBase(handleOrderNoInfo) {
		return [
			...
			{ label: '运单号', key: 'blNo', prop: 'blNo', sortable: 'custom', width: '120', disabled: false },
			...
			{ label: '空运订舱单价', key: 'airBookPrice', prop: 'airBookPrice', width: '150' },
			{ label: '空运订舱币别', key: 'airBookCurrency', prop: 'airBookCurrency', width: '150' },
			{ label: '空运出货单价', key: 'airDeliverPrice', prop: 'airDeliverPrice', width: '150' },
			{ label: '空运出货币别', key: 'airDeliverCurrency', prop: 'airDeliverCurrency', width: '150' },
			{ label: '差额', key: 'airPriceDiff', prop: 'airPriceDiff', width: '150' },
		]
	}
}
...
const state = {
	...
	orderList: {
		...
		// 订单详情可写入角色集合
		allEditRoleArr: ['bd', 'obd', 'asst', 'op', 'cs', 'ecs', 'ac', 'eac', 'pricing', 'epricing', 'rc'],
