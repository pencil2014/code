    ...
    getData() {
      ...
      Fn(data).then(res => { // getBillDetail(data).then(res => {
        if (res.code === 0) {
          ...
          if (this.ship) {
            this.showOptions = this.showOptions.length > 0 ? this.showOptions : ['custNameShow', 'custAddrShow', 'dnNoShow', 'orderNoShow', 'soShow', 'cnShow', 'hblShow', 'mblShow', 'etdShow', 'atdShow', 'etaShow', 'vesselShow', 'polPortCodeShow', 'podPortCodeShow'] // 'custIntrustNoShow', 'billNoShow',
          } else if (this.air) {
            this.showOptions = this.showOptions.length > 0 ? this.showOptions : ['custNameShow', 'custAddrShow', 'dnNoShow', 'orderNoShow', 'hblShow', 'mblShow', 'etdShow', 'etaShow', 'airLineShow', 'eflightNumberShow', 'polPortCodeShow', 'podPortCodeShow', 'totalQuantityShow', 'totalWeightShow', 'totalVolumeShow', 'chargeWeightShow'] // 'custIntrustNoShow', 'billNoShow',
          } else if (this.rail) {
            this.showOptions = this.showOptions.length > 0 ? this.showOptions : ['custNameShow', 'custAddrShow', 'dnNoShow', 'orderNoShow', 'cnShow', 'hblShow', 'mblShow', 'etdShow', 'vesselShow', 'polPortCodeShow', 'podPortCodeShow', 'totalQuantityShow', 'totalWeightShow', 'totalVolumeShow'] // 'custIntrustNoShow', 'billNoShow',
          }
