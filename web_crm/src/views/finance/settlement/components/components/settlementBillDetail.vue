    ...
    <el-form ref="accountForm" :inline="true" size="mini">
      <el-form-item label="显示字段">
        <el-select v-model="showOptions"
          ...
          <el-option label="开航日期(ETD)" value="etdShow"></el-option>
...
export default {
  ...
  data() {
    return {
      ...
      allShowOptions: ['settleCompNameShow', 'bdEmployeeNameShow', 'settleCorpNameShow', 'sourceBizNoShow', 'billNoShow', 'dnNoShow', 'customerNoShow', 'containerNoShow', 'soNoShow', 'sysLienNameShow', 'vesselVoyageShow', 'polEnameShow', 'podEnameShow', 'boxSizeShow', 'etdShow', 'atdShow', 'etaShow', 'feeNameShow', 'currencyShow', 'reciTotalAmtShow', 'payTotalAmtShow', 'hblShow', 'mblShow', 'signStatusShow', 'signDateShow'],
      defaultShowOptions: ['settleCompNameShow', 'sourceBizNoShow', 'billNoShow', 'dnNoShow', 'containerNoShow','soNoShow', 'polEnameShow', 'podEnameShow', 'boxSizeShow', 'etdShow', 'atdShow', 'etaShow', 'feeNameShow', 'currencyShow', 'reciTotalAmtShow', 'payTotalAmtShow'], // 'settleCorpNameShow', 'customerNoShow', 现统一都用这个
  ...
  methods: {
    ...
    getColumns() {
      let labelObj = {
        ...
        etdShow: {en: 'ETD', zh: '开航日期'},
        atdShow: {en: 'ATD', zh: '实际开航日期'},
        etaShow: {en: 'ETA', zh: '到港日期'},
      ...
      // })
      let $this = this
      this.showOptions = this.showOptions.sort(function(a, b) {
      ...
      this.showOptions = this.showOptions.filter(item => labelObj[item])
      columns = this.showOptions.map(item => {
        ...
        if (itemNew === 'settleCompName') {
          ...
          width = 125
        } else if (itemNew === 'etd' || itemNew === 'eta') {
          minWidth = 90
        } else if (itemNew === 'atd') {
          minWidth = 100
        }
        ...
        let sortable = false
        if (itemNew === 'etd' || itemNew === 'eta' || itemNew === 'atd') {
          sortable = true
        }
        return {
          prop: itemNew,
