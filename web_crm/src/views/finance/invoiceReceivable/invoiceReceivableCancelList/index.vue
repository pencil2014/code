  ...
  >
    ...
    <el-dialog title="审核拒绝" :visible.sync="dialogRefuseVisible" width="500px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="mini" @click="dialogRefuseVisible = !dialogRefuseVisible">取消</el-button>
      </span>
    </el-dialog>
  ...
  data() {
    return {
      ...
      selfColumnsBase: [
        ...
        { prop: 'confirmName', label: '审核人', width: 130 },
        { prop: 'confirmTime', label: '审核时间', width: 130 },
