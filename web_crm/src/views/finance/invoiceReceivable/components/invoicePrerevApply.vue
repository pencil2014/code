    ...
    <div class="finance-container-scroll">
      ...
      >
        <div class="settlement-detail-form">
          ...
          <div>
            ...
            <el-form-item label="开票币种：" prop="invoiceCurrency">
              <el-select v-model="invoiceApplyForm.invoiceCurrency" placeholder="请选择">
                <el-option
            ...
            <el-form-item label="开票方式：" prop="invoiceWay">
              <el-select v-model="invoiceApplyForm.invoiceWay" placeholder="请选择">
                <el-option
        ...
        <div class="settlement-detail-form">
          <h3>客户信息</h3>
          <div>
            <el-form-item label="结算单位：" prop="settleCompInfoObj">
              <el-select
            ...
            <el-form-item v-if="!isCannotChange" label="纳税人类型：" prop="taxpayerType">
              <el-select v-model="invoiceApplyForm.taxpayerType" placeholder="请选择">
                <el-option
  ...
  methods: {
    ...
    initInvoiceTableOption(index, canDelete) {
      ...
      option.columns = [
        ...
        { prop: 'price', label: '单价', type: 'input', width: 90, inputType: 'number', positive: true },
        { prop: 'amt', label: '金额', type: 'text', width: 80 },
        { prop: 'amtWithoutTax', label: '金额(不含税)', type: 'text', width: 80 },
        { prop: 'taxRate', label: '税率', type: 'select', propInDict: 'taxRateInfo', width: 55 },
