...
export const orderMixin = {
	...
	methods: {
		...
		getRefuse(values) {
			...
			let { orderAuditRefuseReason, bkgRefuseReason, lclAuditRefuseReason } = this.dictMap
			let refuseReasonOptions = orderAuditRefuseReason.concat(bkgRefuseReason, lclAuditRefuseReason)
