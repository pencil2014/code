<template>
	<el-tooltip placement="right" popper-class="copyOrderNo-pop" :content="param.jointNo" :visible-arrow="false">
		<span class="review-row-table-header-container">
			...
			<span size="mini">{{ param.jointNo }}</span>
		</span>
	</el-tooltip>
</template>
