<template>
  <div class="cargo-form">
    <div class="row-flex flex-cargo" v-for="(o, index) in createItem.cargoList" :key="index">
      ...
      <div class="cargo-item hscode">
        ...
        <div class="item-content">
          <el-select v-model="o.shipperCustid" size="mini" remote filterable clearable @visible-change="(val) => custVisibleChange(val, index, o.shipperCustid)"
            :remote-method="(val) => custFilterMehod(val, index)" placeholder="请选择" @change="(val) => handleSelectCustid(val, index)" :disabled="viewState || isOp" style="width: 100%">
      ...
      <el-form-item class="cargo-item hscode" label="中文品名" :prop="`cargoList.${index}.cname`" 
      :show-message="false" :rules="{required: false, message: '请输入中文品名', trigger: 'blur'}">
        ...
        <el-input  v-else size="mini" v-model="o.cname" clearable placeholder="请输入中文品名" :disabled="viewState || isOp" maxlength="128"></el-input>
      </el-form-item>
      <el-form-item class="cargo-item hscode" label="英文品名" :prop="`cargoList.${index}.ename`" 
      :show-message="false" :rules="{required: false, message: '请输入英文品名', trigger: 'blur'}">
        ...
        <el-input v-else size="mini" v-model="o.ename" clearable placeholder="请输入英文品名" :disabled="viewState || isOp" maxlength="128"></el-input>
      </el-form-item>
      <div class="cargo-item hscode">
      ...
      <el-form-item class="cargo-item hscode" label="货物性质" :prop="`cargoList.${index}.property`" :show-message="false" 
        ...
        <el-select size="mini" v-model="o.property" style="width: 100%" clearable placeholder="请选择货物性质" :disabled="viewState || isOp">
      ...
      <el-form-item v-if="isWoodenPackageState" class="cargo-item hscode" label="木质包装" :prop="`cargoList.${index}.isWoodenPackage`" 
        ...
        <el-select size="mini" v-model="o.isWoodenPackage" style="width: 100%" clearable placeholder="请选择木质包装" :disabled="viewState || isOp">
...
export default {
  ...
  computed: {
    ...
    viewState() {
      ...
      // if(this.orderInfoDataObj.exportOrderNo){
      //   return true
      // }
      return false
    },
