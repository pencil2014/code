<template>
	...
	<div id="warehouseInplan" class="edit-row" v-loading="lsLoading"
		...
		<template v-if="showInWarehouse">
			<InWarehouseDetail :isFinish="isFinish" :isDisabledEdit="isDisabledEdit" :isJoint="isJoint" :detailData="in_formData" :saveBarFixed="saveBarFixed" @close="close" @handleConfirm="handleSave"></InWarehouseDetail>
		</template>
		<!-- 生成出仓计划 -->
    ...
    tableCallBack(action, arr) {
      ...
      this['handle' + action](arr)
		...
		getList() {
			...
			orderWarehouseInList(data).then(res => {
