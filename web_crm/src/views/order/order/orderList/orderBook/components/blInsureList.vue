<template>
  <div id="blFileList">
    <BaseDialog :config="dialogConfig" :callback="dialogCallback">
      ...
      <el-table fit highlight-current-row style="width: 100%" ref="fileListTable" :data="tableData" class="table-cont bl-table-insure">
        ...
        <el-table-column show-overflow-tooltip="" width="110" prop="policyHolderCustName" label="投保受益人公司" align="center">
          <span v-if="scope.row.oid" slot-scope="scope">
        ...
        <el-table-column width="150" show-overflow-tooltip="" prop="payLocation" label="赔付地" align="center">
          <span v-if="scope.row.oid" slot-scope="scope">
        ...
        <el-table-column show-overflow-tooltip="" prop="insuranceSupplierId" label="保险公司" width="150" align="center">
          <span v-if="scope.row.oid" slot-scope="scope">
        ...
        <el-table-column show-overflow-tooltip="" prop="issueMode" label="出单方式" align="center">
          <span v-if="scope.row.oid" slot-scope="scope">
        ...
        <el-table-column show-overflow-tooltip="" prop="billFileName" label="保单名称" align="center"> </el-table-column>
        ...
        <el-table-column prop="putFinishTime" width="100" label="放单完成时间" align="center">
          <span slot-scope="scope">
