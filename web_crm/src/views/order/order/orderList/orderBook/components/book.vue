<template>
	<div class="edit-row" id="Book">
		<div class="edit-container so">
			<div id="tableCont" v-if="!isBulkRo">
				...
				<div class="row-form so mt10 table-com-layout">
					<el-table fit border stripe style="width: 100%" :data="soList" class="table-cont" @selection-change="handleSelectionChange" @cell-mouse-enter="showTooltip" @cell-mouse-leave="hiddenTooltip" v-loading="lsLoading"
		...
		:element-loading-background="eLoadingBackground">
			...
			<div :class="['row-tit','pd0',{'isFixed': saveBarFixed}]" :style="styleObject" id="saveBar">
				<span class="tit ft12">免用免堆</span>
				<div class="flex-column-center">
					<el-button size="mini" type="primary" class="ml10" @click="handleSave" :disabled="submitDisabled || !isOp">保存</el-button>
				</div>
			</div>
			<div class="pol-wrap">
		...
		handleExport(obj) {
			...
			this.$store
				...
				.then((res) => {
					...
					link.download =
						`${this.exportTypeOptions[params.bookingType]}${params.orderNo}` + 
						'.' +
