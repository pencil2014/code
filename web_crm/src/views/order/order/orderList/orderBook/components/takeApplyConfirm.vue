		...
		<div class="copy-file-confirm">
			<el-form ref="orderImportForm" :model="orderImportForm" :inline="true" label-width="140px" size="mini" :show-message="false" :rules="orderImportRegRules">
				<el-form-item label="截copy件确认时间:" prop="copyCutDate">
					<elDatePickerLimit disabled v-model="orderImportForm.copyCutDate" type="date" value-format="yyyy-MM-dd" placeholder="请选择"> </elDatePickerLimit>
				</el-form-item>
				<el-form-item class="import-bill-remark" label="备注" prop="copyRemark">
					<el-input disabled :rows="4" type="textarea" size="mini" placeholder="请输入" v-model="orderImportForm.copyRemark"></el-input>
				</el-form-item>
			</el-form>
		</div>
...
export default {
	...
	watch: {
		dialogOrderShow(val) {
			if (val) {
				this.orderImportForm = this.confirmInfo
			}
		}
	},
	methods: {
