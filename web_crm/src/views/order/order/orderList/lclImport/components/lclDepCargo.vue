	...
	<div class="lcl-dept-cargo-form">
		<div class="row-flex flex-cargo" v-for="(o, index) in lclDepCargoList" :key="index">
          ...
          <el-select size="mini" v-model="o.hscode" style="width: 100%"  placeholder="请选择海关编号" disabled>
			...
			<el-form-item class="cargo-item cname" label="中文品名" :show-message="false" :rules="{ required: isBd, message: '请输入中文品名', trigger: 'blur' }">
           ...
           <el-input size="mini" v-model="o.cname" clearable placeholder="请输入中文品名" disabled maxlength="128"></el-input>
			...
			<el-form-item class="cargo-item cname" label="英文品名" :show-message="false" :rules="{ required: isBd, message: '请输入英文品名', trigger: 'blur' }">
