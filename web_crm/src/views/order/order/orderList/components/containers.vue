	...
	<BaseDialog :config="dialogConfig" :callback="dialogCallback">
		<div class="c-pop-table">
			<el-table fit highlight-current-row style="width: 100%" ref="contMultiTable" :data="containerList" @selection-change="handleSelectionChange">
				...
				<el-table-column prop="so" label="SO" align="center" show-overflow-tooltip></el-table-column>
				...
				<el-table-column prop="sn" label="封号" align="center" show-overflow-tooltip> </el-table-column>
				<el-table-column prop="quantity" label="件数" align="center" width="80"> </el-table-column>
				<el-table-column prop="weight" label="毛重(KGS)" align="center" width="100"> </el-table-column>
				<el-table-column prop="volume" label="体积(CBM)" align="center" width="100"> </el-table-column>
				<el-table-column prop="packageInfo" label="包装" align="center" show-overflow-tooltip>
