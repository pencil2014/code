	...
	<BaseDialog :config="dialogConfig" :callback="dialogCallback">
		<div class="bl-fin-log-table" style="max-height: 800px">
			<el-table fit highlight-current-row style="width: 100%" ref="logTable" :data="tableData" :max-height="tableHeight" @cell-mouse-enter="showTooltip" @cell-mouse-leave="hiddenTooltip">
				<el-table-column show-overflow-tooltip prop="bizEmployeeName" label="人员" align="center" width="150px">
					<template slot-scope="scope">
						{{ `${scope.row.bizEmployeeName}(${scope.row.bizDeptName})` }}
					</template>
				</el-table-column>
	...
	data() {
		return {
			...
			tableQuery: {
				...
				ascColumns: [],
				descColumns: ['bizTime'],
				query: [{ column: 'module', type: 'eq', value: 'fin' }],
				blId: '',
				orderNo: ''
			},
			total: null,
