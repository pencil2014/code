		...
		return {
          ...
          cascaderProps: {
			...
			tableConfig: {
				...
				columns: [],
				allColumns: store.state.order.blFinApplyList.columnsBase(this.handleViewSo, this.handleViewCustName, this.handleViewCustSettleUnit, this.handleOrderNo, this.handleToOrderFee, this.handleViewWorkFlowActList),
				// 操作按钮组
				operationBtns: {
					minWidth: '60',
					fixed: 'right',
