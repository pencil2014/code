			...
			<div class="table-td">
              ...
              <div class="flex1">
						...
						<el-form-item :required="true" label="大船预计开船时间" prop="ship.etdTime" :show-message="false">
							<elDatePickerLimit :field="'etdTime'" size="mini" v-model="createItem.ship.etdTime" type="date" style="width: 100%" clearable :disabled="(disabledState && !isOpDocEdit) || finIsCloseStatus" placeholder="请选择" value-format="yyyy-MM-dd"  />
						</el-form-item>
						<el-form-item v-if="isOpView || !ordDetRole" label="大船实际开船时间" prop="ship.tdTime" :show-message="false">
							<elDatePickerLimit noCanFuture :field="'tdTime'" size="mini" v-model="createItem.ship.tdTime" type="date" style="width: 100%" clearable :disabled="(disabledState && !isOpDocEdit) || finIsCloseStatus" placeholder="请选择" value-format="yyyy-MM-dd"  />
						</el-form-item>
						<el-form-item class="timeSpecial" label="预计到港时间" prop="ship.etaTime" :show-message="false" v-if="isOpView">
              <elDatePickerLimit size="mini" :field="'etaTime'" v-model="createItem.ship.etaTime" type="date" style="width: 100%" clearable placeholder="请选择" value-format="yyyy-MM-dd" :disabled="disabledState && !isOpDocEdit" />
            </el-form-item>
            <el-form-item class="timeSpecial" label="实际到港时间" prop="ship.taTime" :show-message="false" v-if="isOpView">
              <elDatePickerLimit noCanFuture :field="'taTime'" size="mini" v-model="createItem.ship.taTime" type="date" style="width: 100%" clearable placeholder="请选择" value-format="yyyy-MM-dd" :disabled="disabledState && !isOpDocEdit" />
            </el-form-item>
...
export default {
	...
	components: { PortPopover,ChangeBizDatePop,VesselSelect,VoyageSelect },
	methods: {
		// 驳船船名输入建议
