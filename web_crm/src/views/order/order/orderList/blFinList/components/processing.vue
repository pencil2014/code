<template>
  <BaseDialog :config="dialogConfig" :callback="dialogCallback">
    <el-form ref="processing" :rules="rules" :model="createdItem" label-position="right" label-width="80px" class="create-form">    
      <el-form-item label="处理中原因" prop="processingReason">
      ...
      <el-form-item label="处理中备注" prop="processingRemark">
...
export default {
  data() {
    return {
      ...
      rules: {
        processingReason: [{required: true, message: '请选择处理中原因', trigger: 'change'}],
      }
    }
  },
  props: {
