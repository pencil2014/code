      ...
      <div class="detail-header">
        <div class="left-cnt">
          ...
          <el-button
            ...
            size="mini"
            type="text"
            v-if="!isHideBtn && (!isPotentialDetail || isClient) && isCts"
            >修改级别</el-button
          >
          <div class="white-box">
            <template v-if="isWhitelist">
              <img src="~@/assets/white.png" alt="" />
              <span class="white-name">{{ baseInfo.industry }}</span>
            </template>
            <template v-if="isCts && !isHideBtn && isClient">
              <el-button
                size="mini"
                type="text"
          ...
          <div class="white-box">
            <template v-if="isPass && isUnordinary">
              ...
              <el-button size="mini" @click="changeVerify()" class="qulityButton" v-if="isPass && !isBlack"
