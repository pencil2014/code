<template>
	<div class="table-cont">
		...
		>
			...
			<vxe-column v-if="config.customColumns && config.customColumns.show" :width="36" :fixed="'left'" :resizable="true">
				<template #header>
			...
			<!-- 索引 -->
			<vxe-column v-if="isShowTabelIndex" type="seq" title="序号" align="left" width="46" :resizable="true" fixed="left"> </vxe-column>
