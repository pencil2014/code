...
// 标记条款
export function blMarkTradeTerms(data) {
	return request({
		url: '/order/shipping/bl/markTradeTerms',
		method: 'post',
		data
	})
}
// 对客平台-包装
export function custBlPackageList(data) {
	return request({
		url: '/order/cust/bl/package/list',
		method: 'post',
		data
	})
}
// 对客平台-集装箱
export function custBlContainerList(data) {
	return request({
		url: '/order/cust/bl/container/list',
		method: 'post',
		data
	})
}
// 对客平台-提单数据字典
export function custBlDictList(data) {
	return request({
		url: '/order/cust/bl/dict/list?groupCode=' + data.groupCode,
		method: 'post',
		data
	})
}
// 对客平台-提单港口下拉
export function custBlPortList(portName, portAttribute, state) {
	state = state || ''
	return request({
		url: '/order/cust/bl/port/list',
		method: 'post',
		data: { portName, portAttribute, state }
	})
}
// 对客平台-最后一次客户提交的补料日志
export function custBlSiCustInfo(data) {
	return request({
		url: '/order/cust/bl/si/cust/info',
		method: 'post',
		data
	})
}
// 对客平台-补料确认拒绝撤回
export function custBlSiRefuseCancel(data) {
	return request({
		url: '/order/cust/bl/si/refuse/cancel',
		method: 'post',
		data
	})
}
// 对客平台-推送补料撤回
export function custBlSiPushCancel(data) {
	return request({
		url: '/order/cust/bl/si/push/cancel',
		method: 'post',
		data
	})
}
// 对客平台-获取邮件发送的标题除【】外内容
export function custBlMailTitle(data) {
	return request({
		url: '/order/cust/bl/mail/title',
		method: 'post',
		data
	})
}
// 对客平台-获取推送COPY件确认的信息
export function custBlSiCopyConfirmInfo(data) {
	return request({
		url: '/order/cust/bl/si/copy/confirm/info',
		method: 'post',
		data
	})
}
// 对客平台-获取邮件发送人
export function custBlContract(data) {
	return request({
		url: '/order/cust/bl/contract',
		method: 'post',
		data
	})
}
// 对客平台-客户COPY件确认
export function custBlCopyConfirm(data) {
	return request({
		url: '/order/cust/bl/si/copy/confirm',
		method: 'post',
		data
	})
}
// 对客平台-附件列表
export function custBlFileList(data) {
	return request({
		url: '/order/cust/bl/file/list',
		method: 'post',
		data
	})
}
// 对客平台-提单详情
export function custBlDetail(data) {
	return request({
		url: '/order/cust/bl/detail',
		method: 'post',
		data
	})
}
// 对客平台-提单列表
export function custBlList(data) {
	return request({
		url: '/order/cust/bl/list',
		method: 'post',
		data
	})
}
export function importBlTakeFinish(data) {
	return request({
		url: '/order/shipping/import/bl/take/finish',
		method: 'post',
		data
	})
}
//记录是否打印正本
export function blHitPrint(data) {
	return request({
		url: '/order/shipping/bl/hitPrint',
		method: 'post',
		data
	})
}
//检查打印情况
export function blCheckPrint(data) {
	return request({
		url: '/order/shipping/bl/checkPrint',
		method: 'post',
		data
	})
}
//进口提单更改放单状态
export function blPutFinishImport(data) {
	return request({
		url: '/order/shipping/bl/put/finish',
		method: 'post',
		data
	})
}
...
// 录入收件人信息
export function blInputReceive(data) {
	return request({
		url: '/order/shipping/bl/inputReceive',
		method: 'post',
		data
	})
}
...
// 放单申请附件列表
export function listBaseFile(data) {
	return request({
		url: '/order/file/listBaseFile',
		method: 'post',
		data
	})
}
