...
.app-wrapper ::v-deep .finance-page, .app-wrapper ::v-deep .one-kind-fee {
  ...
  .el-form-item__label {
    height: 20px; // 20px !important;
    line-height: 20px; // 20px !important;
  }
  ...
  .finance-search-list-gap + .finance-list-container, .finance-search-form {
    .el-button--mini,
    .el-radio-button--mini .el-radio-button__inner {
      font-size: 12px;
      padding: 7px 8px;
    ...
    .dzg-pagination-container .pagination-item .el-input__inner {
      padding: 5px 8px;
      height: 32px;
    }
    .dzg-pagination-container .pagination-item .el-input__suffix {
      top: 7px;
    }
  }
  .detail__search .finance-search-form, div + .finance-search-form, div + .finance-search-form + .finance-search-list-gap + .finance-list-container { // .settlement-detail-form + .finance-table, .detail__search  + .finance-table 用于供应商对账supplierBillListDetail页面列表下的pagesize框
    .el-button--mini,
    .el-radio-button--mini .el-radio-button__inner {
      font-size: 12px;
      height: 24px;
