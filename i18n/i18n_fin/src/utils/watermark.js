export default function watermark(settings) {
  ...
  var defaultSettings = {
      ...
      watermark_fontWeight: 400, //水印字体大小
      watermark_font: '微软雅黑', //水印字体
      watermark_width: 200, //水印宽度
      watermark_height: 20, //水印长度
      watermark_angle: 30, //水印倾斜度数
      watermark_zindex: 9999, //水印zindex
      className: '',//水印区域
  };
  //采用配置项替换默认值
  ...
  //获取页面最大宽度
  var page_width = Math.max(document.body.scrollWidth, document.body.clientWidth) - 200;
  //获取页面最大长度
  ...
  for (var i = 0; i < defaultSettings.watermark_rows; i++) {
      ...
      for (var j = 0; j < defaultSettings.watermark_cols; j++) {
          ...
          mask_div.style.textOverflow = 'ellipsis';
