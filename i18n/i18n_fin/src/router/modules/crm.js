  ...
  children: [
    {
      ...
      children: [
        ...
        {
          path: "customerSLAReviewDetail",
          component: () =>
            import( "@/views/crm/merchantManagement/slaVerify/index"),
          name: "customerSLAReviewDetail",
          meta: { title: "SLA质量审核", keepAlive: true },
          hidden: true,
        },
        {
          ...
          meta: { title: "客户审核通过详情", keepAlive: true },
          hidden: true,
        },
        {
