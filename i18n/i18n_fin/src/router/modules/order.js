...
const chargeRouter = {
  ...
  children: [
      ...
      children: [
        {
          ...
          component: () =>
            import("@/views/charge/chargeSearch/seaFreight/cargoGm"),
          name: "OldSeaFreight",
        ...
        },
        {
          ...
          component: () =>
            import("@/views/charge/chargeSearch/seaFreight/dagIndex"),
        ...
        },
        {
          path: "importBill",
          component: () =>
            import("@/views/order/order/orderList/importBill/index"),
          name: "ImportBill",
        ...
        },
        {
          path: "siDnDetail",
          component: () =>
            import("@/views/order/order/orderList/siDnList/detail"),
          name: "SiDnDetail",
          meta: {
            title: "费用审核详情",
        ...
        },
        {
          path: "lclAuditList",
          component: () =>
            import("@/views/order/order/orderList/lcl/audit/index"),
          name: "LclAuditList",
        ...
        },
        {
          path: "lclAuditDetail",
          component: () =>
            import("@/views/order/order/orderList/lcl/audit/detail"),
          name: "LclAuditDetail",
          meta: {
            title: "订仓列表-审核",
        ...
        },
        {
          path: "lclOrderList",
          component: () =>
            import("@/views/order/order/orderList/lcl/orderList/index"),
          name: "LclOrderList",
        ...
        },
        {
          path: "orderReport",
          component: () =>
            import("@/views/order/order/orderList/orderReport/index"),
          name: "OrderReport",
          meta: {
            title: "订单报表",
            // keepAlive: true,
        ...
        },
        {
          path: "shipBlList",
          component: () =>
            import("@/views/order/order/blList/index"),
          name: "ShipBlList",
          meta: {
            title: "提单列表",
            keepAlive: true,
        ...
        },
        {
          path: "shipBlInfoList",
          component: () =>
            import("@/views/order/order/blList/blInfoList"),
          name: "ShipBlInfoList",
          meta: {
            title: "提单信息列表",
            keepAlive: true,
        ...
        },
        {
          path: "onlineBkgList",
          component: () =>
            import("@/views/order/createBooking/list/bkg/index"),
          name: "OnlineBkgList",
          meta: {
            title: "在线订舱列表",
            keepAlive: true,
        ...
        },
        {
          path: "onlineSiList",
          component: () =>
            import("@/views/order/createBooking/list/si/index"),
          name: "OnlineSiList",
          meta: {
            title: "在线补料列表",
            keepAlive: true,
        ...
        },
        {
          path: "onlineVgmList",
          component: () =>
            import("@/views/order/vgm/list/index"),
          name: "OnlineVgmList",
          meta: {
            title: "在线VGM列表",
            keepAlive: true,
    ...
    },
    {
      ...
      component: () =>
        import(
          "@/views/finance/supplierBill/supplierBillList/components/supplierBillDetail"
        ),
    ...
    },
    {
      ...
      component: () =>
        import(
          "@/views/finance/supplierBill/supplierBillList/components/accountChecking"
        ),
    ...
    },
    {
      ...
      component: () =>
        import(
          "@/views/finance/supplierBill/supplierBillList/components/diffResult"
        ),
