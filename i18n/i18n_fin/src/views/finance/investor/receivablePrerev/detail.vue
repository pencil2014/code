...
export default {
  ...
  created() {
    ...
    this.searchOption1 = {
      ...
      addFilter: {
        ...
        filterGroups: {
          ...
          createdTime: { label: this.$t('Common.createTime'), type: 'daterange', format: 'yyyy-MM-dd', showType: '3' },
    ...
    let columns = [
      { prop: 'recvCompName', label: this.$t('Settle.branchCompany'), type: 'text', sortable: false, width: 150 },
      { prop: 'settleCorpName', label: this.$t('FeeList.settleCorp'), type: 'text', width: 150, sortable: false },
