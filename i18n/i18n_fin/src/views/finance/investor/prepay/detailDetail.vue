...
export default {
  ...
  data() {
    return {
      ...
      columnsCfg: [
        { prop: 'settleCompName', label: this.$t('Settle.branchCompany'), type: 'text', width: 140 },
  ...
  activated() {
    ...
    // }
      ...
      let writeoffType = { prop: 'writeoffSubType', label: this.$t('PayApplyList.writeoffSubType'), type: 'select', propInDict: 'writeoffSubType' }
      let writeoffStatus = { prop: 'recheckStatus', label: '核销状态', type: 'select', propInDict: 'writeoffRecheckStatus' }
      let currency = { prop: 'currency', label: this.$t('FeeList.currency'), type: 'text', width: 50 }
