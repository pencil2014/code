  ...
  created() {
    ...
    this.searchOption = {
      ...
      addFilter: {
        ...
        // 左侧下拉框及对应右侧配置
        filterGroups: {
          payOrderNo: { label: this.$t('Settle.payOrderNo'), type: 'input', showType: '3' },
          ...
          createdTime: { label: this.$t('Common.createTime'), type: 'daterange', format: 'yyyy-MM-dd', showType: '2' },
    ...
    let columns = [
      { prop: 'settleCompName', label: this.$t('Settle.branchCompany'), type: 'text', width: 150, sortable: false },
      { prop: 'settleCorpName', label: this.$t('FeeList.settleCorp'), width: 150, type: 'text', sortable: false },
      { prop: 'accountNo', label: '账号', type: 'text', sortable: false, width: 150 },
      { prop: 'currency', label: this.$t('FeeList.currency'), type: 'text', sortable: false, width: 80 },
      {
        prop: 'payOrderNo',
