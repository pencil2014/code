...
<div class="settle-detail">
  <div class="finance-page finance-page-background" :style="{margin:financePageMargin}">
    ...
    <div class="settlement-detail-form">
      ...
      <el-form class="settlement-detail-form-1" :model="settlementDetailForm" ref="form" :inline="true" size="mini">
        ...
        <el-form-item :label="$t('FeeList.settleCorp')" prop="">
    ...
    <div class="settlement-detail-form">
      ...
      <div class="settlement-detail-form-1" v-for="(item,index) in payInfoList" :key="index">
         <el-form :model="settlementDetailForm" ref="form" :inline="true" size="mini" style="padding: 10px 0">
           <el-form-item :label="$t('Settle.paymentCurrency')" prop="settleCorpName">
              <div class="el-form-item-text" v-html="item.currency">
              </div>
            </el-form-item>
           <el-form-item :label="$t('PayApplyList.payAmt')" prop="settleCorpName">
           ...
           <el-form-item label="付款方式：" prop="settleCorpName">
             <el-select v-model="item.payWay"
              ...
              :placeholder="$t('Common.plSelect')" :disabled="confirmStatus !== 'pending'" style="width:100px" >
                <el-option
  ...
  <!-- <el-dialog
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button @click="handleCancel" size="mini">{{$t('Common.close')}}</el-button>
    </span>
  </el-dialog> -->
  <!-- 申请不通过弹框 -->
  <el-dialog
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="primary" @click="rejectSubmit('refuse')" size="mini">{{$t('Common.sure')}}</el-button>
      <el-button @click="handleCancelRefuse" size="mini">{{$t('Common.cancel')}}</el-button>
    </span>
  </el-dialog>
</div>
</template>
...
export default {
  ...
  created() {
    ...
    let columns3 = [
      ...
      {
        prop: 'confirmTime',
        label: this.$t('FinBill.paymentDate'),
        type: 'text',
      },
    ]
