<template>
    ...
    >
      ...
      >
        <div class="dialog-add-dialog-item" v-for="(item,index) in invoicePaymentAddForm.invoicePaymentList" :key="'invoicePaymentList'+index">
            ...
            <el-form-item label="开票日期" :prop="`invoicePaymentList[${index}].invoiceIssueDate`" :rules="{ required: true, message: ' ', trigger: 'blur' }">
                <el-date-picker value-format="yyyy-MM-dd" v-model="item.invoiceIssueDate" :placeholder="$t('Common.plSelect')" style="width:170px;"></el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="发票税率" :prop="`invoicePaymentList[${index}].taxRate`" :rules="{ required: true, message: ' ', trigger: 'change' }">
                <el-select v-model="item.taxRate" :placeholder="$t('Common.plSelect')" @input="changeAmt(item)" style="width:170px;">
                    <el-option
            ...
            <el-form-item label="开票币种" :prop="`invoicePaymentList[${index}].currency`" :rules="{ required: true, message: ' ', trigger: 'blur' }" >
                <el-select v-model="item.currency" @change="changeCurrency(item.currency,index)" filterable :placeholder="$t('Common.plSelect')" @input="changeAmt(item)" style="width:170px;">
                    <el-option
            ...
            <el-form-item label="发票登记编号" :prop="`invoicePaymentList[${index}].receiveNo`" :rules="[{ required: isCompany && item.invoiceType !== 'electronic', message: ' ', trigger: 'change' },{ pattern:  /^[A-Za-z0-9]+$/, message: '必须数字或字母' }]">
                <el-input v-model="item.receiveNo" maxlength="32" :placeholder="$t('Common.plEnter')"></el-input>
            </el-form-item>
            <el-form-item label="税额" :prop="`invoicePaymentList[${index}].taxAmt`" :rules="{ required: false, message: ' ', trigger: 'change' }">
                <el-input v-model="item.taxAmt" disabled maxlength="16" :placeholder="$t('Common.plEnter')"></el-input>
            </el-form-item>
            <el-form-item label="价税合计" :prop="`invoicePaymentList[${index}].amtCny`" :rules="{ required: false, message: ' ', trigger: 'change' }">
                <el-input v-model="item.amtCny" disabled maxlength="16" :placeholder="$t('Common.plEnter')"></el-input>
            </el-form-item>
        ...
        <div class="dialog-add-dialog-item">
            ...
            <el-form-item label="我司发票抬头" prop="">
                <el-input v-model="invoicePaymentAddForm.title" disabled :placeholder="$t('Common.plEnter')"></el-input>
            </el-form-item>
            <el-form-item label="纳税人识别号" prop="">
                <el-input v-model="invoicePaymentAddForm.taxNo" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
            <!-- <el-form-item label="付款银行" prop="">
                <el-input v-model="invoicePaymentAddForm.bankName" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item> -->
            <el-form-item label="我司开户行" prop="">
                <el-input :value="`${invoicePaymentAddForm.bankName ? invoicePaymentAddForm.bankName : ''}${invoicePaymentAddForm.bankBranchName?'(':''}${invoicePaymentAddForm.bankBranchName ? invoicePaymentAddForm.bankBranchName : ''}${invoicePaymentAddForm.bankBranchName?')':''}`" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
            <!-- <el-form-item label="我司开户行" prop="">
                <el-input v-model="invoicePaymentAddForm.bankBranchName" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item> -->
            <el-form-item label="我司账号" prop="">
                <el-input v-model="invoicePaymentAddForm.accountNo" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
            <el-form-item label="我司电话" prop="">
                <el-input v-model="invoicePaymentAddForm.tel" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
            <el-form-item label="我司地址" prop="">
                <el-input style="width:720px" v-model="invoicePaymentAddForm.addr" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
        ...
        <div class="dialog-add-dialog-item-1">
            ...
            <el-form-item label="发票抬头" prop="supplierTitle">
                <el-input v-model="invoicePaymentAddForm.supplierTitle" maxlength="32" disabled :placeholder="$t('Common.plEnter')"></el-input>
            </el-form-item>
            <el-form-item label="纳税人识别号" prop="">
                <el-input v-model="invoicePaymentAddForm.supplierTaxpayerNo" maxlength="32" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
            <el-form-item label="银行账号" prop="supplierAccountNo">
                ...
                <!-- <el-input v-model="invoicePaymentAddForm.supplierAccountNo" :placeholder="$t('Common.plEnter')" ></el-input> -->
            </el-form-item>
            <!-- <el-form-item label="收款银行" prop="">
                <el-input v-model="invoicePaymentAddForm.supplierBankName" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item> -->
            <el-form-item label="供应商开户行" prop="">
                <el-input :value="`${invoicePaymentAddForm.supplierBankName ? invoicePaymentAddForm.supplierBankName : ''}${invoicePaymentAddForm.supplierBankBranchName?'(':''}${invoicePaymentAddForm.supplierBankBranchName ? invoicePaymentAddForm.supplierBankBranchName : ''}${invoicePaymentAddForm.supplierBankBranchName?')':''}`" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
            <!-- <el-form-item label="供应商开户行" prop="">
                <el-input v-model="invoicePaymentAddForm.supplierBankBranchName" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item> -->
            <el-form-item label="电话" prop="">
                <el-input v-model="invoicePaymentAddForm.supplierTel" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
            <el-form-item label="地址" prop="">
                <el-input style="width:720px" v-model="invoicePaymentAddForm.supplierAddr" :placeholder="$t('Common.plEnter')" disabled></el-input>
            </el-form-item>
        </div>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" size="mini" @click="submitAdd">{{$t('Common.submit')}}</el-button>
