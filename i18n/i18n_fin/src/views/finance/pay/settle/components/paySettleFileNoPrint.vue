  ...
  <div class="finance-page" v-loading="lsLoading">
    ...
    <div class="finance-payorder-print finance-paySettlePrint-print" v-if="infoList.length">
        ...
        <el-carousel-item v-for="(item,index) in infoList" :key="item.key">
          ...
          >
            ...
            <div
              ...
              :key="index"
            >
              <span>{{$t('PayApplyList.nthPrint1')}}{{isPrinting ? it.printCount : it.printCount - 1}}{{$t('PayApplyList.nthPrint2')}}</span>
      ...
      <div class="print-btn-box">
        ...
        <el-tooltip class="item" effect="dark" :content="$t('PayApplyList.printHalfPaperUseLeft')" placement="top">
          <el-button
            class="finance-btn"
            type="primary"
            size="mini"
