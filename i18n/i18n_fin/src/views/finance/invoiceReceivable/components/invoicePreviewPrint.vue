  ...
  <div class="invoice-preview-print">
    <el-dialog title="发票预览" :visible.sync="dialogVisibleO.show" width="1180px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button v-if="$attrs.isPrint" type="primary" size="mini" @click="printInvoice">{{$t('Common.print')}}</el-button>
        <el-button
        ...
        <el-button v-else size="mini" @click="dialogVisibleO.show = false">{{$t('Common.close')}}</el-button>
      </span>
    </el-dialog>
  </div>
</template>
