  ...
  <div class="one-kind-fee"
    ...
    <div class="finance-table-container" v-show="option2.data.length > 0">
      <div class="money-box">
        ...
        <div class="money-box-right">
          <el-button class="finance-btn" @click="handleCustomColumns" size="mini" v-show="option1.data.length === 0">{{$t('Common.custTableHead')}}</el-button>
...
export default {
  ...
  methods: {
    ...
    cancelAgentCompany() {
      ...
      this.$confirm('是否确认将选中的费用进行撤销代收付？', this.$t('Common.tips'), {
