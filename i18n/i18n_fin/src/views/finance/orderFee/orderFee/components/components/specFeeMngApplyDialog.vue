...
<!-- '业务费用申请' : '专项管理费申请' -->
<el-dialog
  :title="isBusinessFee ? $t('OrderFee.commercialFee')+$t('OrderFee.enspace')+$t('OrderFee.apply') : $t('OrderFee.specialMngFee')+$t('OrderFee.enspace')+$t('OrderFee.apply')"
  ...
  <div v-if="!isModifyFee" style="margin-bottom:14px;font-size:12px;word-break:break-all;">{{feeSaveVerifyData.tipMsg ? feeSaveVerifyData.tipMsg : $t('OrderFee.feeNeedApproval')}}, {{$t('OrderFee.applyTip')}}</div>
  <FinanceTable
    :option="option1"
  ...
  <span slot="footer" class="dialog-footer">
    <el-button type="primary" @click="submit" size="mini" :loading="loading">{{$t('OrderFee.submit')}}</el-button>
...
export default {
  ...
  created() {
    ...
    this.option1 = Object.assign({}, this.option, {
      ...
      maxHeight: 300,
      columns: [
        { prop: 'approverName', label: this.$t('OrderFee.approver'), type: 'text', key: 'approverName', width: '50%' },
        { prop: 'approverDesc', label: this.$t('OrderFee.approverRole'), type: 'text', key: 'approverDesc', width: '50%' },
      ]
    })
  },
  methods: {
