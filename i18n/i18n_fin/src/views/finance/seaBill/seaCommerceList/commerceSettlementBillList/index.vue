...
export default {
    ...
    this.searchOption = {
      ...
      addFilter: {
        ...
        filterGroups: {
          ...
          settleCurrency: {  label: this.$t('FeeList.currency'),  type: 'select', selectOptions: this.dictMap.currency.filter((v) => v.value != 'ORIGINAL'), },
          settleCorpCode: {
  ...
  methods: {
    ...
    handleWithdrawPayApplyAudit(){
      ...
      this.$confirm('是否确认撤回申请？', this.$t('Common.tips'), {
        cancelButtonText: this.$t('Common.cancel'),
