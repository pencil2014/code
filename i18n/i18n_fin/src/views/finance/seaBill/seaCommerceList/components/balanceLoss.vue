  ...
  <div class="finance-page">
      ...
      <div class="balance-loss-cnt" v-if="option4.data.length">
        ...
        <div class="loss-cnt">
          ...
          <div class="loss-cnt-info">
            ...
            <div class="base-item">
              对冲金额：
              <el-input v-model="gedgingAmt" :placeholder="$t('Common.plEnter')" @blur="changeGedgingAmt"></el-input>
    ...
    <el-dialog title="添加留置费用" :visible.sync="lienAmtDialog" class="self-dialog" width="1060px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="mini" @click="lienAmtDialog = false">{{$t('Common.cancel')}}</el-button>
      </span>
    </el-dialog>
    <!-- <ExchangeRateDialog
...
export default {
  ...
  data() {
    return {
      ...
      //   change: true,
      //   columns: [
      //     { label: this.$t('FeeList.currency'), prop: 'originCurrency', type: 'text' },
  ...
  created() {
    ...
    let columns2 = [
      ...
      { prop: 'sourceBizNo', label: this.$t('FeeList.orderNo'), type: 'text' },
      ...
      { prop: 'exAmt', label: this.$t('Settle.exSettleAmt'), type: 'text' },
  ...
  methods: {
    init() {
      ...
      let columns3 = [
        ...
        { prop: 'currency', label: this.$t('FeeList.currency'), type: 'text', forceWidth: 70 },
