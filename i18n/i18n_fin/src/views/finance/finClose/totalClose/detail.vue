...
export default {
  ...
  created() {
    ...
    let columns = [
      { prop: 'billNo', label: this.$t('PreClose.bizNo'), width: 130, type: 'button', callback: (row) => this.showDetail(row) },
      ...
      { prop: 'bdEmployeeName', label: this.$t('PreClose.salesman'), type: 'text', width: 100 },
