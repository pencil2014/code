<template>
  <el-dialog :visible.sync="dialogOption.show" class="transfer-dialog" :title="$t('Collect.balanceDZG')" width="800px">
    <div class="transfer-cnt">
      <el-button @click="addTransfer" size="mini" type="primary">{{$t('Common.add')}}</el-button>
      <FinanceTableMass v-if="dialogOption.show" :option="option1" />
    </div>
    <div class="dialog-footer" slot="footer">
      <el-button @click="submit" size="mini" type="primary">{{$t('Common.submit')}}</el-button>
