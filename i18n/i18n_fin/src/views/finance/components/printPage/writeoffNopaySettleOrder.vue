...
export default {
  ...
  data() {
    return {
      ...
      printObj: {
        id: 'printDetail',
        popTitle: this.$t('Hedge.presalesDtail'),
        type: 'html',
        extraCss: '',
  ...
  created() {
    ...
    this.option1.columns = [
      { prop: 'settleCompName', label: this.$t('FeeList.settleComp'), type: 'text', forceWidth: 122 },
      { prop: 'settleCorpName', label: this.$t('FeeList.settleCorp'), type: 'text', forceWidth: 122 },
      { prop: 'bdEmployeeName', label: this.$t('FeeList.bdEmployeeId'), type: 'text', forceWidth: 76 },
      { prop: 'settleOrderNo', label: this.$t('FeeList.settleOrderNo'), type: 'text', forceWidth: 128 },
      // { prop: 'gedgingCurrency', label: this.$t('FeeList.currency'), type: 'text', forceWidth: 40 },
      { prop: 'writeOffAmt', label: this.$t('Charge.writeoffAmt'), type: 'text', forceWidth: 90 },
      { prop: 'writeoffNopayNo', label: this.$t('Hedge.writeoffNo'), type: 'text', forceWidth: 128 },
      { prop: 'auditTime', label: this.$t('Hedge.writeoffTime'), type: 'text', forceWidth: 76 },
      { prop: 'badReason', label: this.$t('Charge.debtsReasons'), type: 'select', propInDict: 'baddebtReason', forceWidth: 82 },
      { prop: 'createdName', label: this.$t('Settle.applicant'), type: 'text', forceWidth: 76 },
      { prop: 'auditName', label: this.$t('FinBill.approverName'), type: 'text', forceWidth: 76 },
    ]
  },
  activated() {
    setTimeout(() => {
